...
def get_vehicle_customers(doctype, txt, searchfield, start, page_len, filters):
	...
	vehicle_groups = frappe.get_all("Customer Group", filters={"custom_is_vehicle_customer": 1}, pluck="name")
...
def get_vehicle_items(doctype, txt, searchfield, start, page_len, filters):
	...
	vehicle_groups = frappe.get_all("Item Group", filters={"custom_is_vehicle": 1}, pluck="name")
