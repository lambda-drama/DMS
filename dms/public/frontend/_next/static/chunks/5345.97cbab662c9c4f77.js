		...
		47279: (e, t, r) => {
			...
			function v(e) {
				let {
					...
					[m, v] = (0, s.i)({ prop: r, defaultProp: d ?? !1, onChange: o, caller: k }),
					[x, b] = a.useState(null),
					[j, g] = a.useState(null),
					w = a.useRef(!1),
					C = !x || !!i || !!x.closest("form"),
					E = {
						checked: m,
						disabled: c,
						setChecked: v,
				...
				return (0, u.jsx)(y, {
					scope: t,
					...E,
					children: "function" == typeof f ? f(E) : n,
				});
			}
			var x = "CheckboxTrigger",
				b = a.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...d }, s) => {
					let {
							control: i,
							value: l,
							disabled: o,
			...
			var g = "CheckboxIndicator",
				w = a.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: a, ...n } = e,
						d = m(g, r);
					return (0, u.jsx)(o.C, {
						present: a || A(d.checked) || !0 === d.checked,
						children: (0, u.jsx)(p.sG.span, {
							"data-state": _(d.checked),
				...
				E = a.forwardRef(({ __scopeCheckbox: e, ...t }, r) => {
					...
					a.useEffect(() => {
						...
						if (g !== s && e) {
							...
							(x.indeterminate = A(s)), e.call(x, !A(s) && s), x.dispatchEvent(r);
						}
					}, [x, g, s, c]);
					let E = a.useRef(!A(s) && s);
