...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5028],
	{
		...
		38291: (e, s, t) => {
			...
			function o({ className: e, variant: s, asChild: t = !1, ...r }) {
				let c = t ? i.DX : "span";
				return (0, a.jsx)(c, {
					"data-slot": "badge",
					className: (0, n.cn)(l({ variant: s }), e),
					...r,
				});
			}
		},
		...
		42074: (e, s, t) => {
			...
			function l({ children: e, className: s, align: t = "end" }) {
				...
				return o ? (0, r.createPortal)(d, document.body) : null;
			}
		},
		45028: (e, s, t) => {
			...
			function y() {
				let { navigate: e, viewParams: s } = (0, l.c)(),
					t = s.get("id") || "",
					{ data: y } = (0, r.Ay)("crm-activity-form-options", n.Ac),
					{
						data: f,
						isLoading: j,
						mutate: _,
					} = (0, r.Ay)(t ? ["crm-activity", t] : null, () => (0, n.aZ)(t)),
					[w, N] = (0, i.useState)(!1),
					{ error: k, success: S, showError: C, showSuccess: A, clear: E } = (0, v.B)(),
					[Z, z] = (0, i.useState)({
						subject: "",
						activity_type: "",
						status: "",
				...
				(0, i.useEffect)(() => {
					f &&
						z({
							...
							due_datetime: String(f.due_datetime || "").slice(0, 16),
							disposition: String(f.disposition || ""),
							outcome_notes: String(f.outcome_notes || ""),
							reassign_to: "",
						});
				}, [f]);
				let R = (e) => (e || []).filter(Boolean).map((e) => ({ value: e, label: e })),
					B = (e, s) => z((t) => ({ ...t, [e]: s })),
					D = async () => {
						if (t) {
							E(), N(!0);
							try {
								await (0, n.am)(t, {
									subject: Z.subject.trim(),
									activity_type: Z.activity_type,
									status: Z.status,
									priority: Z.priority,
									due_datetime: Z.due_datetime || null,
									disposition: Z.disposition || null,
					...
					$ = async () => {
						if (t) {
							E();
							try {
								await (0, n.BJ)(t, Z.disposition, Z.outcome_notes),
									await _(),
									A("Activity completed.");
							} catch (e) {
								C(e, "Complete failed — disposition and notes are required");
							}
						}
					},
					O = async () => {
						if (!t || !Z.reassign_to.trim())
							return void C("Enter a User ID / email to reassign.");
						E();
						try {
							await (0, n.El)(t, Z.reassign_to.trim(), "Reassigned from CRM"),
								await _(),
								A("Reassigned.");
						} catch (e) {
							C(e, "Reassign failed");
				...
				return t
					? j || !f
						...
						: (0, a.jsxs)("div", {
								...
								children: [
									(0, a.jsx)(v.y, { error: k, success: S, onDismiss: E }),
									(0, a.jsxs)("div", {
										className:
												...
												children: [
													...
													(0, a.jsxs)("div", {
														...
														children: [
															...
															(0, a.jsx)(g.Zi, {
																options: R(y?.activity_types),
																value: Z.activity_type,
																onValueChange: (e) =>
																	B("activity_type", e || ""),
															}),
														],
									...
									Array.isArray(f.assignment_history) &&
									f.assignment_history.length > 0
										? (0, a.jsxs)(d.Zp, {
												className: "border-border/70 shadow-sm",
												children: [
													(0, a.jsx)(d.aR, {
													...
													(0, a.jsx)(d.Wu, {
														...
														children: f.assignment_history.map(
															(e, s) =>
																(0, a.jsxs)(
																	"div",
																	{
		...
		93108: (e, s, t) => {
			...
			function d() {
				let [e, s] = (0, i.useState)(""),
					[t, a] = (0, i.useState)(""),
					n = (0, i.useCallback)((e, t = "Something went wrong.") => {
						let i =
			...
			function u({ error: e, success: s, onDismiss: t, className: i }) {
				if (!e && !s) return null;
				let r = !!e;
				return (0, a.jsx)("div", {
					className: (0, c.cn)("sticky top-0 z-40 -mx-1 px-1 pt-1", i),
