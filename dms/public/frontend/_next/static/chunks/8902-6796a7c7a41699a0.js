...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[8902],
	{
		...
		38291: (e, r, t) => {
			...
			function l({ className: e, variant: r, asChild: t = !1, ...n }) {
				let o = t ? a.DX : "span";
				return (0, s.jsx)(o, {
					"data-slot": "badge",
		...
		38902: (e, r, t) => {
			...
			function p() {
				let { navigate: e } = (0, d.c)(),
					[r, t] = (0, a.useState)(""),
					[p, g] = (0, a.useState)("all"),
					[b, v] = (0, a.useState)("all"),
					{ data: j, isLoading: f } = (0, n.Ay)(["crm-cases", r, p, b], () =>
						(0, i.qz)({ search: r || void 0, status: p, priority: b, limit: 50 })
					),
					N = j?.data || [],
					y = j?.summary || {};
				return (0, s.jsxs)("div", {
								...
								(0, s.jsxs)("div", {
									...
									children: [
										...
										(0, s.jsxs)("span", {
											...
											children: ["SLA breached: ", Number(y.breached || 0)],
										}),
									],
								}),
								(0, s.jsxs)(o.$, {
									onClick: () => e("crm-case-new"),
									children: [
										(0, s.jsx)(x.A, { className: "mr-2 h-4 w-4" }),
										"New Case",
									],
								}),
							],
											...
											(0, s.jsxs)("select", {
												...
												children: [
													...
													(0, s.jsx)("option", {
														...
														children: "Awaiting Customer",
													}),
													(0, s.jsx)("option", {
														value: "Awaiting Internal Action",
														children: "Awaiting Internal Action",
													}),
													(0, s.jsx)("option", {
														value: "Resolution Proposed",
														children: "Resolution Proposed",
													}),
													(0, s.jsx)("option", {
														value: "Resolved",
														children: "Resolved",
