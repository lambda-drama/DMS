...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[9195],
	{
		15306: (e, t, r) => {
			...
			function d({ className: e, ...t }) {
				return (0, a.jsx)(l.UC, {
					...
					className: (0, o.cn)("outline-none data-[state=inactive]:hidden", e),
					...t,
				});
			}
		},
		21350: (e, t, r) => {
			...
			function p(e) {
				return null == e || "" === e
					...
					? Number.isInteger(e)
						? e.toLocaleString()
						: e.toLocaleString(void 0, { maximumFractionDigits: 2 })
					: String(e);
			}
			function f(e) {
				let t = Number(e) || 0,
					...
					a = t < 0 ? "-" : "";
				return r >= 1e6
					? `${a}${(r / 1e6).toFixed(r >= 1e7 ? 0 : 1)}M`
					: r >= 1e3
					? `${a}${(r / 1e3).toFixed(r >= 1e4 ? 0 : 1)}k`
					: `${a}${Math.round(r).toLocaleString()}`;
			}
			function h(e, t) {
				if (null == e || "" === e) return "—";
				let r = "number" == typeof e ? e : Number(e);
				if (!Number.isFinite(r)) return String(e);
				let a = r.toLocaleString(void 0, {
					minimumFractionDigits: 2 * !Number.isInteger(r),
					...
					? Array.isArray(r)
						? r
								.map((e) => {
									...
									let t = String(e.label ?? e.name ?? "—"),
										r =
											"number" == typeof e.value
												? e.value
												: Number(e.value) || 0;
									return {
										name: t.length > 14 ? `${t.slice(0, 12)}…` : t,
										fullName: t,
										value: r,
									};
								})
								.filter((e) => !!e && 0 !== e.value)
								.slice(0, 8)
						: "object" != typeof r
						? []
						: Object.entries(r)
								.map(([e, t]) => {
									...
									return (
										"number" == typeof t
											...
											: t &&
											  "object" == typeof t &&
											  ("number" == typeof t.gross_profit
													? (r = t.gross_profit)
													: "number" == typeof t.net
													? (r = t.net)
													: "number" == typeof t.count
													? (r = t.count)
													: "number" == typeof t.actual
													? (r = t.actual)
													: "number" == typeof t.value && (r = t.value)),
										{
											name: e.length > 14 ? `${e.slice(0, 12)}…` : e,
											fullName: e,
											value: r,
										}
									);
			...
			function j({ metrics: e, onNavigate: t }) {
				return e.length
					? (0, a.jsx)("div", {
									...
									o = (0, a.jsxs)(a.Fragment, {
										children: [
											...
											"stars" === e.display
												...
												: (0, a.jsx)("p", {
														className:
															"mt-1 font-serif-display text-[1.65rem] font-semibold leading-none tracking-tight text-foreground tabular-nums",
														children:
															"money" === e.display
																? h(e.value, e.currency)
																: p(e.value),
												  }),
											"number" == typeof e.progress
												? (0, a.jsx)("div", {
														className:
															"mt-2.5 h-1 overflow-hidden rounded-full bg-muted",
														children: (0, a.jsx)("div", {
															className:
																"h-full rounded-full bg-dms-gold transition-all",
															style: {
																width: `${Math.max(
																	0,
																	Math.min(100, e.progress)
																)}%`,
															},
														}),
												  })
												: (0, a.jsx)("div", {
														className:
															"mt-2.5 h-1 rounded-full bg-dms-gold/25",
												  }),
											(e.hint || r) &&
												(0, a.jsx)("p", {
													className:
														"mt-1.5 text-[11px] text-muted-foreground",
													children: e.hint || "Click to open",
												}),
										],
									});
								return r
									...
									: (0, a.jsx)("div", { className: l, children: o }, e.key);
							}),
					  })
					: null;
			}
			function N({
				...
				let s = new Set(t),
					i = Object.entries(e).filter(
						([e, t]) => !s.has(e) && (null == t || "object" != typeof t)
					),
					d = [
						...r.map((e) => i.find(([t]) => t === e)).filter(Boolean),
				...
				return (0, a.jsx)(j, {
					...
					metrics: d.map(([e, t]) => ({
						...
						value: t,
						href: o[e],
						display: (0, x.gt)(e) ? "stars" : void 0,
						progress:
							("number" == typeof t && e.includes("pct")) ||
							("number" == typeof t && t > 0 && t <= 100 && e.includes("rate"))
								? t
								: void 0,
					})),
				});
			...
			function w({
				...
				let v = x || !!b;
				return (0, a.jsxs)("div", {
					className: (0, g.cn)("rounded-lg border border-border/80 bg-card p-3.5", u),
					children: [
						(0, a.jsxs)("div", {
								...
								children: (0, a.jsxs)(o.E, {
									...
									children: [
										...
										(0, a.jsx)(i.h, {
											...
											axisLine: !1,
											tickLine: !1,
											tickFormatter: (e) => f(Number(e)),
											allowDecimals: !1,
										}),
										(0, a.jsx)(d.m, {
											formatter: (e) => (v ? h(Number(e), b) : p(Number(e))),
											contentStyle: {
												borderRadius: 8,
			...
			function k({
				...
				if (!t.length) return null;
				let i = t.reduce((e, t) => e + t.value, 0),
					c = s || !!n;
				return (0, a.jsxs)("div", {
					className: (0, g.cn)("rounded-lg border border-border/80 bg-card p-3.5", r),
					children: [
						(0, a.jsxs)("div", {
							...
							children: [
								...
								(0, a.jsx)("p", {
									...
									children: c ? h(i, n) : `${i.toLocaleString()} total`,
								}),
							],
						}),
						(0, a.jsxs)("div", {
							...
							children: [
								...
								(0, a.jsx)("ul", {
									className:
										"max-h-44 space-y-1.5 overflow-y-auto pr-1 text-[11px]",
									children: t.map((e, t) =>
										(0, a.jsxs)(
											"li",
											{
												...
												children: [
													(0, a.jsx)("span", {
														...
														style: { background: v[t % v.length] },
													}),
													(0, a.jsx)("button", {
														type: "button",
														className: (0, g.cn)(
															"min-w-0 flex-1 truncate text-left text-muted-foreground",
															o && "hover:text-foreground"
														),
														onClick: () => o?.(e.fullName || e.name),
														disabled: !o,
														children: e.name,
													}),
													(0, a.jsx)("span", {
			...
			function C({ children: e }) {
				return (0, a.jsx)("div", { className: "space-y-4", children: e });
			}
			let $ =
		...
		26518: (e, t, r) => {
			r.d(t, { bq: () => u, eb: () => b, gC: () => m, l6: () => d, yv: () => c });
			var a = r(95155);
			r(12115);
			var l = r(40287),
				o = r(66088),
				...
				i = r(91337);
			function d({ ...e }) {
				return (0, a.jsx)(l.bL, { "data-slot": "select", ...e });
			}
			function c({ ...e }) {
				return (0, a.jsx)(l.WT, { "data-slot": "select-value", ...e });
			}
			function u({ className: e, size: t = "default", children: r, ...n }) {
				return (0, a.jsxs)(l.l9, {
					...
					children: [
						...
						(0, a.jsx)(l.In, {
							asChild: !0,
							children: (0, a.jsx)(o.A, { className: "size-4 opacity-50" }),
						}),
					],
				});
			}
			function m({ className: e, children: t, position: r = "popper", ...o }) {
				return (0, a.jsx)(l.ZL, {
			...
			function g({ className: e, ...t }) {
				return (0, a.jsx)(l.PP, {
					...
					...t,
					children: (0, a.jsx)(s.A, { className: "size-4" }),
				});
			}
			function x({ className: e, ...t }) {
				return (0, a.jsx)(l.wn, {
					...
					...t,
					children: (0, a.jsx)(o.A, { className: "size-4" }),
				});
			}
		},
		31529: (e, t, r) => {
			r.d(t, { Gk: () => i, O9: () => s, gt: () => n });
			var a = r(95155),
				l = r(94290),
				o = r(91337);
			function n(e) {
				let t = e.toLowerCase();
				return (
					"customer_rating_score" === t ||
					"customer_satisfaction_score" === t ||
					"csat_score" === t ||
					"avg_rating" === t ||
					"csat_actual" === t ||
					"csat_target" === t ||
					"csat" === t ||
					(t.includes("satisfaction") && (t.includes("score") || t.includes("rating")))
				);
			}
			function s(e) {
			...
			function i({
				...
				let u = (function (e) {
						...
						if ("happy" === t) return 5;
						if ("neutral" === t) return 3;
						if ("unhappy" === t) return 1;
						let r = t.match(/(\d+(?:\.\d+)?)/);
						if (!r) return null;
						let a = Number(r[1]);
						return Number.isFinite(a) ? Math.max(0, Math.min(5, a)) : null;
					})(e),
					m = "sm" === r ? "h-3.5 w-3.5" : "lg" === r ? "h-6 w-6" : "h-4 w-4";
				if (!d && null == u)
					return (0, a.jsx)("span", {
				...
				return (0, a.jsxs)("span", {
					className: (0, o.cn)("inline-flex items-center gap-2", s),
					title: b ? `${b.toFixed(b % 1 ? 1 : 0)} / ${t}` : void 0,
					"aria-label": d
						? `Select rating out of ${t} stars`
						: `${b.toFixed(1)} out of ${t} stars`,
					children: [
						(0, a.jsx)("span", {
							className: "inline-flex items-center gap-0.5",
							children: Array.from({ length: t }, (e, t) => {
								let r = t + 1,
									n = Math.max(0, Math.min(1, b - t)),
									s = n > 0;
								return d && c
									? (0, a.jsx)(
											"button",
											{
												...
												"aria-label": `${r} star${1 === r ? "" : "s"}`,
												"aria-pressed": b >= r,
												onClick: () => c(r),
												children: (0, a.jsx)(l.A, {
													className: (0, o.cn)(m, s && "fill-dms-gold"),
													strokeWidth: 1.5,
												}),
											},
											t
						...
						n &&
							(0, a.jsxs)("span", {
								...
								children: [
									b ? (b % 1 == 0 ? b.toFixed(0) : b.toFixed(1)) : "—",
									(0, a.jsxs)("span", {
		...
		38291: (e, t, r) => {
			...
			function i({ className: e, variant: t, asChild: r = !1, ...o }) {
				let d = r ? l.DX : "span";
				return (0, a.jsx)(d, {
					"data-slot": "badge",
					className: (0, n.cn)(s({ variant: t }), e),
					...o,
				});
			}
		},
		40572: (e, t, r) => {
			r.d(t, { U8: () => w, Wh: () => y, bb: () => v, mo: () => j });
			var a = r(95155),
				l = r(38291),
				o = r(48368),
				n = r(84980),
			...
			function y({ status: e }) {
				...
				return (0, a.jsxs)(l.E, {
					...
					children: [(0, a.jsx)(r, { className: "h-3.5 w-3.5" }), t.label],
				});
			}
			function j({ reference: e, className: t }) {
				return (0, a.jsxs)(l.E, {
					variant: "outline",
					...
					children: [
						(0, a.jsx)(f.A, { className: "h-3.5 w-3.5" }),
						"Repeat Job",
						e
							? (0, a.jsxs)("span", {
			...
			function w({ paymentStatus: e, hasInvoice: t }) {
				...
				return (0, a.jsxs)(l.E, {
					variant: "outline",
					className: `${o.bgColor} ${o.color} border-0 gap-1.5`,
					children: [(0, a.jsx)(s, { className: "h-3.5 w-3.5" }), o.label],
				});
			}
		},
		45171: (e, t, r) => {
			...
			var a = r(95155),
				...
				s = r(74350),
				i = r(4474);
			function d({ open: e, onOpenChange: t, title: r, html: c }) {
				let u = (0, l.useRef)(null),
					m = (0, l.useMemo)(() => c || "", [c]);
				return (
					(0, l.useEffect)(() => {
						if (!e) return;
						let t = window.setTimeout(() => u.current?.contentWindow?.focus(), 200);
					...
					(0, a.jsx)(s.lG, {
						...
						children: (0, a.jsxs)(s.Cf, {
							className:
								"flex h-[min(90vh,920px)] w-[min(96vw,1100px)] max-w-none flex-col gap-0 overflow-hidden p-0 sm:rounded-xl",
							children: [
								(0, a.jsx)(s.c7, {
									className: "shrink-0 space-y-0 border-b px-4 py-3 text-left",
									children: (0, a.jsx)("div", {
										className: "flex items-center justify-between gap-3 pr-8",
										children: (0, a.jsxs)(s.L3, {
											className:
												"font-serif-display text-base font-semibold tracking-tight",
											children: ["Preview — ", r],
										}),
									}),
								}),
								(0, a.jsx)("div", {
									className: "min-h-0 flex-1 bg-muted/30 p-3",
									children: m
										? (0, a.jsx)("iframe", {
												ref: u,
												title: `PDF preview — ${r}`,
								...
								(0, a.jsxs)(s.Es, {
									className:
										"shrink-0 flex-row items-center justify-between gap-2 border-t bg-card px-4 py-3 sm:justify-between",
									children: [
										(0, a.jsx)("p", {
										...
										(0, a.jsxs)("div", {
											...
											children: [
												...
												(0, a.jsxs)(i.$, {
													...
													size: "sm",
													className:
														"bg-dms-gold text-[#0F172A] hover:bg-dms-gold/90",
													onClick: () => {
														let e = u.current?.contentWindow;
														e && (e.focus(), e.print());
													},
													disabled: !m,
													children: [
		...
		52118: (e, t, r) => {
			...
			function g({ fieldKey: e, value: t }) {
				...
				let o = String(t),
					x = (function (e, t) {
						let r = e.toLowerCase();
						if ("alert" === r && u[t]) return u[t];
						if ("payment_status" === r && c[t]) return c[t];
						if ("parts_status" === r && m[t]) return m[t];
						if ("customer_approval_status" === r && b[t]) return b[t];
						let a = s.bb[t];
						if (a) return { color: a.color, bg: a.bgColor, label: a.label };
						if (d[t]) return d[t];
						if (c[t]) return c[t];
						if (m[t]) return m[t];
						if (b[t]) return b[t];
			...
			function f({ data: e }) {
				...
				return (0, a.jsxs)("div", {
					...
					children: [
						(0, a.jsxs)("div", {
							className:
								"flex items-center justify-between border-b border-border/80 bg-muted/20 px-3 py-2",
							children: [
								(0, a.jsx)("p", {
						...
						(0, a.jsx)("div", {
							className: "dms-table-panel max-h-[min(65vh,760px)] overflow-auto",
							children: (0, a.jsxs)(l.XI, {
								children: [
									(0, a.jsx)(l.A0, {
										children: (0, a.jsx)(l.Hj, {
											children: r.map((e) =>
												(0, a.jsx)(
													l.nd,
													{
									...
									(0, a.jsx)(l.BF, {
										children:
											0 === n.length
												? (0, a.jsx)(l.Hj, {
														children: (0, a.jsx)(l.nA, {
															colSpan: Math.max(r.length, 1),
															className:
																"py-12 text-center text-sm text-muted-foreground",
															children: "No rows for this period",
														}),
												  })
												: n.map((e, n) =>
														(0, a.jsx)(
		...
		52335: (e, t, r) => {
			r.d(t, { M7: () => c, Oq: () => d, hn: () => i });
			var a = r(81672);
			function l(e) {
				let t = null == e ? "" : String(e);
			...
			function s(e, t) {
				...
				(a.href = r), (a.download = t), a.click(), URL.revokeObjectURL(r);
			}
			function i(e) {
				let t = e.columns.map((e) => e.key),
					r = e.columns.map((e) => l(e.label)).join(","),
					a = e.rows.map((e) => t.map((t) => l(e[t])).join(",")).join("\n");
				s(
					new Blob(
						[
							`${r}
${a}`,
					...
					`${e.report_id || "report"}_export.csv`
				);
			}
			function d(e) {
				let t = e.columns.map((e) => e.key),
					r = e.columns.map((e) => `<th>${n(e.label)}</th>`).join(""),
					l = e.rows
						.map((e) => `<tr>${t.map((t) => `<td>${n(o(e[t]))}</td>`).join("")}</tr>`)
						.join(""),
					i = Object.entries(e.summary || {})
						.filter(([, e]) => null == e || "object" != typeof e)
						.map(
							([e, t]) =>
								`<tr><td><b>${n(e.replace(/_/g, " "))}</b></td><td>${n(
									o(t)
								)}</td></tr>`
						)
						.join("");
...
<title>${n(e.title)}</title></head><body>
<h2>${n(e.title)}</h2>
<p>Generated: ${(0, a.r6)(new Date())}</p>
<table border="1"><thead><tr><th>KPI</th><th>Value</th></tr></thead><tbody>${i}</tbody></table>
<br/>
<table border="1"><thead><tr>${r}</tr></thead><tbody>${l}</tbody></table>
</body></html>`,
						],
						{ type: "application/vnd.ms-excel;charset=utf-8;" }
					),
					`${e.report_id || "report"}_export.xls`
				);
			}
			function c(e) {
				let t = e.columns.map((e) => e.key),
					...
					l = e.rows
						.map((e) => `<tr>${t.map((t) => `<td>${n(o(e[t]))}</td>`).join("")}</tr>`)
						.join(""),
					s = Object.entries(e.summary || {})
						.filter(([, e]) => null == e || "object" != typeof e)
						.map(
							([e, t]) =>
								`<div class="kpi"><span>${n(
									e.replace(/_/g, " ")
								)}</span><strong>${n(o(t))}</strong></div>`
						)
						.join("");
...
<h1>${n(e.title)}</h1>
<div class="meta">Generated ${(0, a.r6)(new Date())} \xb7 ${e.rows.length} rows</div>
${s ? `<div class="kpis">${s}</div>` : ""}
<table><thead><tr>${r}</tr></thead><tbody>${
					l || `<tr><td colspan="${Math.max(t.length, 1)}">No rows</td></tr>`
				}</tbody></table>
</body></html>`;
			}
		},
		79984: (e, t, r) => {
			r.d(t, { BT: () => i, Wu: () => d, ZB: () => s, Zp: () => o, aR: () => n });
			var a = r(95155);
			r(12115);
			var l = r(91337);
			function o({ className: e, ...t }) {
		...
		81672: (e, t, r) => {
			r.d(t, { Ge: () => u, N0: () => d, Yq: () => s, gQ: () => c, r6: () => i });
			let a = [
					"January",
					"February",
					"March",
			...
			function s(e, t = "") {
				let r = n(e);
				return r ? `${o(r.getDate())}/${o(r.getMonth() + 1)}/${r.getFullYear()}` : t;
			}
			function i(e, t = "", r = !1) {
				let a = n(e);
				if (!a) return t;
				let l = `${o(a.getHours())}:${o(a.getMinutes())}${
					r ? `:${o(a.getSeconds())}` : ""
				}`;
				return `${s(a)} ${l}`;
			}
		...
		99916: (e, t, r) => {
			...
			function s({
				...
				return (0, a.jsxs)(o.$, {
					...
					"aria-label": r,
					title: r,
					className: (0, n.cn)("h-9 shrink-0 gap-1.5 text-muted-foreground", i),
					children: [
						(0, a.jsx)(l.A, { "aria-hidden": "true" }),
						(0, a.jsx)("span", { className: "hidden sm:inline", children: r }),
					],
				});
			}
		},
