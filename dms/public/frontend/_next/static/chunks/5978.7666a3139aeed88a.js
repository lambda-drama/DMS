...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5978],
	{
		...
		29947: (e, t, a) => {
			...
			function g() {
				let { navigate: e } = (0, o.c)(),
					[t, a] = (0, b.useState)(!1),
					{ error: g, success: j, showError: N, clear: w } = (0, x.B)(),
					[C, _] = (0, b.useState)({
						title: "",
						customer: "",
						stage: "New",
					...
					{ data: k } = (0, h.Ay)("crm-opp-form-options", n.Er),
					A = (0, b.useMemo)(
						() => (k?.stages || y).map((e) => ({ value: e, label: e })),
						[k]
					),
					D = (0, b.useMemo)(
						() => (k?.companies || []).map((e) => ({ value: e, label: e })),
						[k]
					);
				(0, b.useEffect)(() => {
					k?.default_company &&
						!C.company &&
						_((e) => ({ ...e, company: k.default_company || "" }));
				}, [k, C.company]);
				let { data: R } = (0, h.Ay)(
						["crm-opp-branches", C.company],
						() => (0, n.Dd)(C.company || void 0),
						{ keepPreviousData: !0 }
					),
					F = (e, t) => _((a) => ({ ...a, [e]: t })),
					I = async () => {
						if ((w(), !C.title.trim())) return void N("Title is required.");
						if (!C.customer) return void N("Select a customer.");
						if (!C.company) return void N("Company is required.");
						a(!0);
						try {
							let t = await (0, n.MG)({
								title: C.title.trim(),
								customer: C.customer,
								stage: C.stage,
								expected_value: C.expected_value ? Number(C.expected_value) : 0,
								model: C.model || void 0,
								brand: C.brand || void 0,
								preferred_color: C.preferred_color || void 0,
								company: C.company,
								branch: C.branch || void 0,
								next_action: C.next_action || void 0,
								expected_close_date: C.expected_close_date || void 0,
								status:
									"Won" === C.stage
										? "Won"
										: "Lost" === C.stage
				...
				return (0, r.jsxs)("div", {
					...
					children: [
						(0, r.jsx)(x.y, { error: g, success: j, onDismiss: w }),
						(0, r.jsxs)(u.Zp, {
									...
									children: [
										...
										(0, r.jsxs)("div", {
											...
											children: [
												...
												(0, r.jsx)(m.p, {
													type: "date",
													value: C.expected_close_date,
													onChange: (e) =>
														F("expected_close_date", e.target.value),
												}),
											],
										}),
										(0, r.jsxs)("div", {
											...
											children: [
												...
												(0, r.jsx)(m.p, {
													...
													onChange: (e) =>
														F("expected_value", e.target.value),
												}),
											],
										}),
										(0, r.jsxs)("div", {
										...
										(0, r.jsxs)("div", {
											...
											children: [
												...
												(0, r.jsx)(c.s, {
													value: C.preferred_color,
													onValueChange: (e) => F("preferred_color", e),
												}),
											],
										}),
										(0, r.jsxs)("div", {
		...
		57518: (e, t, a) => {
			...
			var g = "TabsList",
				j = r.forwardRef((e, t) => {
					let { __scopeTabs: a, loop: r = !0, ...n } = e,
						o = h(g, a),
						l = v(a);
					return (0, m.jsx)(s.bL, {
						asChild: !0,
			...
			var N = "TabsTrigger",
				w = r.forwardRef((e, t) => {
					let { __scopeTabs: a, value: r, disabled: o = !1, ...l } = e,
						i = h(N, a),
						d = v(a),
						u = k(i.baseId, r),
						p = A(i.baseId, r),
			...
			var C = "TabsContent",
				_ = r.forwardRef((e, t) => {
					let { __scopeTabs: a, value: n, forceMount: o, children: s, ...i } = e,
						d = h(C, a),
						u = k(d.baseId, n),
						p = A(d.baseId, n),
						f = n === d.value,
		...
		83478: (e, t, a) => {
			...
			var _ = r.forwardRef((e, t) => {
					...
					return (
						r.useEffect(() => {
							let e = _.current;
							if (e)
								return e.addEventListener(f, T), () => e.removeEventListener(f, T);
						}, [T]),
						(0, p.jsx)(N, {
							scope: a,
							orientation: o,
							...
							loop: l,
							currentTabStopId: D,
							onItemFocus: r.useCallback((e) => F(e), [F]),
					...
					return (
						...
						(0, p.jsx)(b.ItemSlot, {
							...
							children: (0, p.jsx)(i.sG.span, {
								...
								ref: t,
								onMouseDown: (0, n.mK)(e.onMouseDown, (e) => {
									o ? x.onItemFocus(f) : e.preventDefault();
								}),
								onFocus: (0, n.mK)(e.onFocus, () => x.onItemFocus(f)),
								onKeyDown: (0, n.mK)(e.onKeyDown, (e) => {
								...
								children:
									"function" == typeof d
										? d({ isCurrentTabStop: v, hasTabStop: null != N })
										: d,
							}),
						})
					);
			...
			function R(e, t = !1) {
				...
				for (let r of e)
					if (r === a || (r.focus({ preventScroll: t }), document.activeElement !== a))
						return;
			}
			var F = C,
				I = A;
