...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[9599],
	{
		...
		22164: (e, t, a) => {
			a.d(t, { A: () => r });
			let r = (0, a(90425).A)("external-link", [
					...
					(0, r.useEffect)(() => {
						try {
							JSON.stringify(n) === JSON.stringify(a)
								...
								: window.localStorage.setItem(s, JSON.stringify(n));
						} catch {}
					}, [s, n, a]),
					[n, l]
				);
		...
		31529: (e, t, a) => {
			...
			function d({
				...
				let u = (function (e) {
					...
					m = "sm" === a ? "h-3.5 w-3.5" : "lg" === a ? "h-6 w-6" : "h-4 w-4";
				if (!o && null == u)
					return (0, r.jsx)("span", {
				...
				return (0, r.jsxs)("span", {
					className: (0, n.cn)("inline-flex items-center gap-2", i),
					title: x ? `${x.toFixed(x % 1 ? 1 : 0)} / ${t}` : void 0,
					"aria-label": o
						? `Select rating out of ${t} stars`
						: `${x.toFixed(1)} out of ${t} stars`,
					children: [
						(0, r.jsx)("span", {
							className: "inline-flex items-center gap-0.5",
							children: Array.from({ length: t }, (e, t) => {
								let a = t + 1,
									l = Math.max(0, Math.min(1, x - t)),
									i = l > 0;
								return o && c
									? (0, r.jsx)(
											"button",
											{
												...
												"aria-label": `${a} star${1 === a ? "" : "s"}`,
												"aria-pressed": x >= a,
												onClick: () => c(a),
												children: (0, r.jsx)(s.A, {
													className: (0, n.cn)(m, i && "fill-dms-gold"),
													strokeWidth: 1.5,
												}),
											},
											t
		...
		33745: (e, t, a) => {
			...
			var r = a(95155),
				...
				l = a(4474),
				i = a(91337);
			function d({ module: e, label: t, className: a, ...o }) {
				...
				return c(e)
					? (0, r.jsxs)(l.$, {
							...
							...o,
							children: [
								(0, r.jsx)(s.A, { className: "h-4 w-4 shrink-0" }),
								(0, r.jsx)("span", {
		...
		38291: (e, t, a) => {
			...
			function d({ className: e, variant: t, asChild: a = !1, ...n }) {
				let o = a ? s.DX : "span";
				return (0, r.jsx)(o, {
					"data-slot": "badge",
		...
		43447: (e, t, a) => {
			...
			var s = a(61108),
				n = a(91337);
			function l({ ...e }) {
				return (0, r.jsx)(s.bL, { "data-slot": "dropdown-menu", ...e });
			}
			function i({ ...e }) {
				return (0, r.jsx)(s.l9, { "data-slot": "dropdown-menu-trigger", ...e });
			}
			...
			function o({ className: e, inset: t, variant: a = "default", ...l }) {
				return (0, r.jsx)(s.q7, {
		...
		49580: (e, t, a) => {
			...
			function o({
				...
				let b = (r) => {
						e &&
							t &&
							(function (e, t, a = "Standard", r) {
								let s = new URLSearchParams();
								s.set("doctype", e),
									s.set("name", t),
									s.set("format", a),
									s.set("trigger_print", String(r?.triggerPrint ?? 0)),
									s.set("no_letterhead", String(r?.noLetterhead ?? 0));
								let n = window.location.origin;
								window.open(
									`${n}/printview?${s.toString()}`,
									"_blank",
									"noopener,noreferrer"
								);
							})(e, t, r, { noLetterhead: a, triggerPrint: c });
					},
					j = async (a) => {
						if ((a.stopPropagation(), a.preventDefault(), !g && e && t)) {
							...
							try {
								let t = x;
								if (!t) {
									let a = await (0, l.Iy)(e);
									(t = a.length ? a : ["Standard"]), h(t);
								}
				...
				return x && x.length > 1
							...
							children: [
								(0, r.jsx)(d.ty, {
									...
									children: (0, r.jsxs)(i.$, {
										...
										children: [
											(0, r.jsx)(n.A, {
												className: y ? "h-4 w-4" : "h-4 w-4 mr-2",
											}),
											!y && "Print",
										],
									}),
					...
					: (0, r.jsxs)(i.$, {
							...
							onClick: j,
							children: [
								(0, r.jsx)(n.A, { className: y ? "h-4 w-4" : "h-4 w-4 mr-2" }),
								!y && "Print",
							],
					  });
			}
					...
					let { mutate: n } = (0, s.iX)(),
						...
						[m, x, h] = ((e) => {
							let [, t] = (0, r.useState)({}),
								a = (0, r.useRef)(!1),
								s = (0, r.useRef)(e),
								n = (0, r.useRef)({ data: !1, error: !1, isValidating: !1 }),
								i = (0, r.useCallback)((e) => {
									let r = !1,
										l = s.current;
									for (let t in e)
						...
						f = m.current,
						p = (0, r.useCallback)(async (e, t) => {
							let [a, r] = (0, l.s)(d.current);
							if (!o.current)
							...
							let s = (0, l.m)(
								...
								m = (0, l.o)();
							(u.current = m), h({ isMutating: !0 });
							try {
								let t = await n(
									a,
									o.current(r, { arg: e }),
									(0, l.m)(s, { throwOnError: !0 })
								);
								return (
									u.current <= m &&
										(i(() => h({ data: t, isMutating: !1, error: void 0 })),
										null == s.onSuccess || s.onSuccess.call(s, t, a, s)),
									t
								);
							} catch (e) {
								if (
									u.current <= m &&
									(i(() => h({ error: e, isMutating: !1 })),
									null == s.onError || s.onError.call(s, e, a, s),
									s.throwOnError)
								)
									throw e;
							}
						...
						g = (0, r.useCallback)(() => {
							(u.current = (0, l.o)()), h({ data: l.U, error: l.U, isMutating: !1 });
						}, []);
					return (
						(0, l.u)(() => {
							(d.current = e), (o.current = t), (c.current = a);
						}),
						{
							trigger: p,
							reset: g,
							get data() {
								return (x.data = !0), f.data;
							},
							get error() {
								return (x.error = !0), f.error;
							},
							get isMutating() {
								return (x.isMutating = !0), f.isMutating;
							},
						}
					);
				});
		...
		63410: (e, t, a) => {
			...
			function M() {
				let { navigate: e, viewParams: t } = (0, i.c)(),
					[a, M] = (0, l.P)("deliveries", "search", ""),
					[C, $] = (0, n.useState)(null);
				(0, n.useEffect)(() => {
					let e = t.get("id");
					e && $(e);
				}, [t]);
				let { data: D, isLoading: z, error: F } = (0, o.CU)({ search: a || void 0 }),
					H = D?.find((e) => e.name === C),
					O = {
						total: D?.length || 0,
						draft: D?.filter((e) => 0 === e.docstatus).length || 0,
						submitted: D?.filter((e) => 1 === e.docstatus).length || 0,
					};
				return (0, r.jsxs)("div", {
					...
					children: [
								...
								(0, r.jsxs)("div", {
									...
									children: [
										(0, r.jsx)("h1", {
											...
											children: "Vehicle Deliveries",
										}),
										(0, r.jsx)("p", {
											className:
												"mt-1 hidden text-muted-foreground sm:block",
											children: "Manage vehicle delivery and handover",
										}),
									],
								}),
								(0, r.jsx)(d.l, {
									...
									children: (0, r.jsx)(m.Wu, {
										...
										children: (0, r.jsxs)("div", {
											...
											children: [
												(0, r.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-primary/10 p-2 sm:order-2",
									...
									children: (0, r.jsx)(m.Wu, {
										...
										children: (0, r.jsxs)("div", {
											...
											children: [
												(0, r.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-[#F9A825]/10 p-2 sm:order-2",
									...
									children: (0, r.jsx)(m.Wu, {
										...
										children: (0, r.jsxs)("div", {
											...
											children: [
												(0, r.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-[#2E7D32]/10 p-2 sm:order-2",
							...
							children: (0, r.jsx)(m.Wu, {
								...
								children: (0, r.jsxs)("div", {
									...
									children: [
										...
										(0, r.jsx)(u.p, {
											placeholder:
												"Search by delivery ID, vehicle, customer...",
											value: a,
						...
						(0, r.jsxs)(m.Zp, {
							children: [
								(0, r.jsx)(m.aR, {
									children: (0, r.jsx)(m.ZB, { children: "Deliveries List" }),
								}),
								(0, r.jsx)(m.Wu, {
									children: z
										? (0, r.jsx)("div", {
										...
										? (0, r.jsx)("div", {
												...
												children: "Failed to load deliveries",
										  })
										: D && D.length > 0
										? (0, r.jsx)("div", {
												className: "dms-table-panel",
												children: (0, r.jsxs)(h.XI, {
													children: [
														(0, r.jsx)(h.A0, {
															children: (0, r.jsxs)(h.Hj, {
																children: [
																	(0, r.jsx)(h.nd, {
																											...
																											r.jsxs)(
																												f._2,
																												{
																													onClick:
																														() =>
																															window.open(
																																`/app/vehicle-delivery-note/${t.name}`,
																																"_blank"
																															),
																													children:
																														[
						...
						(0, r.jsx)(p.BN, {
							...
							badge: H
								? {
										label: S[H.docstatus]?.label || "Draft",
										variant: S[H.docstatus]?.variant,
								  }
								: void 0,
							onOpenInDesk: () =>
								window.open(`/app/vehicle-delivery-note/${C}`, "_blank"),
							children:
								H &&
								(0, r.jsxs)(r.Fragment, {
									children: [
										(0, r.jsxs)(p.JH, {
											...
											children: [
												...
												(0, r.jsx)(p.Qb, {
													label: "Delivered By",
													value: H.delivered_by,
												}),
												(0, r.jsx)(p.Qb, {
													label: "Delivery Date",
													value: H.delivery_date_time
														? (0, s.r6)(H.delivery_date_time)
														: void 0,
												}),
											],
										}),
										(0, r.jsxs)(p.JH, {
											...
											children: [
												...
												(0, r.jsx)(p.Qb, {
													label: "Model",
													value: H.vehicle_model,
												}),
												(0, r.jsx)(p.Qb, {
													label: "License Plate",
													value: H.license_plate,
												}),
												(0, r.jsx)(p.Qb, {
													label: "Final Odometer",
													value: H.final_odometer_km
														? `${H.final_odometer_km} km`
														: void 0,
												}),
											],
										}),
										(0, r.jsxs)(p.JH, {
											...
											children: [
												(0, r.jsx)(p.Qb, {
													...
													value: (0, r.jsx)(A.Gk, {
														value:
															H.customer_satisfaction_score ??
															H.customer_satisfaction_initial,
														size: "md",
													}),
												}),
												H.customer_satisfaction_initial
													? (0, r.jsx)(p.Qb, {
															label: "Label",
															value: H.customer_satisfaction_initial,
													  })
													: null,
												H.customer_comments
													? (0, r.jsx)(p.Qb, {
															label: "Comments",
															value: H.customer_comments,
													  })
													: null,
											],
										}),
										(0, r.jsxs)(p.JH, {
											...
											children: [
												(0, r.jsx)(p.Qb, {
													label: "Due KM",
													value: H.next_service_due_km
														? `${H.next_service_due_km} km`
														: void 0,
												}),
												(0, r.jsx)(p.Qb, {
													label: "Due Date",
													value: H.next_service_due_date
														? (0, s.Yq)(H.next_service_due_date)
														: void 0,
												}),
											],
										}),
		...
		79984: (e, t, a) => {
			a.d(t, { BT: () => d, Wu: () => o, ZB: () => i, Zp: () => n, aR: () => l });
			var r = a(95155);
			a(12115);
			var s = a(91337);
		...
		81672: (e, t, a) => {
			a.d(t, { Ge: () => u, N0: () => o, Yq: () => i, gQ: () => c, r6: () => d });
			let r = [
					"January",
					"February",
					"March",
			...
			function i(e, t = "") {
				let a = l(e);
				return a ? `${n(a.getDate())}/${n(a.getMonth() + 1)}/${a.getFullYear()}` : t;
			}
			function d(e, t = "", a = !1) {
				let r = l(e);
				if (!r) return t;
				let s = `${n(r.getHours())}:${n(r.getMinutes())}${
					a ? `:${n(r.getSeconds())}` : ""
				}`;
				return `${i(r)} ${s}`;
			}
			...
			function c(e, t = "") {
				let a = l(e);
				return a ? s[a.getDay()] : t;
			}
			function u(e, t = "") {
				let a = l(e);
				return a ? `${s[a.getDay()]}, ${i(a)}` : t;
			}
		},
		83786: (e, t, a) => {
			a.d(t, {
		...
		89803: (e, t, a) => {
			...
			var s = a(42442),
				...
				o = r.forwardRef((e, t) => {
					var a;
					let { decorative: r, orientation: s = i, ...o } = e,
						c = ((a = s), d.includes(a)) ? s : i;
					return (0, n.jsx)(l.div, {
						"data-orientation": c,
						...(r
							? { role: "none" }
							: {
		...
		93408: (e, t, a) => {
			...
			var r = a(95155),
				s = a(49580);
			function n({ children: e, doctype: t, docName: a, showPrint: l = !0 }) {
				return (0, r.jsxs)("div", {
					className: "flex items-center justify-end gap-0.5",
					onClick: (e) => e.stopPropagation(),
					children: [
						e,
						l ? (0, r.jsx)(s.e, { variant: "icon", doctype: t, docName: a }) : null,
					],
				});
			}
		},
		...
		98883: (e, t, a) => {
			...
			var s = a(29483),
				...
				l = a(91337);
			function i({ ...e }) {
				return (0, r.jsx)(s.bL, { "data-slot": "sheet", ...e });
			}
			function d({ ...e }) {
				return (0, r.jsx)(s.ZL, { "data-slot": "sheet-portal", ...e });
			}
			function o({ className: e, ...t }) {
				return (0, r.jsx)(s.hJ, {
			...
			function c({ className: e, children: t, side: a = "right", ...i }) {
				return (0, r.jsxs)(d, {
					children: [
						(0, r.jsx)(o, {}),
						(0, r.jsxs)(s.UC, {
								...
								children: (0, r.jsx)("div", {
									...
									children: (0, r.jsxs)("div", {
										...
										children: [
											...
											s && (0, r.jsx)(x, { className: "mt-1", children: s }),
										],
									}),
								}),
							}),
							(0, r.jsx)(f.w, { className: "bg-(--dms-green)/20" }),
							d
								? (0, r.jsx)("div", {
			...
			function v({ title: e, children: t, className: a }) {
				return (0, r.jsxs)("div", {
