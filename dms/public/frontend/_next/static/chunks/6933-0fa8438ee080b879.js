...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6933],
	{
		2958: (e, t, a) => {
			...
			function f({
				...
				let [v, j] = (0, s.useState)(!1),
					...
					[A, J] = (0, s.useState)(""),
					[C, z] = (0, s.useState)(e || ""),
					[q, I] = (0, s.useState)("Pcs"),
					[E, D] = (0, s.useState)(""),
					[B, F] = (0, s.useState)([{ value: "Pcs", label: "Pcs" }]),
					[M, Z] = (0, s.useState)(!!t);
				async function L() {
					let e = w.trim(),
						t = (T.trim() || e).trim();
					if (!e) return void i.o.error("Item code is required");
					if (!C)
						return void i.o.error(
							"Configure Default Item Group on DMS Settings first"
						);
					S(!0);
					try {
						let a = await p.w_({
								item_code: e,
								item_name: t,
								valuation_rate: P ? Number(P) : void 0,
								standard_rate: A ? Number(A) : void 0,
								item_group: C,
								stock_uom: q || "Pcs",
								bin_location: E.trim() || void 0,
							}),
							r = {
								item_code: a.item_code || a.name,
								item_name: a.item_name || a.label || e,
								valuation_rate: a.valuation_rate,
						...
						b(r.item_code),
							...
							i.o.success(
								r.spare_part
									? `Created item, spare part (${r.spare_part})${
											a.price_list ? `, and price on ${a.price_list}` : ""
									  }`
									: `Created item ${r.item_code}${
											a.price_list ? ` with price on ${a.price_list}` : ""
									  }`
							),
							j(!1);
					} catch (e) {
						i.o.error(e instanceof Error ? e.message : "Could not create item");
					} finally {
						S(!1);
					}
				}
					...
					return (
						(async () => {
							try {
								let t = await p.mH();
								if (a) return;
								!e && t.default_item_group && z(t.default_item_group),
									t.uoms?.length && F(t.uoms),
									I(t.default_stock_uom || "Pcs"),
									Z(!!t.auto_create_spare_parts);
							} catch {}
						})(),
						() => {
							a = !0;
						...
						(0, r.jsx)(o.lG, {
							...
							children: (0, r.jsxs)(o.Cf, {
								...
								children: [
									(0, r.jsxs)(o.c7, {
										children: [
											(0, r.jsx)(o.L3, { children: "New stock item" }),
											(0, r.jsxs)(o.rr, {
												children: [
													"Creates an ERPNext Item using the default item group from DMS Settings. Selling price also creates an Item Price on the default selling price list configured in DMS Settings.",
													M
									...
									(0, r.jsxs)("div", {
										...
										children: [
											(0, r.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, r.jsx)(c.J, { children: "Item code *" }),
													(0, r.jsx)(d.p, {
														value: w,
											...
											(0, r.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, r.jsx)(c.J, { children: "Item name" }),
													(0, r.jsx)(d.p, {
														value: T,
											...
											(0, r.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, r.jsx)(c.J, { children: "Default UOM" }),
													(0, r.jsxs)(m.l6, {
														value: q,
														onValueChange: I,
														children: [
															(0, r.jsx)(m.bq, {
																children: (0, r.jsx)(m.yv, {
																	placeholder: "Pcs",
																}),
															}),
															(0, r.jsx)(m.gC, {
											...
											(0, r.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, r.jsx)(c.J, { children: "Bin location" }),
													(0, r.jsx)(d.p, {
														value: E,
											...
											(0, r.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, r.jsx)(c.J, { children: "Item group" }),
													(0, r.jsx)(d.p, {
														value: C,
														disabled: !0,
														placeholder: "From DMS Settings",
													}),
												],
											}),
										],
		...
		21219: (e, t, a) => {
			...
			var r = a(49876);
			let s = "dms.api.stock_operations";
			function n(e) {
			...
			async function i(e) {
				return (0, r.AT)(`/api/method/${s}.get_stock_operation_defaults_api`, {
					method: "POST",
					body: JSON.stringify({ company: e || null }),
				});
			}
			async function o(e, t, a = 20) {
				return (0, r.AT)(`/api/method/${s}.search_stock_items_for_ui`, {
					method: "POST",
					body: JSON.stringify({ search: e || null, warehouse: t || null, limit: a }),
				});
			}
			async function l(e) {
				return (0, r.AT)(`/api/method/${s}.get_stock_entry_detail`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function d(e) {
				return (0, r.AT)(`/api/method/${s}.get_stock_entries`, {
					method: "POST",
					body: JSON.stringify({
			...
			async function c(e) {
				return (0, r.AT)(`/api/method/${s}.get_stock_reconciliations`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 30,
			...
			async function u(e) {
				return (0, r.AT)(`/api/method/${s}.get_material_request_defaults_api`, {
					method: "POST",
					body: JSON.stringify({ company: e || null }),
				});
			}
			async function m(e) {
				return (0, r.AT)(`/api/method/${s}.get_material_requests`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 30,
			...
			async function p(e) {
				return (0, r.AT)(`/api/method/${s}.get_item_uoms_for_ui_api`, {
					method: "POST",
					body: JSON.stringify({ item_code: e }),
				});
			}
			async function f(e) {
				return (0, r.AT)(`/api/method/${s}.create_material_request`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function h(e) {
				return (0, r.AT)(`/api/method/${s}.get_pending_material_requests`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 50,
			...
			async function g(e) {
				return (0, r.AT)(`/api/method/${s}.get_material_request_detail`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function b(e, t = !0) {
				return (0, r.AT)(`/api/method/${s}.create_stock_entry_from_material_request`, {
					method: "POST",
			...
			async function x(e, t) {
				return (0, r.AT)(
					`/api/method/${s}.create_purchase_receipt_from_material_request`,
					{
						method: "POST",
						body: JSON.stringify({
							name: e,
			...
			async function _(e) {
				return (0, r.AT)(`/api/method/${s}.create_stock_entry`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function y(e) {
				return (0, r.AT)(`/api/method/${s}.create_stock_reconciliation`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function v(e) {
				return (0, r.AT)(`/api/method/${s}.get_purchase_receipt_defaults_api`, {
					method: "POST",
					body: JSON.stringify({ company: e || null }),
				});
			}
			async function j(e, t = 20) {
				return (0, r.AT)(`/api/method/${s}.search_suppliers_for_ui`, {
					method: "POST",
					body: JSON.stringify({ search: e || null, limit: t }),
				});
			}
			async function N(e) {
				return (0, r.AT)(`/api/method/${s}.create_supplier`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function S(e) {
				return (0, r.AT)(`/api/method/${s}.get_purchase_receipts`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 30,
			...
			async function w(e) {
				return (0, r.AT)(`/api/method/${s}.get_purchase_receipt_detail`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function O(e) {
				return (0, r.AT)(`/api/method/${s}.create_purchase_receipt`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function T(e, t) {
				let a = await (0, r.AT)(`/api/method/${s}.get_item_price_list_rate_api`, {
					method: "POST",
			...
			async function k() {
				return (0, r.AT)(`/api/method/${s}.get_stock_item_create_defaults_api`, {
					method: "POST",
					body: JSON.stringify({}),
				});
			}
			async function P(e) {
				return (0, r.AT)(`/api/method/${s}.create_stock_item`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
		...
		26518: (e, t, a) => {
			...
			function f({ className: e, ...t }) {
				return (0, r.jsx)(s.PP, {
					...
					...t,
					children: (0, r.jsx)(o.A, { className: "size-4" }),
				});
			}
		...
		38291: (e, t, a) => {
			...
			function l({ className: e, variant: t, asChild: a = !1, ...n }) {
				let d = a ? s.DX : "span";
				return (0, r.jsx)(d, {
					"data-slot": "badge",
		...
		42074: (e, t, a) => {
			...
			function o({ children: e, className: t, align: a = "end" }) {
				...
				return l ? (0, n.createPortal)(c, document.body) : null;
			}
		},
		52959: (e, t, a) => {
			a.d(t, { _: () => o });
		...
		79984: (e, t, a) => {
			a.d(t, { BT: () => l, Wu: () => d, ZB: () => o, Zp: () => n, aR: () => i });
			var r = a(95155);
			a(12115);
			var s = a(91337);
