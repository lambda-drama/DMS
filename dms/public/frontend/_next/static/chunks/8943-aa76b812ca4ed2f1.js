...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[8943],
	{
		...
		47279: (e, t, r) => {
			...
			function k(e) {
				let {
					...
					[m, k] = (0, l.i)({ prop: r, defaultProp: i ?? !1, onChange: s, caller: p }),
					[b, g] = a.useState(null),
					[w, x] = a.useState(null),
					A = a.useRef(!1),
					j = !b || !!c || !!b.closest("form"),
					C = {
						checked: m,
						disabled: o,
						setChecked: k,
			...
			var b = "CheckboxTrigger",
				g = a.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...i }, l) => {
					let {
							control: c,
							value: d,
							disabled: s,
			...
			var w = a.forwardRef((e, t) => {
				...
				return (0, h.jsx)(k, {
					...
					internal_do_not_use_render: ({ isFormControl: e }) =>
						(0, h.jsxs)(h.Fragment, {
							children: [
								(0, h.jsx)(g, { ...u, ref: t, __scopeCheckbox: r }),
								e && (0, h.jsx)(C, { __scopeCheckbox: r }),
							],
						}),
				});
			});
			...
			var x = "CheckboxIndicator",
				A = a.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: a, ...n } = e,
						i = m(x, r);
					return (0, h.jsx)(s.C, {
						present: a || M(i.checked) || !0 === i.checked,
				...
				C = a.forwardRef(({ __scopeCheckbox: e, ...t }, r) => {
					...
					a.useEffect(() => {
						...
						if (x !== l && e) {
							...
							(b.indeterminate = M(l)), e.call(b, !M(l) && l), b.dispatchEvent(r);
						}
					}, [b, x, l, o]);
					let C = a.useRef(!M(l) && l);
		...
		57518: (e, t, r) => {
			...
			var x = "TabsTrigger",
				A = a.forwardRef((e, t) => {
					let { __scopeTabs: r, value: a, disabled: i = !1, ...l } = e,
						d = k(x, r),
						s = v(r),
						u = M(d.baseId, a),
						p = R(d.baseId, a),
			...
			var j = "TabsContent",
				C = a.forwardRef((e, t) => {
					let { __scopeTabs: r, value: n, forceMount: i, children: o, ...d } = e,
						s = k(j, r),
						u = M(s.baseId, n),
						p = R(s.baseId, n),
						f = n === s.value,
			...
			let l = o.r
				...
				c = (0, n.Ht)(i.Ay, () => (e, t, r = {}) => {
					let { mutate: i } = (0, n.iX)(),
						...
						y = h.current,
						v = (0, a.useCallback)(async (e, t) => {
							let [r, a] = (0, o.s)(c.current);
							if (!d.current)
