	...
	[6593],
	{
		...
		24279: (e, t, n) => {
			...
			function rI() {
				var e = rT;
				return (
					null !== e && (null === i1 ? (i1 = e) : i1.push.apply(i1, e), (rT = null)), e
				);
			}
			function rU(e) {
			...
			var ol = {
					...
					useOptimistic: function (e) {
						...
						return (
							(t.queue = n), (t = a7.bind(null, lG, !0, n)), (n.dispatch = t), [e, t]
						);
					},
					useMemoCache: ac,
			...
			function o$(e, t) {
				return (
					((t = oj({ mode: "visible", children: t }, e.mode)).return = e), (e.child = t)
				);
			}
			function oj(e, t) {
			...
			var cU = o.version;
			if ("19.2.6" !== cU) throw Error(u(527, cU, "19.2.6"));
			if (
