...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[3317],
	{
		...
		21531: (e, a, t) => {
			...
			var r = t(49876);
			let s = "dms.api.spare_part_sales";
			async function n(e) {
				return (0, r.AT)(`/api/method/${s}.get_spare_part_sales_defaults`, {
					method: "POST",
					body: JSON.stringify({ company: e || null }),
				});
			}
			async function i(e) {
				return (0, r.AT)(`/api/method/${s}.search_spare_parts_for_sale`, {
					method: "POST",
					body: JSON.stringify({
			...
			async function l(e) {
				return (0, r.AT)(`/api/method/${s}.create_spare_part_sale`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function o(e) {
				return (0, r.AT)(`/api/method/${s}.list_spare_part_proformas`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
			...
			async function c(e) {
				return (0, r.AT)(`/api/method/${s}.get_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function d(e) {
				return (0, r.AT)(`/api/method/${s}.create_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function m(e) {
				return (0, r.AT)(`/api/method/${s}.update_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function u(e, a) {
				return (0, r.AT)(`/api/method/${s}.convert_proforma_to_sales_invoice`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: a || {} }),
				});
			}
			async function p(e) {
				return (0, r.AT)(`/api/method/${s}.cancel_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function h(e) {
				return (0, r.AT)(`/api/method/${s}.delete_draft_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function _(e) {
				return (0, r.AT)(`/api/method/${s}.amend_spare_part_proforma`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
		...
		23317: (e, a, t) => {
			...
			function z() {
				let { canCreate: e, canWrite: a } = (0, n.Sk)(),
					{ navigate: t, viewParams: z } = (0, i.c)(),
					F = z.get("id") || "",
					[I, M] = (0, s.useState)(F),
					[q, Z] = (0, s.useState)(""),
					[D, W] = (0, s.useState)(!!F),
					[E, H] = (0, s.useState)(""),
					[U, B] = (0, s.useState)(""),
					[R, K] = (0, s.useState)(null),
					[Q, X] = (0, s.useState)(!0),
					[G, Y] = (0, s.useState)(""),
					[ee, ea] = (0, s.useState)(""),
					[et, er] = (0, s.useState)(null),
					[es, en] = (0, s.useState)(""),
					[ei, el] = (0, s.useState)(""),
					[eo, ec] = (0, s.useState)(""),
					[ed, em] = (0, s.useState)(null),
					[eu, ep] = (0, s.useState)(""),
					[eh, e_] = (0, s.useState)(""),
					[ex, ev] = (0, s.useState)(""),
					[ef, eg] = (0, s.useState)(""),
					[eb, ej] = (0, s.useState)(() => new Date().toISOString().split("T")[0]),
					[ey, eN] = (0, s.useState)(V),
					[ew, eS] = (0, s.useState)(""),
					[eC, ek] = (0, s.useState)(!0),
					[eA, eO] = (0, s.useState)([T()]),
					[e$, eJ] = (0, s.useState)([P()]),
					[eL, eT] = (0, s.useState)(""),
					[eP, eV] = (0, s.useState)(!1),
					[ez, eF] = (0, s.useState)(null),
					[eI, eM] = (0, s.useState)(!1),
					[eq, eZ] = (0, s.useState)(null),
					[eD, eW] = (0, s.useState)("none"),
					[eE, eH] = (0, s.useState)(""),
					[eU, eB] = (0, s.useState)(""),
					[eR, eK] = (0, s.useState)([]),
					[eQ, eX] = (0, s.useState)(!1),
					[eG, eY] = (0, s.useState)(!1),
					[e0, e1] = (0, s.useState)("none"),
					[e2, e5] = (0, s.useState)(""),
					e4 = e("proforma-invoices") || a("proforma-invoices");
				(0, s.useEffect)(() => {
					F && F !== I && M(F);
				}, [F, I]);
				let { data: e3, isLoading: e9 } = (0, l.Rr)(U),
					{ data: e6, isLoading: e7 } = (0, l.dQ)(es),
					{ data: e8 } = (0, l.Ms)(),
					{ data: ae, isLoading: aa } = (0, l.mv)(ee || void 0, ei),
					{ data: at, isLoading: ar } = (0, l.iR)(ef, eu || void 0),
					as = ed?.model || ed?.resolved_vehicle_model || void 0,
					{ data: an, isLoading: ai } = (0, l.Sg)(eL, as, eo || void 0),
					al = (0, s.useMemo)(() => {
						let e =
							at?.map((e) => ({
								value: e.name,
						...
						return (
							ex &&
								...
								e.unshift({
									...
									label: ex,
									description:
										ed?.model_name || ed?.resolved_vehicle_model_label || "",
								}),
							e
						);
					}, [at, ex, ed]),
					ao = (0, s.useCallback)(
						async (e) => {
							X(!0);
							try {
								let a = await S.$2(e || void 0);
								K(a),
									!E && a.company && H(a.company),
									!G && a.default_warehouse && Y(a.default_warehouse);
							} catch (e) {
								L.o.error(
									e instanceof Error
										? e.message
				...
				(0, s.useEffect)(() => {
					...
					(0, s.useEffect)(() => {
						let e = !1,
							a = window.setTimeout(async () => {
								...
								try {
									let a = await S.Kf({
										search: eU || void 0,
										warehouse: G || R?.default_warehouse || void 0,
										inStockOnly: eC,
										limit: 30,
									});
									if (e) return;
						...
						return () => {
							(e = !0), window.clearTimeout(a);
						};
					}, [eU, G, R?.default_warehouse, eC]),
					(0, l.Tr)(e3, e9, E, (e) => H(e.name), { search: U }),
					(0, l.Zf)(
						ee,
						(e) => {
							ea(e.default_customer),
								er({
				...
				let ac = (0, s.useMemo)(
					...
					am = (0, s.useMemo)(() => (0, o.b0)(e6, ee, et), [e6, ee, et]),
					au = (e) => {
						em(e),
							ep(e.brand || ""),
							e_(e.brand_label || e.brand || ""),
							ev(e.model || e.resolved_vehicle_model || ""),
							e.current_customer &&
								(ea(e.current_customer),
								er({
					...
					return (
						(async () => {
							...
							try {
								let a = await S.tP(F);
								if (e) return;
								if (0 !== Number(a.docstatus)) {
									L.o.error("Only draft proformas can be edited"),
										t("proforma-invoices");
									return;
								}
								M(a.name),
									H(a.company || ""),
									a.warehouse && Y(a.warehouse),
									a.transaction_date &&
										ej(String(a.transaction_date).slice(0, 10)),
									a.delivery_date && eN(String(a.delivery_date).slice(0, 10)),
									eS(a.remarks || "");
								let r = a.labour || [];
								eJ(
									r.length
								...
								if (
									...
									ec(a.vehicle_vin);
									try {
										let t = await C.Dh(a.vehicle_vin);
										e ||
											(em(t),
											ep(t.brand || ""),
											e_(t.brand_label || t.brand || ""),
											ev(t.model || t.resolved_vehicle_model || ""));
									} catch {}
								}
								ea(a.customer || ""),
									er(
				...
				let ap = async (e) => {
						if ((ec(e), eO([T()]), eJ([P()]), eB(""), eT(""), ev(""), !e)) {
							em(null), ep(""), e_("");
							return;
						}
						let a = ae?.find((a) => a.name === e);
						a && au(a);
						try {
							let a = await C.Dh(e);
							au({
								...
								resolved_vehicle_model_label: a.resolved_vehicle_model_label,
							...
							a || L.o.error("Could not load vehicle details for the selected VIN");
						}
					},
					ah = (0, s.useMemo)(() => {
						let e =
						...
						return (
							eo &&
								...
								e.unshift({
									value: eo,
									label: ed.vin_number || eo,
									description: [
										ed.model || ed.resolved_vehicle_model,
										ed.model_name,
										ed.plate_number,
										ed.customer_name,
									]
					...
					a_ = async (e, a) => {
						...
						let t = an?.find((e) => e.name === a),
							r = t?.custom_rate || 0,
							s = (0, w.mW)(t),
							n = (0, w.sJ)(t) || a;
						try {
							let e = await (0, w.J$)(a);
							e.estimated_hours > 0 && (s = e.estimated_hours),
								e.rate_per_hour > 0 && (r = e.rate_per_hour),
							...
							t.map((t) =>
								t.id === e
									? {
											...
											hours: String(s || 1),
											rate_per_hour: r ? String(r) : t.rate_per_hour,
									  }
									: t
							)
						);
					...
					ax = async (e, a, t) => {
						if (!a)
							return void eO((a) =>
								a.map((a) =>
									a.id === e
										? { ...a, spare_part: "", item_name: "", unit_price: "" }
										: a
								)
							);
						let r = eR.find((e) => e.value === a),
							s = "",
							n = t || r?.label || a;
						try {
							let e = (
							...
							e &&
								(null != e.unit_price && (s = String(e.unit_price)),
								e.item_name && (n = e.item_name));
						} catch {}
						eK((e) =>
							e.some((e) => e.value === a) ? e : [{ value: a, label: n }, ...e]
						),
							eO((t) =>
								t.map((t) =>
									t.id === e
					...
					av = eA.reduce(
						(e, a) => e + (Number(a.qty) || 0) * (Number(a.unit_price) || 0),
						0
					),
					af = e$.reduce(
						(e, a) => e + (Number(a.hours) || 0) * (Number(a.rate_per_hour) || 0),
						0
					),
					ag = (0, N.mW)(e0, e2),
					ab = (0, N.HW)(av, e0, ag),
					...
					aw = async (e) => {
						...
						let n = {
							...
							company: E || R?.company || "",
							warehouse: G || void 0,
							labour: s.length ? s : void 0,
							parts: r.length ? r : void 0,
							posting_date: eb,
							due_date: ey,
							remarks: ew || void 0,
							submit: !a,
							labour_discount: (0, N.Z_)(eD, eE),
							parts_discount: (0, N.Z_)(e0, e2),
							vehicle_vin: eo || void 0,
							vehicle_brand: eu || void 0,
							vehicle_model: ex || void 0,
						};
						eY(!0);
						try {
							let e = I ? await S._H({ name: I, ...n }) : await S.hK(n);
							a
								? (M(e.name),
								  Z(e.name),
								  L.o.success(`Proforma ${e.name} saved as draft`),
								  (F && F === e.name) || t("proforma-invoice-new", { id: e.name }))
								: (L.o.success(`Proforma ${e.name} submitted (${e.grand_total})`),
								  eO([T()]),
								  eJ([P()]),
								  eW("none"),
								  eH(""),
						...
						(0, r.jsxs)("div", {
							children: [
								(0, r.jsxs)("h2", {
									...
									children: [
										(0, r.jsx)(k.A, { className: "h-6 w-6" }),
										I ? "Continue Proforma" : "Proforma Invoice",
									],
								}),
								(0, r.jsx)("p", {
									className: "text-sm text-muted-foreground mt-1",
									children: I
										? `Editing draft ${I} — save again or submit when ready.`
						...
						D
							...
							: (0, r.jsxs)(r.Fragment, {
									children: [
										...
										(e$.some((e) => e.vehicle_service_item) ||
											eA.some((e) => e.spare_part)) &&
											(0, r.jsxs)(g.Zp, {
												children: [
													(0, r.jsx)(g.aR, {
														children: (0, r.jsx)(g.ZB, {
													...
													(0, r.jsx)(g.Wu, {
														children: (0, r.jsxs)(b.XI, {
															children: [
																(0, r.jsx)(b.A0, {
																	children: (0, r.jsxs)(b.Hj, {
																		children: [
																			(0, r.jsx)(b.nd, {
																				children: "Type",
																			}),
										...
										(0, r.jsx)(u.B, {
											...
											onCreated: (e) => {
												let a = ez || e$[e$.length - 1]?.id;
												eV(!1), eF(null), a && a_(a, e);
											},
										}),
										(0, r.jsx)(p.d, {
											open: eI,
											...
											onCreated: (e, a) => {
												let t = eq || eA[eA.length - 1]?.id;
												eM(!1), eZ(null), eB(e), t && ax(t, e, a);
											},
										}),
									],
							  }),
		...
		26518: (e, a, t) => {
			t.d(a, { bq: () => m, eb: () => p, gC: () => u, l6: () => c, yv: () => d });
			var r = t(95155);
			t(12115);
			var s = t(40287),
				n = t(66088),
			...
			function m({ className: e, size: a = "default", children: t, ...i }) {
			...
			function u({ className: e, children: a, position: t = "popper", ...n }) {
				return (0, r.jsx)(s.ZL, {
			...
			function p({ className: e, children: a, ...t }) {
		...
		42074: (e, a, t) => {
			...
			var r = t(95155),
				...
				n = t(47650),
				i = t(91337);
			function l({ children: e, className: a, align: t = "end" }) {
		...
		52959: (e, a, t) => {
			...
			var r = t(95155),
				...
				n = t(51914),
				i = t(91337);
			function l({ onClick: e, label: a = "Add", className: t, disabled: o }) {
				return (0, r.jsx)("div", {
					className: (0, i.cn)("pt-1", t),
					children: (0, r.jsxs)(s.$, {
						type: "button",
						onClick: e,
						disabled: o,
		...
		54828: (e, a, t) => {
			...
			function s(e, a, t) {
				...
				return a && t && !r.some((e) => e.value === a)
					? [{ value: t.name, label: t.customer_name, description: t.mobile_no }, ...r]
					: r;
			}
			function n(e, a, t) {
				if (!e) {
		...
		88361: (e, a, t) => {
			...
			function s(e, a, t) {
				return "none" === a || e <= 0 || t <= 0
					? 0
					: "percentage" === a
					? (Math.min(t, 100) / 100) * e
					: Math.min(t, e);
			}
			function n(e, a) {
				let t = r(e, a);
				if ("none" !== e && !(t <= 0)) return { type: e, value: t };
			}
			function i(e) {
