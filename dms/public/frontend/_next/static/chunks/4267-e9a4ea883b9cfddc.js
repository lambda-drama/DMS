	...
	[4267],
	{
		...
		54267: (e, t, a) => {
			...
			async function k(e, t, a) {
				return (0, h.AT)("/api/method/dms.crm_api.calendar.get_calendar_events", {
					method: "POST",
					body: JSON.stringify({
						from_date: e,
						to_date: t,
			...
			function S() {
				let { navigate: e } = (0, v.c)(),
					[t, a] = (0, r.useState)(() => (0, i.w)(new Date())),
					[h, S] = (0, r.useState)(""),
					[C, A] = (0, r.useState)(""),
					[D, P] = (0, r.useState)(""),
					[T, G] = (0, r.useState)(""),
					[$, E] = (0, r.useState)("all"),
					z = (0, l.k)((0, i.w)(t), { weekStartsOn: 1 }),
					O = (0, d.$)((0, o.p)(t), { weekStartsOn: 1 }),
					Z = (0, c.GP)(z, "yyyy-MM-dd"),
					B = (0, c.GP)(O, "yyyy-MM-dd"),
					W =
						"all" === $
							? void 0
							: "service" === $
							...
							: $,
					{ data: R, isLoading: F } = (0, n.Ay)(
						["crm-calendar", Z, B, h, C, D, T, $],
						() =>
							k(Z, B, {
								branch: h || void 0,
								advisor: C || void 0,
								bay: D || void 0,
								appointment_type: T || void 0,
								event_types: W,
							})
					),
					H = (0, r.useMemo)(
					...
					L = (0, r.useMemo)(() => {
						...
						for (let t of R?.events || []) {
							if (!t.start) continue;
							let a = (0, c.GP)(new Date(t.start), "yyyy-MM-dd"),
								s = e.get(a) || [];
							s.push(t), e.set(a, s);
						}
						return e;
					}, [R?.events]),
					V = (0, c.GP)(new Date(), "yyyy-MM-dd"),
					[J, q] = (0, r.useState)(V),
					I = L.get(J) || [];
				return (0, s.jsxs)("div", {
					className: "space-y-4",
					children: [
								...
								(0, s.jsxs)("div", {
									...
									children: [
										(0, s.jsx)(y.$, {
											variant: "outline",
											size: "icon",
											onClick: () => a((e) => (0, m.a)(e, 1)),
											children: (0, s.jsx)(N.A, { className: "h-4 w-4" }),
										}),
										(0, s.jsx)("h2", {
											className:
												"min-w-[10rem] text-center text-base font-semibold tracking-tight",
											children: (0, c.GP)(t, "MMMM yyyy"),
										}),
										(0, s.jsx)(y.$, {
											variant: "outline",
											size: "icon",
											onClick: () => a((e) => (0, u.P)(e, 1)),
											children: (0, s.jsx)(w.A, { className: "h-4 w-4" }),
										}),
										(0, s.jsx)(y.$, {
											variant: "ghost",
											size: "sm",
											onClick: () => a((0, i.w)(new Date())),
											children: "Today",
										}),
										(0, s.jsx)(y.$, {
											size: "sm",
						...
						(0, s.jsx)(b.Zp, {
							...
							children: (0, s.jsxs)(b.Wu, {
								className: "grid gap-2 p-3 sm:grid-cols-2 lg:grid-cols-5",
								children: [
									(0, s.jsx)(f.p, {
										placeholder: "Branch…",
										value: h,
									...
									(0, s.jsxs)("select", {
										...
										children: [
											(0, s.jsx)("option", {
												value: "",
												children: "All appointment types",
											}),
											(0, s.jsx)("option", {
												value: "Service",
												children: "Service",
								...
								(0, s.jsx)(b.Zp, {
									...
									children: (0, s.jsxs)(b.Wu, {
										...
										children: [
											(0, s.jsx)("div", {
												className:
													"grid grid-cols-7 gap-1 text-center text-[11px] font-medium uppercase tracking-wide text-muted-foreground",
												children: [
													"Mon",
													"Tue",
													"Wed",
											...
											F
												? (0, s.jsx)("div", {
														...
														children: Array.from({ length: 35 }).map(
															(e, t) =>
																(0, s.jsx)(
																	j.E,
																	{ className: "h-24" },
		...
		79984: (e, t, a) => {
			a.d(t, { BT: () => d, Wu: () => o, ZB: () => l, Zp: () => n, aR: () => i });
			var s = a(95155);
			a(12115);
			var r = a(91337);
			function n({ className: e, ...t }) {
