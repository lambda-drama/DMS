	...
	[1985],
	{
		42427: (e, t, a) => {
			...
			function b({
				...
				modes: y,
				loading: v = !1,
				title: w = "Collect Payment",
				closeOnRecord: _ = !0,
				onRecord: $,
				onPaid: k,
			}) {
				let [C, S] = (0, r.useState)(!1),
					[M, D] = (0, r.useState)([N()]),
					[F, A] = (0, r.useState)(""),
					T = a?.outstanding || 0,
					E = a?.currency;
				(0, r.useEffect)(() => {
					e && a && (S(!1), D([N(y[0]?.name || "", T)]), A(""));
				}, [e, a?.name]),
					(0, r.useEffect)(() => {
						e &&
							y.length &&
							D((e) =>
								e.map((e) =>
									e.mode_of_payment ? e : { ...e, mode_of_payment: y[0].name }
								)
							);
					}, [e, y]);
				let J = (0, r.useMemo)(
						() => M.reduce((e, t) => e + (Number(t.amount) || 0), 0),
						[M]
					),
					L = Math.round((T - J) * 100) / 100,
					R = (e, t) => {
						D((a) => a.map((a) => (a.id === e ? { ...a, ...t } : a)));
					},
					z = async () => {
						if (!a) return;
						if (void 0 !== a.docstatus && 1 !== a.docstatus)
							return void g.o.error(
								`Submit the ${a.documentLabel} before recording a payment`
							);
						let e = M.filter((e) => e.mode_of_payment && Number(e.amount) > 0).map(
							(e) => ({
						...
						if (!e.length)
							return void g.o.error(
								"Add at least one mode of payment with an amount"
							);
						if (J <= 0) return void g.o.error("Enter a valid payment amount");
						S(!0);
						try {
							let a = await $(e, F.trim()),
								s =
									a.payment_entries && a.payment_entries.length > 1
										? a.payment_entries.join(", ")
										: a.payment_entry || "";
							g.o.success(`Payment recorded${s ? ` (${s})` : ""}`),
								k?.(),
								_ && t(!1);
						} catch (e) {
							g.o.error(e instanceof Error ? e.message : "Failed to record payment");
						} finally {
							S(!1);
						}
					},
					O = !!a && 1 === a.docstatus && (a.outstanding || 0) > 0;
				return (0, s.jsx)(l.lG, {
					open: e,
					onOpenChange: t,
					children: (0, s.jsxs)(l.Cf, {
						className:
							"flex max-h-[90vh] w-full flex-col gap-4 overflow-hidden sm:max-w-3xl",
						children: [
							(0, s.jsxs)(l.c7, {
								className: "shrink-0",
								children: [
									(0, s.jsxs)(l.L3, {
										...
										children: [(0, s.jsx)(h.A, { className: "h-5 w-5" }), w],
									}),
									(0, s.jsx)(l.rr, {
										children: a
											? `Record payment against ${a.documentLabel} ${a.name}. Split across as many modes as needed.`
											: "Record a payment",
									}),
								],
							}),
								...
								children: v
									...
									? (0, s.jsxs)("div", {
											...
											children: [
												(0, s.jsxs)("div", {
													className:
														"rounded-lg border bg-muted/30 p-3 space-y-1 text-sm",
													children: [
														(0, s.jsxs)("p", {
															children: [
																(0, s.jsx)("span", {
												...
												1 !== a.docstatus
													? (0, s.jsxs)("p", {
															...
															children: [
																"This ",
																a.documentLabel,
																" is still a draft. Submit it before recording a payment.",
															],
													  })
													: null,
												O
													? (0, s.jsxs)("div", {
															...
															children: [
																...
																(0, s.jsxs)("div", {
																	className:
																		"rounded-lg border bg-muted/20 px-3 py-2 text-sm space-y-1",
																	children: [
																		(0, s.jsxs)("div", {
																			className:
																	...
																	children: [
																		...
																		(0, s.jsx)(u.T, {
																			...
																			onChange: (e) =>
																				A(e.target.value),
																			placeholder:
																				"Optional note — saved on the payment as DMS remarks",
																		}),
																	],
																}),
															],
													...
													: null,
												0 >= (a.outstanding || 0) && 1 === a.docstatus
													? (0, s.jsxs)("p", {
															className:
							...
							(0, s.jsxs)(l.Es, {
								className: "shrink-0 gap-2 border-t pt-4 sm:gap-0",
								children: [
									(0, s.jsx)(i.$, {
										variant: "outline",
										onClick: () => t(!1),
		...
		52959: (e, t, a) => {
			...
			var s = a(95155),
				...
				r = a(51914),
				l = a(91337);
			function i({ onClick: e, label: t = "Add", className: a, disabled: d }) {
				return (0, s.jsx)("div", {
					...
					children: (0, s.jsxs)(n.$, {
						...
						onClick: e,
						disabled: d,
						children: [(0, s.jsx)(r.A, { className: "h-4 w-4 mr-1" }), t],
					}),
				});
			}
		},
		...
		81672: (e, t, a) => {
			a.d(t, { Ge: () => m, N0: () => o, Yq: () => i, gQ: () => c, r6: () => d });
			let s = [
					"January",
					"February",
					"March",
			...
			function i(e, t = "") {
				let a = l(e);
				return a ? `${r(a.getDate())}/${r(a.getMonth() + 1)}/${a.getFullYear()}` : t;
			}
			function d(e, t = "", a = !1) {
				let s = l(e);
				if (!s) return t;
				let n = `${r(s.getHours())}:${r(s.getMinutes())}${
					a ? `:${r(s.getSeconds())}` : ""
				}`;
				return `${i(s)} ${n}`;
			}
		...
		95964: (e, t, a) => {
			...
			function d({
				...
				let [x, h] = n.useState(!1),
					[f, p] = n.useState(() => i(e, a));
				return (
					n.useEffect(() => {
						x || p(i(e, a));
					}, [e, x, a]),
		...
		98883: (e, t, a) => {
			...
			function N({ label: e, value: t, className: a }) {
				return (0, s.jsxs)("div", {
					className: (0, l.cn)(
