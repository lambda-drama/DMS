					...
					return (
						...
						[
							function (t, l) {
								...
								a = [...a, l];
								let s = (t) => {
									let { scope: a, children: l, ...s } = t,
										u = a?.[e]?.[o] || i,
										d = r.useMemo(() => s, Object.values(s));
									return (0, n.jsx)(u.Provider, { value: d, children: l });
								};
								return (
			...
			var k = "CollapsibleContent",
				N = r.forwardRef((e, t) => {
					let { forceMount: a, ...r } = e,
						n = y(k, e.__scopeCollapsible);
					return (0, p.jsx)(d.C, {
						present: a || n.open,
						children: ({ present: e }) => (0, p.jsx)(w, { ...r, ref: t, present: e }),
					});
				});
			N.displayName = k;
			var w = r.forwardRef((e, t) => {
				let { __scopeCollapsible: a, present: n, children: l, ...i } = e,
					d = y(k, a),
					[c, m] = r.useState(n),
					f = r.useRef(null),
					v = (0, s.s)(t, f),
