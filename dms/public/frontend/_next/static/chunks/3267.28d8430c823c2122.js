	...
	[3267],
	{
		...
		47279: (e, t, r) => {
			...
			function v(e) {
				let {
					...
					[m, v] = (0, i.i)({ prop: r, defaultProp: l ?? !1, onChange: s, caller: h }),
					[x, b] = a.useState(null),
					[w, A] = a.useState(null),
					g = a.useRef(!1),
					j = !x || !!d || !!x.closest("form"),
					C = {
						checked: m,
						disabled: c,
						setChecked: v,
			...
			var x = "CheckboxTrigger",
				b = a.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...l }, i) => {
					let {
							control: d,
							value: o,
							disabled: s,
			...
			var w = a.forwardRef((e, t) => {
				...
				return (0, u.jsx)(v, {
					...
					internal_do_not_use_render: ({ isFormControl: e }) =>
						(0, u.jsxs)(u.Fragment, {
							children: [
								(0, u.jsx)(b, { ...p, ref: t, __scopeCheckbox: r }),
								e && (0, u.jsx)(C, { __scopeCheckbox: r }),
							],
						}),
				});
			});
			...
			var A = "CheckboxIndicator",
				g = a.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: a, ...n } = e,
						l = m(A, r);
					return (0, u.jsx)(s.C, {
						present: a || E(l.checked) || !0 === l.checked,
						children: (0, u.jsx)(p.sG.span, {
							"data-state": z(l.checked),
				...
				C = a.forwardRef(({ __scopeCheckbox: e, ...t }, r) => {
					...
					a.useEffect(() => {
						...
						if (A !== i && e) {
							...
							(x.indeterminate = E(i)), e.call(x, !E(i) && i), x.dispatchEvent(r);
						}
					}, [x, A, i, c]);
					let C = a.useRef(!E(i) && i);
		...
		89803: (e, t, r) => {
			...
			var n = r(42442),
				...
				o = a.forwardRef((e, t) => {
					var r;
					let { decorative: a, orientation: n = i, ...o } = e,
