	...
	[7689],
	{
		...
		38291: (e, t, r) => {
			...
			function o({ className: e, variant: t, asChild: r = !1, ...n }) {
				...
				return (0, i.jsx)(c, {
					"data-slot": "badge",
					className: (0, s.cn)(d({ variant: t }), e),
					...n,
				});
			}
		},
		...
		47279: (e, t, r) => {
			...
			function x(e) {
				let {
					...
					[y, x] = (0, d.i)({ prop: r, defaultProp: n ?? !1, onChange: l, caller: h }),
					[g, b] = i.useState(null),
					[_, T] = i.useState(null),
					j = i.useRef(!1),
					S = !g || !!o || !!g.closest("form"),
					N = {
						checked: y,
						disabled: s,
						setChecked: x,
				...
				return (0, m.jsx)(v, {
					scope: t,
					...N,
					children: "function" == typeof p ? p(N) : a,
				});
			}
			var g = "CheckboxTrigger",
				b = i.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...n }, d) => {
					let {
							control: o,
							value: c,
							disabled: l,
			...
			var T = "CheckboxIndicator",
				j = i.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: i, ...a } = e,
						n = y(T, r);
					return (0, m.jsx)(l.C, {
						present: i || k(n.checked) || !0 === n.checked,
			...
			var S = "CheckboxBubbleInput",
				N = i.forwardRef(({ __scopeCheckbox: e, ...t }, r) => {
					let {
							control: n,
					...
					i.useEffect(() => {
						...
						if (T !== d && e) {
							...
							(g.indeterminate = k(d)), e.call(g, !k(d) && d), g.dispatchEvent(r);
						}
					}, [g, T, d, s]);
					let N = i.useRef(!k(d) && d);
		...
		57689: (e, t, r) => {
			...
			function S() {
				...
				let {
						...
						isLoading: z,
						mutate: L,
					} = (0, n.Ay)(["job-card-terms-master", r], () =>
						_.rv({ search: r || void 0, limit: 100, offset: 0 })
					),
					R = M?.data || [];
				async function F() {
					if (!A.title.trim()) return void s.o.error("Title is required");
					P(!0);
					try {
						O && A.name
							? (await _.qS(A.name, {
							  ...
							  s.o.success("Job Card Terms updated"))
							: (await _.PJ({
									title: A.title.trim(),
									terms_and_conditions: A.terms_and_conditions,
									default: +!!A.default,
							  }),
							  s.o.success("Job Card Terms created")),
							k(!1),
							L();
					} catch (e) {
						s.o.error(
				...
				async function H(e) {
					E(e.name);
					try {
						await _.aL(e.name), s.o.success("Job Card Terms deleted"), L();
					} catch (e) {
						s.o.error(
						...
						(0, i.jsxs)("div", {
							...
							children: [
								...
								(0, i.jsxs)(d.$, {
									...
									children: [
										(0, i.jsx)(p.A, { className: "h-4 w-4 mr-2" }),
										"New Terms Template",
									],
								}),
							],
		...
		66348: (e, t, r) => {
			...
			async function n(e) {
				return (0, i.AT)(`/api/method/${a}.list_spare_parts`, {
					method: "POST",
					body: JSON.stringify({
			...
			async function s(e) {
				return (0, i.AT)(`/api/method/${a}.get_spare_part`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function d(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_spare_part`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function o(e) {
				return (0, i.AT)(`/api/method/${a}.list_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
			...
			async function c(e) {
				return (0, i.AT)(`/api/method/${a}.get_vehicle_service_item`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function l(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_vehicle_service_item`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function u(e) {
				return (0, i.AT)(`/api/method/${a}.create_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function m(e, t) {
				return (0, i.AT)(`/api/method/${a}.add_vehicle_service_item_models`, {
					method: "POST",
					body: JSON.stringify({ name: e, vehicle_models: t }),
				});
			}
			async function h(e) {
				return (0, i.AT)(`/api/method/${a}.list_vehicle_service_item_names`, {
					method: "POST",
					body: JSON.stringify({ search: e?.search || null, limit: e?.limit ?? 100 }),
				});
			}
			async function f(e) {
				return (0, i.AT)(`/api/method/${a}.bulk_update_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify(e),
				});
			}
			async function p(e) {
				return (0, i.AT)(`/api/method/${a}.list_item_prices`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
			...
			async function v(e) {
				return (0, i.AT)(`/api/method/${a}.get_item_price`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function y(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_item_price`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function x(e) {
				return (0, i.AT)(`/api/method/${a}.create_item_price`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function g(e) {
				return (0, i.AT)(`/api/method/${a}.list_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 100,
			...
			async function b(e) {
				return (0, i.AT)(`/api/method/${a}.create_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function _(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function T(e) {
				return (0, i.AT)(`/api/method/${a}.delete_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function j(e) {
				return (0, i.AT)(`/api/method/${a}.list_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 100,
			...
			async function S(e) {
				return (0, i.AT)(`/api/method/${a}.create_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function N(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function k(e) {
				return (0, i.AT)(`/api/method/${a}.delete_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function O(e) {
				return (0, i.AT)(`/api/method/${a}.list_vehicle_models`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						active_filter: e?.active_filter || "active",
			...
			async function w(e) {
				return (0, i.AT)(`/api/method/${a}.get_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function A(e) {
				return (0, i.AT)(`/api/method/${a}.create_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function J(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function C(e, t) {
				return (0, i.AT)(`/api/method/${a}.create_vehicle_item_group`, {
					method: "POST",
					body: JSON.stringify({ item_group: e, parent_item_group: t || null }),
				});
			}
			async function P() {
				return (0, i.AT)(`/api/method/${a}.get_masters_options`, {
					method: "POST",
					body: JSON.stringify({}),
				});
			}
			async function $(e) {
				return (0, i.AT)(`/api/method/${a}.list_vehicle_service_packages`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						active_filter: e?.active_filter || "active",
			...
			async function E(e) {
				return (0, i.AT)(`/api/method/${a}.get_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function M(e) {
				return (0, i.AT)(`/api/method/${a}.create_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function z(e, t) {
				return (0, i.AT)(`/api/method/${a}.update_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function L(e) {
				return (0, i.AT)(`/api/method/${a}.delete_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
		...
		79984: (e, t, r) => {
			r.d(t, { BT: () => o, Wu: () => c, ZB: () => d, Zp: () => n, aR: () => s });
			var i = r(95155);
			r(12115);
			var a = r(91337);
			function n({ className: e, ...t }) {
			...
			function d({ className: e, ...t }) {
				return (0, i.jsx)(a.bL, {
					...
					children: (0, i.jsx)(a.C1, {
						...
						children: (0, i.jsx)(n.A, { className: "size-3.5" }),
					}),
				});
			}
		},
