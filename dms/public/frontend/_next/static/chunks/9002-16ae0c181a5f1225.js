...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[9002],
	{
				...
				return (0, s.jsx)(r.Lt, {
					...
					children: (0, s.jsxs)(r.EO, {
						...
						children: [
							...
							(0, s.jsxs)(r.ck, {
								children: [
									(0, s.jsx)(r.Zr, { disabled: m, children: u }),
									(0, s.jsxs)(r.Rx, {
										disabled: m,
										className: (0, i.cn)(
											x && (0, o.r)({ variant: "destructive" })
										),
										onClick: (e) => {
											e.preventDefault(), h();
										},
		...
		38291: (e, t, a) => {
			...
			function d({ className: e, variant: t, asChild: a = !1, ...r }) {
				let l = a ? n.DX : "span";
				return (0, s.jsx)(l, {
					"data-slot": "badge",
					className: (0, o.cn)(i({ variant: t }), e),
					...r,
				});
			}
		},
		43447: (e, t, a) => {
			...
			function l({ className: e, inset: t, variant: a = "default", ...o }) {
				return (0, s.jsx)(n.q7, {
			...
			function C() {
				let { navigate: e } = (0, d.c)(),
					...
					[q, z] = (0, n.useState)(""),
					{
						...
						isLoading: E,
						mutate: L,
					} = (0, r.Ay)(["crm-quotations", t, C], () =>
						(0, i.gw)({ search: t || void 0, status: C, limit: 100 })
					),
					O = D?.data || [],
					Q = async (e, t) => {
						z(e);
						try {
							"submit" === t ? await (0, i.d6)(e) : await (0, i.x3)(e),
								await L(),
								$(null),
								o.o.success(
									"submit" === t
				...
				return (0, s.jsxs)("div", {
					...
					children: [
											...
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsx)(x.p, {
														className: "pl-9",
														placeholder:
															"Search quotation, customer or deal…",
														value: t,
						...
						(0, s.jsx)(l.J, {
							...
							quotationId: String(S?.name || ""),
							customer: {
								name: String(S?.party_name || ""),
								display: String(S?.customer_display || S?.party_name || ""),
								email: String(S?.customer_email || ""),
						...
						(0, s.jsx)(c.j, {
							...
							description:
								A?.action === "cancel"
									? `${A.name} will be cancelled. This cannot be undone from here.`
									: `${
											A?.name || "This quotation"
									  } will be submitted. After that it cannot be edited — you can still share it with the customer.`,
							confirmLabel:
								A?.action === "cancel" ? "Cancel quotation" : "Submit quotation",
							cancelLabel:
								A?.action === "cancel" ? "Keep quotation" : "Keep as draft",
							destructive: A?.action === "cancel",
							loading: !!q,
							onConfirm: () => {
								A && Q(A.name, A.action);
							},
		...
		70521: (e, t, a) => {
			...
			function p({ className: e, ...t }) {
				return (0, s.jsx)(n.rc, { className: (0, r.cn)((0, o.r)(), e), ...t });
			}
			function f({ className: e, ...t }) {
				return (0, s.jsx)(n.ZD, {
					className: (0, r.cn)((0, o.r)({ variant: "outline" }), e),
					...t,
				});
			}
		},
		98790: (e, t, a) => {
					...
					children: [
						(0, s.jsx)("span", {
							className: (0, d.cn)(
								...
								a ? "bg-muted text-muted-foreground" : r
							),
							children: o,
						}),
			...
			function m({ open: e, onOpenChange: t, quotationId: a, customer: d }) {
				var x, h;
				let p,
					f,
					b,
					...
					j,
					v,
					N = d.display || d.name || "Customer",
					w =
						((x = a),
						(p = (h = d).display || h.name || "Customer"),
						(f = (h.email || "").trim()),
						(g = (b = (h.phone || "").trim()).replace(/\D/g, "")),
						(j = encodeURIComponent(`Quotation ${x}`)),
						(v = encodeURIComponent(`Hello ${p},
...
`)),
						{
							...
							phone: b,
							phoneDigits: g,
							whatsapp: g ? `https://wa.me/${g}?text=${v}` : "",
							sms: g ? `sms:${g}?body=${v}` : "",
							mailto: f ? `mailto:${f}?subject=${j}&body=${v}` : "",
						});
				return (0, s.jsx)(i.lG, {
					open: e,
					onOpenChange: t,
					children: (0, s.jsxs)(i.Cf, {
						...
						children: [
							(0, s.jsxs)(i.c7, {
								children: [
									(0, s.jsx)(i.L3, { children: "Send to Customer" }),
									(0, s.jsx)(i.rr, {
										children:
							...
							(0, s.jsxs)("div", {
								...
								children: [
									(0, s.jsx)("p", { className: "font-medium", children: N }),
									d.name && d.name !== N
										? (0, s.jsx)("p", {
												className: "text-xs text-muted-foreground",
												children: d.name,
									...
									(0, s.jsx)("p", {
										...
										children: w.email || "No email on file",
									}),
									(0, s.jsx)("p", {
										className: "text-muted-foreground",
										children: w.phone || "No phone on file",
									}),
								],
							}),
							(0, s.jsxs)("div", {
								...
								children: [
									(0, s.jsx)(u, {
										label: "WhatsApp",
										description: w.phone ? w.phone : "Needs a phone number",
										disabled: !w.whatsapp,
										className: "bg-[#25D366]",
										onClick: () => w.whatsapp && c(w.whatsapp),
										children: (0, s.jsx)(l, { className: "h-5 w-5" }),
									}),
									(0, s.jsx)(u, {
										label: "SMS",
										description: w.phone ? w.phone : "Needs a phone number",
										...
										onClick: () => w.sms && c(w.sms),
										children: (0, s.jsx)(n.A, { className: "h-5 w-5" }),
									}),
									(0, s.jsx)(u, {
										label: "Email",
										description: w.email || "Needs an email",
										disabled: !w.mailto,
										className: "bg-primary",
										onClick: () => w.mailto && c(w.mailto),
