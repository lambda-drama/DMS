		...
		47279: (e, t, a) => {
			...
			function m(e) {
				let {
					...
					[v, m] = (0, c.i)({ prop: a, defaultProp: n ?? !1, onChange: i, caller: u }),
					[x, b] = r.useState(null),
					[w, A] = r.useState(null),
					j = r.useRef(!1),
					M = !x || !!s || !!x.closest("form"),
					g = {
						checked: v,
						disabled: l,
						setChecked: m,
				...
				return (0, h.jsx)(f, {
					scope: t,
					...g,
					children: "function" == typeof y ? y(g) : d,
				});
			}
			var x = "CheckboxTrigger",
				b = r.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: a, ...n }, c) => {
					let {
							control: s,
							value: o,
							disabled: i,
			...
			var w = r.forwardRef((e, t) => {
				...
				return (0, h.jsx)(m, {
					...
					internal_do_not_use_render: ({ isFormControl: e }) =>
						(0, h.jsxs)(h.Fragment, {
							children: [
								(0, h.jsx)(b, { ...p, ref: t, __scopeCheckbox: a }),
								e && (0, h.jsx)(g, { __scopeCheckbox: a }),
							],
						}),
				});
			});
			...
			var A = "CheckboxIndicator",
				j = r.forwardRef((e, t) => {
					let { __scopeCheckbox: a, forceMount: r, ...d } = e,
						n = v(A, a);
					return (0, h.jsx)(i.C, {
						present: r || C(n.checked) || !0 === n.checked,
				...
				g = r.forwardRef(({ __scopeCheckbox: e, ...t }, a) => {
					...
					r.useEffect(() => {
						...
						if (A !== c && e) {
							...
							(x.indeterminate = C(c)), e.call(x, !C(c) && c), x.dispatchEvent(a);
						}
					}, [x, A, c, l]);
					let g = r.useRef(!C(c) && c);
					return (0, h.jsx)(p.sG.input, {
						type: "checkbox",
						"aria-hidden": !0,
		...
		91760: (e, t, a) => {
			...
			var d = a(42442),
				...
				l = [
					...
					let a = (0, d.TL)(`Primitive.${t}`),
						l = r.forwardRef((e, r) => {
							let { asChild: d, ...l } = e;
							return (
								"u" > typeof window && (window[Symbol.for("radix-ui")] = !0),
								(0, n.jsx)(d ? a : t, { ...l, ref: r })
							);
						});
