		...
		19485: (e, s, t) => {
			...
			function f() {
				let { navigate: e, viewParams: s } = (0, l.c)(),
					t = s.get("id") || "",
					{ data: f } = (0, n.Ay)("crm-segment-form-options", c.ET),
					{
						data: b,
						isLoading: y,
						mutate: v,
					} = (0, n.Ay)(t ? ["crm-segment", t] : null, () => (0, c.kn)(t)),
					[j, k] = (0, r.useState)(!1),
					{ error: N, success: w, showError: S, showSuccess: C, clear: A } = (0, p.B)(),
					[q, E] = (0, r.useState)({
						segment_name: "",
						status: "",
						customer_type: "",
				...
				(0, r.useEffect)(() => {
					b &&
						E({
							segment_name: String(b.segment_name || ""),
							status: String(b.status || ""),
							customer_type: String(b.customer_type || ""),
							city: String(b.city || ""),
							brand: String(b.brand || ""),
							retention_category: String(b.retention_category || ""),
							sales_status: String(b.sales_status || ""),
							channel_preference: String(b.channel_preference || ""),
							require_marketing_consent: !!b.require_marketing_consent,
							include_do_not_contact: !!b.include_do_not_contact,
							has_deferred_work: !!b.has_deferred_work,
							has_complaint_history: !!b.has_complaint_history,
							notes: String(b.notes || ""),
						});
				}, [b]);
				let B = (e) => (e || []).filter(Boolean).map((e) => ({ value: e, label: e })),
					Z = (e, s) => E((t) => ({ ...t, [e]: s })),
					z = async () => {
						if (t) {
							A(), k(!0);
							try {
								await (0, c.BY)(t, {
									...q,
									segment_name: q.segment_name.trim(),
									require_marketing_consent: +!!q.require_marketing_consent,
									include_do_not_contact: +!!q.include_do_not_contact,
									has_deferred_work: +!!q.has_deferred_work,
									has_complaint_history: +!!q.has_complaint_history,
								}),
									await v(),
									C("Segment saved.");
							} catch (e) {
								S(e, "Failed to save segment");
							} finally {
								k(!1);
							}
						}
					...
					$ = async () => {
						A();
						try {
							let e = await (0, c.sb)({ name: t });
							await v(), C(`Audience: ${e.count} customers`);
						} catch (e) {
							S(e, "Preview failed");
						}
					};
				return t
					? y || !b
						? (0, a.jsx)(u.E, { className: "h-48" })
						: (0, a.jsxs)("div", {
								className: "dms-form-page space-y-4",
								children: [
									(0, a.jsx)(p.y, { error: N, success: w, onDismiss: A }),
									(0, a.jsxs)("div", {
										className:
											...
											(0, a.jsxs)("p", {
												...
												children: [
													...
													(0, a.jsx)("span", {
														...
														children: Number(b.audience_count || 0),
													}),
												],
											}),
										],
												...
												children: [
													...
													(0, a.jsxs)("div", {
														...
														children: [
															...
															(0, a.jsx)(g.Zi, {
																options: B(f?.customer_types),
																value: q.customer_type,
																onValueChange: (e) =>
																	Z("customer_type", e || ""),
															}),
														],
													...
													(0, a.jsxs)("div", {
														...
														children: [
															...
															(0, a.jsx)(g.Zi, {
																options: B(
																	f?.retention_categories
																),
																value: q.retention_category,
																onValueChange: (e) =>
																	Z(
																		"retention_category",
																		e || ""
													...
													(0, a.jsxs)("div", {
														...
														children: [
															...
															(0, a.jsx)(g.Zi, {
																options: B(f?.sales_statuses),
																value: q.sales_status,
																onValueChange: (e) =>
																	Z("sales_status", e || ""),
															}),
														],
											...
											(0, a.jsxs)("div", {
												...
												children: [
													(0, a.jsx)(i.$, {
														variant: "outline",
														onClick: () => void $(),
														children: "Refresh audience count",
													}),
													(0, a.jsxs)(i.$, {
														onClick: () => void z(),
														disabled: j,
		...
		93108: (e, s, t) => {
			...
			function d() {
				let [e, s] = (0, r.useState)(""),
					[t, a] = (0, r.useState)(""),
					c = (0, r.useCallback)((e, t = "Something went wrong.") => {
						let r =
