...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	...
	{
		26518: (e, t, a) => {
			a.d(t, { bq: () => m, eb: () => p, gC: () => u, l6: () => c, yv: () => d });
			var s = a(95155);
			a(12115);
			var r = a(40287),
				i = a(66088),
			...
			function m({ className: e, size: t = "default", children: a, ...n }) {
				return (0, s.jsxs)(r.l9, {
					...
					children: [
						...
						(0, s.jsx)(r.In, {
							asChild: !0,
							children: (0, s.jsx)(i.A, { className: "size-4 opacity-50" }),
						}),
					],
				});
			}
			function u({ className: e, children: t, position: a = "popper", ...i }) {
				return (0, s.jsx)(r.ZL, {
		...
		38291: (e, t, a) => {
			...
			function o({ className: e, variant: t, asChild: a = !1, ...i }) {
				let c = a ? r.DX : "span";
				return (0, s.jsx)(c, {
					"data-slot": "badge",
		...
		42074: (e, t, a) => {
			...
			function l({ children: e, className: t, align: a = "end" }) {
				...
				return o ? (0, i.createPortal)(d, document.body) : null;
			}
		},
		54828: (e, t, a) => {
			function s(e) {
		...
		58979: (e, t, a) => {
			...
			function o({ summary: e, className: t = "" }) {
				...
				let a = e.warranty_active,
					c = a ? r.A : "Expired by Mileage" === e.warranty_status ? i.A : n.A;
				return (0, s.jsxs)("div", {
		...
		79984: (e, t, a) => {
			a.d(t, { BT: () => o, Wu: () => c, ZB: () => l, Zp: () => i, aR: () => n });
			var s = a(95155);
			a(12115);
			var r = a(91337);
			function i({ className: e, ...t }) {
		...
		81346: (e, t, a) => {
			...
			let B = [
				...
				L = ["Drop-off", "Pick-up Later", "Tow-in", "Fleet Driver Drop-off"];
			function I(e) {
				return e ? String(e).trim().replace(" ", "T").slice(0, 16) : "";
			}
			function M() {
				let { navigate: e, viewParams: t } = (0, n.c)(),
					...
					[U, H] = (0, r.useState)({
						...
						priority: "Normal",
						appointment_date_time: (0, l.GP)(new Date(), "yyyy-MM-dd'T'HH:mm"),
					...
					[O, K] = (0, r.useState)(""),
					[X, Y] = (0, r.useState)(""),
					[ee, et] = (0, r.useState)({ mobile_no: "", email_id: "" }),
					[ea, es] = (0, r.useState)(!1),
					[er, ei] = (0, r.useState)(null),
					[en, el] = (0, r.useState)(null),
					[eo, ec] = (0, r.useState)(null),
					{ data: ed } = (0, T.dQ)(G),
					{ data: em, isLoading: eu } = (0, T.mv)(void 0, O),
					{ data: ep } = (0, T.qg)(),
					{ data: eh } = (0, T.qp)(),
					{ data: e_ } = (0, T.oA)(),
					{ data: ex, isLoading: ev } = (0, T.Rr)(X),
					{ data: ef } = (0, T.Ms)(),
					{ trigger: eg, isMutating: eb } = (0, T.xW)(),
					{ data: ej, isLoading: ey } = (0, T.zV)(a || null),
					[eN, ew] = (0, r.useState)(!1),
					ek = eb || eN;
				(0, T.Tr)(ex, ev, U.company, (e) => H((t) => ({ ...t, company: e.name })), {
					search: X,
				}),
					(0, T.Zf)(
						U.customer,
						(e) => {
							H((t) => ({ ...t, customer: e.default_customer })),
								ec({
									name: e.default_customer,
									customer_name: e.customer_name || e.default_customer,
									mobile_no: e.mobile_no || void 0,
				...
				let eS = async (e) => {
					...
					let t = em?.find((t) => t.name === e);
					t && el(t),
						H((a) => ({
							...a,
							vin_chassis: e,
							vehicle: t?.linked_item || "",
							license_plate: t?.plate_number || "",
							current_odometer: t?.current_odometer ?? 0,
						})),
						t?.current_customer &&
							(H((e) => ({ ...e, customer: t.current_customer })),
							ec({
								name: t.current_customer,
								customer_name: t.customer_name || t.current_customer,
								mobile_no: void 0,
							}));
					try {
						let t = await E.Dh(e);
				...
				(0, r.useEffect)(() => {
					M &&
						...
						W !== ej.name &&
						(H({
							booking_source: ej.booking_source || "Phone Call",
							priority: ej.priority || "Normal",
							appointment_date_time:
								I(ej.appointment_date_time) ||
								(0, l.GP)(new Date(), "yyyy-MM-dd'T'HH:mm"),
							promised_delivery_date_time: I(ej.promised_delivery_date_time),
							estimated_duration_hours: ej.estimated_duration_hours || 2,
							customer: ej.customer || "",
							vehicle: ej.vehicle || "",
							vin_chassis: ej.vin_chassis || "",
							license_plate: ej.license_plate || "",
							current_odometer: ej.current_odometer || 0,
							customer_complaint_summary: ej.customer_complaint_summary || "",
							preferred_advisor:
								ej.preferred_advisor || ej.assigned_service_advisor || "",
							assigned_bay: ej.assigned_bay || "",
							special_instructions: ej.special_instructions || "",
							vehicle_arrival_status: ej.vehicle_arrival_status || "Drop-off",
							company: ej.company || "",
						}),
						q(
							(ej.service_type_requested || [])
						...
						ej.customer &&
							ec({
								name: ej.customer,
								customer_name: ej.customer_name || ej.customer,
							}),
						ej.vin_chassis &&
							E.Dh(ej.vin_chassis)
								.then((e) => {
									el({
										...
										H((t) => ({
											...t,
											vehicle: e.linked_item || t.vehicle,
											license_plate: e.plate_number || t.license_plate,
											current_odometer:
												e.current_odometer ?? t.current_odometer,
										})),
										ei(e.warranty_summary || null);
								})
								.catch(() => {
									el({
										name: ej.vin_chassis,
										vin_number: ej.vin_number || ej.vin_chassis,
										plate_number: ej.license_plate,
										model_name: ej.vehicle_model,
										linked_item: ej.vehicle,
									});
								}),
						$(ej.name));
				}, [ej, W, M]);
				let eC = t.get("vin");
				(0, r.useEffect)(() => {
					eC && eC !== U.vin_chassis && eS(eC);
				}, [eC]);
				let eA = (0, r.useMemo)(() => (0, P.b0)(ed, U.customer, eo), [ed, U.customer, eo]),
					eF = (0, r.useMemo)(() => {
						let e =
							em?.map((e) => ({
								value: e.name,
						...
						return U.vin_chassis && en && !e.some((e) => e.value === U.vin_chassis)
							? [
									{
										value: en.name,
										label: en.vin_number,
										description: [en.model_name, en.plate_number]
											.filter(Boolean)
											.join(" \xb7 "),
									},
									...e,
				...
				async function eV(t) {
					let s = "draft" === t;
					if (!U.company) return void o.o.error("Please select a company");
					if (s) {
						if (!U.customer && !U.vin_chassis)
							return void o.o.error(
								"Select at least a customer or vehicle before saving a draft"
							);
					} else {
						if (!U.vin_chassis) return void o.o.error("Please select a vehicle");
						if (!U.customer) return void o.o.error("Please select a customer");
						if (!U.vehicle)
							return void o.o.error(
								"Selected vehicle has no linked model. Update the VIN record in Vehicles."
							);
						if (0 === R.length)
							return void o.o.error("Please add at least one service type");
						if (!U.customer_complaint_summary.trim())
							return void o.o.error("Please enter the customer complaint summary");
					}
					try {
						U.customer &&
							(await i.KU(U.customer, {
								mobile_no: ee.mobile_no,
								email_id: ee.email_id,
							}));
						let t = {
							booking_source: U.booking_source,
							priority: U.priority,
							company: U.company,
							appointment_date_time: U.appointment_date_time,
							promised_delivery_date_time: U.promised_delivery_date_time || void 0,
							estimated_duration_hours: U.estimated_duration_hours,
							customer: U.customer || void 0,
							vehicle: U.vehicle || void 0,
							vin_chassis: U.vin_chassis || void 0,
							license_plate: U.license_plate,
							current_odometer: U.current_odometer,
							customer_complaint_summary: U.customer_complaint_summary,
							preferred_advisor: U.preferred_advisor || void 0,
							assigned_service_advisor: U.preferred_advisor || void 0,
							assigned_bay: U.assigned_bay || void 0,
							vehicle_arrival_status: U.vehicle_arrival_status,
							special_instructions: U.special_instructions,
							mobile_no: ee.mobile_no,
							customer_email: ee.email_id,
							service_type_requested: R.map((e) => {
								let t = ep?.find((t) => t.name === e);
								return {
									service_type: e,
									estimated_hours: t?.default_estimated_hours,
									is_warranty: +!!t?.warranty_applicable,
								};
							}),
						};
						if (M) {
							...
							try {
								await Z.l0(a, t),
									!s && ej && 0 === Number(ej.docstatus)
										? (await Z.qk(a),
										  o.o.success("Appointment updated and confirmed"),
										  e("appointment-detail", { id: a }))
										: s
										? o.o.success("Appointment saved as draft", {
												description: a,
										  })
										: (o.o.success("Appointment updated"),
										  e("appointment-detail", { id: a }));
							} finally {
								ew(!1);
							}
						...
						let r = await eg({ ...t, as_draft: +!!s, confirm: +!s });
						s
							? (o.o.success("Appointment saved as draft", { description: r.name }),
							  e("appointment-new", { id: r.name }))
							: (o.o.success("Appointment created successfully", {
				...
				async function eD(e) {
					e.preventDefault(), await eV("create");
				}
				async function eT() {
					await eV("draft");
				}
				(0, r.useEffect)(() => {
					if (!U.customer) return void et({ mobile_no: "", email_id: "" });
					let e = !1;
					return (
						es(!0),
						i
							...
							.catch(() => {
								if (!e) {
									let e = ed?.find((e) => e.name === U.customer);
									et({
				...
				let eP = M && 1 === Number(ej?.docstatus),
					ez = M ? "appointment-detail" : "appointments",
					eE = M ? { id: a } : void 0;
				return M && ey
					? (0, s.jsx)("div", {
								...
								(0, s.jsxs)("div", {
									...
									children: [
										(0, s.jsx)(c.$, {
											...
											size: "icon",
											onClick: () => e(ez, eE),
											children: (0, s.jsx)(v.A, { className: "h-5 w-5" }),
										}),
										(0, s.jsxs)("div", {
											children: [
												(0, s.jsx)("h1", {
													...
													children: M
														? 0 !== Number(ej?.docstatus) ||
														  (ej?.status !== "Draft" && ej?.status)
															? "Edit Appointment"
												...
												(0, s.jsx)("p", {
													...
													children: M
														? 0 !== Number(ej?.docstatus) ||
														  (ej?.status !== "Draft" && ej?.status)
															? ej?.name ||
															  "Update this service appointment"
															: ej?.name
															? `Resume draft ${ej.name}`
												...
												(0, s.jsxs)(h.Wu, {
													...
													children: [
														...
														(0, s.jsxs)("div", {
															...
															children: [
																...
																(0, s.jsx)(d.p, {
																	...
																	type: "datetime-local",
																	value: U.promised_delivery_date_time,
																	onChange: (e) =>
																		H((t) => ({
																			...t,
																			promised_delivery_date_time:
														...
														(0, s.jsxs)("div", {
															...
															children: [
																...
																(0, s.jsx)(m.Q, {
																	...
																	min: 0,
																	value: U.estimated_duration_hours,
																	onValueChange: (e) =>
																		H((t) => ({
																			...t,
														...
														(0, s.jsxs)("div", {
															...
															children: [
																(0, s.jsx)(u.J, {
																	htmlFor: "vehicle_arrival",
																	children:
																		"Vehicle Arrival Status",
																}),
																(0, s.jsxs)(_.l6, {
																	value: U.vehicle_arrival_status,
																	onValueChange: (e) =>
																		H((t) => ({
																			...t,
																					...
																					children: [
																						...
																						(0, s.jsx)(
																							"button",
																							{
																								...
																								className:
																									"ml-1 rounded-full hover:bg-muted",
																								children:
																									(0,
																									s.jsx)(
																										w.A,
														...
														(0, s.jsxs)("div", {
															...
															children: [
																...
																(0, s.jsx)(p.T, {
																	id: "complaint",
																	placeholder:
																		"Record customer's exact words about the issue...",
																	className: "min-h-24",
																	value: U.customer_complaint_summary,
																	onChange: (e) =>
																		H((t) => ({
																			...t,
																			customer_complaint_summary:
														...
														(0, s.jsxs)("div", {
															...
															children: [
																...
																(0, s.jsx)(p.T, {
																	...
																	placeholder:
																		"e.g., Do not wash, Customer has dog, etc.",
																	className: "min-h-20",
																	value: U.special_instructions,
																	onChange: (e) =>
																		H((t) => ({
																			...t,
																			special_instructions:
											...
											children: [
												(0, s.jsxs)(h.aR, {
													children: [
														...
														(0, s.jsx)(h.BT, {
															children:
																"Assign service advisor and bay (optional)",
														}),
													],
												}),
												(0, s.jsxs)(h.Wu, {
