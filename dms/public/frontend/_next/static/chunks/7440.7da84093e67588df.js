...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[7440],
	{
		29161: (e, t, a) => {
			...
			function w() {
				let { canCreate: e } = (0, n.Sk)(),
					{ data: t, isLoading: a } = (0, j.Rr)(),
					[w, S] = (0, s.useState)(""),
					[N, C] = (0, s.useState)(null),
					[M, A] = (0, s.useState)(!0),
					[E, R] = (0, s.useState)(""),
					[q, I] = (0, s.useState)(() => new Date().toISOString().split("T")[0]),
					[J, T] = (0, s.useState)(""),
					[V, D] = (0, s.useState)([k()]),
					[O, Z] = (0, s.useState)(""),
					[U, B] = (0, s.useState)([]),
					...
					[z, F] = (0, s.useState)(!0),
					[W, X] = (0, s.useState)(!1);
				(0, j.Tr)(t, a, w, (e) => S(e.name));
				let G = (0, s.useCallback)(
						async (e) => {
							A(!0);
							try {
								let t = await g.gk(e || void 0);
								C(t),
									!w && t.company && S(t.company),
					...
					(0, s.useEffect)(() => {
						let e = !1,
							t = window.setTimeout(async () => {
								L(!0);
								try {
									let t = await g.ju(O || void 0, E || void 0, 25);
									if (e) return;
									B(
										t.map((e) => ({
											value: e.item_code,
				...
				let K = (0, s.useMemo)(
					...
					Q = async () => {
						...
						let t = V.filter((e) => e.item_code && "" !== e.qty).map((e) => ({
							item_code: e.item_code,
							qty: Number(e.qty),
							valuation_rate: e.valuation_rate ? Number(e.valuation_rate) : void 0,
						}));
						if (!w) return void b.o.error("Select a company");
						if (!E) return void b.o.error("Select a warehouse");
						if (!t.length) return void b.o.error("Add at least one item");
						X(!0);
						try {
							let e = await g.sn({
								company: w,
								warehouse: E,
								posting_date: q,
								expense_account: N?.stock_adjustment_account || void 0,
								remarks: J || void 0,
								submit: !0,
								items: t,
							});
							b.o.success(`Stock Reconciliation ${e.name} submitted`),
								D([k()]),
								T(""),
								Y();
						} catch (e) {
					...
					children: [
						...
						(0, r.jsxs)(h.Zp, {
							children: [
								(0, r.jsxs)(h.aR, {
									children: [
										(0, r.jsx)(h.ZB, { children: "New reconciliation" }),
										(0, r.jsxs)(h.BT, {
											children: [
												"Enter the counted quantity per item. ERPNext compares it with system stock and books the difference.",
												N?.stock_adjustment_account
													? ` Account: ${N.stock_adjustment_account}.`
																...
																(0, r.jsxs)("div", {
																	...
																	children: [
																		...
																		(0, r.jsx)(c.Y, {
																			...
																			initialItemCode: O,
																			defaultItemGroup:
																				N?.default_item_group,
																			autoCreateSpareParts:
																				N?.auto_create_spare_parts,
																			placeholder:
																				"Search spare part",
																			isLoading: H,
																		}),
		...
		60504: (e, t, a) => {
			...
			let c = i.r
				...
				l = (0, s.Ht)(n.Ay, () => (e, t, a = {}) => {
						...
						y = (0, r.useCallback)(async (e, t) => {
							...
							try {
								let t = await n(
									a,
									o.current(r, { arg: e }),
									(0, i.m)(s, { throwOnError: !0 })
								);
								return (
									u.current <= m &&
										(c(() => p({ data: t, isMutating: !1, error: void 0 })),
					...
					return (
						(0, i.u)(() => {
							(l.current = e), (o.current = t), (d.current = a);
						}),
						{
							trigger: y,
							reset: j,
		...
		98307: (e, t, a) => {
			a.d(t, { A: () => r });
			let r = (0, a(90425).A)("clipboard-list", [
				[
					"rect",
