...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6896],
	{
		38807: (e, t, a) => {
			a.d(t, { A: () => s });
			let s = (0, a(90425).A)("package-check", [
		...
		42953: (e, t, a) => {
			...
			function f({
				...
				let [j, v] = (0, r.useState)(!1),
					[y, b] = (0, r.useState)(!1),
					[w, N] = (0, r.useState)(""),
					[_, S] = (0, r.useState)("Company"),
					[C, k] = (0, r.useState)(""),
					[A, E] = (0, r.useState)("");
				async function P() {
					let e = w.trim();
					if (!e) return void o.o.error("Supplier name is required");
					b(!0);
					try {
						let s = await x.jx({
								supplier_name: e,
							...
							r = {
								name: s.name,
								supplier_name: s.supplier_name || s.label || s.name,
							};
						a(r.name),
							t?.(r),
							o.o.success(`Created supplier ${r.supplier_name}`),
							v(!1);
					} catch (e) {
						o.o.error(e instanceof Error ? e.message : "Could not create supplier");
					} finally {
						b(!1);
					}
				}
				return (
					(0, r.useEffect)(() => {
						j && (b(!1), N((e || g.value || "").trim()), S("Company"), k(""), E(""));
					}, [j, e, g.value]),
					(0, s.jsxs)(s.Fragment, {
						children: [
							(0, s.jsx)(i.Zi, {
							...
							(0, s.jsx)(c.lG, {
								...
								children: (0, s.jsxs)(c.Cf, {
									...
									children: [
										(0, s.jsxs)(c.c7, {
											children: [
												(0, s.jsx)(c.L3, { children: "New supplier" }),
												(0, s.jsx)(c.rr, {
													children:
			...
			function R() {
				let { canCreate: e } = (0, n.Sk)(),
					{ data: t } = (0, C.ZN)(),
					[a, c] = (0, r.useState)(""),
					[R, L] = (0, r.useState)(null),
					[$, J] = (0, r.useState)(!0),
					[M, I] = (0, r.useState)(""),
					[z, q] = (0, r.useState)(""),
					[O, V] = (0, r.useState)("ETB"),
					[T, B] = (0, r.useState)(""),
					[Q, Z] = (0, r.useState)(() => new Date().toISOString().split("T")[0]),
					[D, F] = (0, r.useState)(""),
					[H, U] = (0, r.useState)([P()]),
					[X, G] = (0, r.useState)(""),
					[W, Y] = (0, r.useState)(""),
					...
					[el, ed] = (0, r.useState)([]),
					[eo, ec] = (0, r.useState)(!0),
					[eu, em] = (0, r.useState)(!1),
					[ep, eh] = (0, r.useState)(null),
					[ex, ef] = (0, r.useState)(null),
					[eg, ej] = (0, r.useState)(!1),
					ev = (0, r.useCallback)(
						async (e) => {
							J(!0);
							try {
								let t = await x.mx(e || void 0);
								L(t),
									!a && t.company && c(t.company),
									!z && t.default_warehouse && q(t.default_warehouse),
									t.default_currency && V(t.default_currency),
									t.default_price_list ? B(t.default_price_list) : B(""),
									t.default_supplier
										? (I(t.default_supplier),
										  ea((e) =>
												e.some((e) => e.value === t.default_supplier)
													? e
													: [
															{
																value: t.default_supplier,
																label: t.default_supplier,
															},
															...e,
													  ]
										  ))
								...
								o.o.error(
									e instanceof Error
										? e.message
										: "Failed to load purchase receipt defaults"
								);
							} finally {
								J(!1);
							}
				...
				(0, r.useEffect)(() => {
					...
					}, [X, z, R?.default_warehouse]),
					(0, r.useEffect)(() => {
						let e = !1,
							t = window.setTimeout(async () => {
								ei(!0);
								try {
									let t = await x.Zj(W || void 0, 25);
									if (e) return;
									ea(
										t.map((e) => ({
											value: e.name,
				...
				let eb = (0, r.useMemo)(
					...
					eN = (0, r.useMemo)(() => {
						let e = R?.price_lists ?? [];
						return T && !e.some((e) => e.name === T)
							? [{ name: T, currency: O || null }, ...e]
							: e;
					}, [R?.price_lists, T, O]),
					e_ = (0, r.useCallback)(
						async (e, t) => {
					...
					eS = async () => {
						if (!e("purchase-receipt")) return;
						let t = H.filter((e) => e.item_code && Number(e.qty) > 0).map((e) => ({
							item_code: e.item_code,
							qty: Number(e.qty),
							rate: Number(e.rate || 0),
						}));
						if (!t.length)
							return void o.o.error("Add at least one item with quantity and rate");
						if (t.some((e) => e.rate < 0 || Number.isNaN(e.rate)))
							return void o.o.error("Enter a valid rate for each item");
						em(!0);
						try {
							let e = await x.Kd({
								company: a || R?.company || void 0,
								supplier: M || void 0,
								warehouse: z || R?.default_warehouse || void 0,
								currency: O || void 0,
								buying_price_list: T || void 0,
								price_list: T || void 0,
								posting_date: Q,
								remarks: D || void 0,
								submit: !0,
							...
							o.o.success(`Purchase Receipt ${e.name} submitted`),
								U([P()]),
								F(""),
								ey();
						} catch (e) {
				...
				return (0, s.jsxs)("div", {
					...
					children: [
						...
						(0, s.jsxs)(v.Zp, {
							children: [
								(0, s.jsx)(v.aR, {
									children: (0, s.jsx)(v.ZB, {
										children: "New purchase receipt",
									}),
								}),
								(0, s.jsxs)(v.Wu, {
									className: "space-y-4",
									children: [
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsxs)("div", {
													...
													children: [
														...
														(0, s.jsx)(f, {
															...
															onSearchChange: Y,
															initialSupplierName: W,
															placeholder: R?.default_supplier
																? `Default: ${R.default_supplier}`
												...
												(0, s.jsxs)("div", {
													className: "space-y-2",
													children: [
														(0, s.jsx)(p.J, { children: "Warehouse" }),
														(0, s.jsx)(i.Zi, {
															options: ew,
															value: z,
															onValueChange: q,
													...
													children: [
														...
														(0, s.jsxs)(h.l6, {
															...
															onValueChange: (e) => {
																...
																t?.currency && V(t.currency);
															},
															disabled: $ || 0 === eN.length,
															children: [
																(0, s.jsx)(h.bq, {
																	children: (0, s.jsx)(h.yv, {
																		placeholder: $
																...
																(0, s.jsxs)("div", {
																	...
																	children: [
																		...
																		(0, s.jsx)(l.Y, {
																			...
																			initialItemCode: X,
																			defaultItemGroup:
																				R?.default_item_group,
																			autoCreateSpareParts:
																				R?.auto_create_spare_parts,
																			placeholder:
																				"Search spare part",
																			isLoading: es,
																		}),
										...
										(0, s.jsx)(w.h, {
											children: (0, s.jsxs)(u.$, {
												type: "button",
												onClick: () => void eS(),
												disabled: eu || !e("purchase-receipt"),
												children: [
													eu &&
														(0, s.jsx)(d.A, {
						...
						(0, s.jsxs)(v.Zp, {
							children: [
								(0, s.jsx)(v.aR, {
									children: (0, s.jsx)(v.ZB, {
										children: "Recent spare-part receipts",
									}),
								}),
								(0, s.jsx)(v.Wu, {
									children: eo
										...
										? (0, s.jsx)("p", {
												...
												children: "No purchase receipts yet.",
										  })
										: (0, s.jsxs)(y.XI, {
												children: [
													(0, s.jsx)(y.A0, {
														children: (0, s.jsxs)(y.Hj, {
															children: [
																(0, s.jsx)(y.nd, {
																	children: "ID",
																}),
						...
						(0, s.jsx)(N.BN, {
							...
							title: ep || "",
							subtitle: ex?.supplier,
							badge: ex ? { label: E(ex.docstatus) } : void 0,
							isLoading: eg,
							footer: ep
								? (0, s.jsxs)("div", {
									...
									children: [
										(0, s.jsxs)(N.JH, {
											...
											children: [
												...
												(0, s.jsx)(N.Qb, {
													label: "Price List",
													value: ex.buying_price_list,
												}),
												(0, s.jsx)(N.Qb, {
													label: "Posting date",
													value: ex.posting_date,
												}),
												(0, s.jsx)(N.Qb, {
													label: "Grand total",
													value:
														null != ex.grand_total
															? ex.grand_total.toLocaleString(
																	void 0,
																	{
					...
					let { mutate: n } = (0, r.iX)(),
						...
						f = (0, s.useCallback)(async (e, t) => {
							...
							try {
								...
								return (
									u.current <= m &&
										(l(() => h({ data: t, isMutating: !1, error: void 0 })),
						...
						g = (0, s.useCallback)(() => {
							(u.current = (0, i.o)()), h({ data: i.U, error: i.U, isMutating: !1 });
						}, []);
					return (
						(0, i.u)(() => {
						...
						}),
						{
							...
							reset: g,
							get data() {
								return (p.data = !0), x.data;
							},
							get error() {
								return (p.error = !0), x.error;
							},
							get isMutating() {
								return (p.isMutating = !0), x.isMutating;
							},
						}
					);
				});
		...
		89803: (e, t, a) => {
			...
			var r = a(42442),
				...
				o = s.forwardRef((e, t) => {
					var a;
					let { decorative: s, orientation: r = l, ...o } = e,
						c = ((a = r), d.includes(a)) ? r : l;
								...
								children: (0, s.jsx)("div", {
									...
									children: (0, s.jsxs)("div", {
										...
										children: [
											...
											r && (0, s.jsx)(p, { className: "mt-1", children: r }),
										],
									}),
								}),
							}),
