...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	...
	{
		26518: (e, s, t) => {
			t.d(s, { bq: () => u, eb: () => p, gC: () => m, l6: () => l, yv: () => c });
			var a = t(95155);
			t(12115);
			var r = t(40287),
				i = t(66088),
			...
			function u({ className: e, size: s = "default", children: t, ...n }) {
				return (0, a.jsxs)(r.l9, {
					...
					children: [
						...
						(0, a.jsx)(r.In, {
							asChild: !0,
							children: (0, a.jsx)(i.A, { className: "size-4 opacity-50" }),
						}),
					],
				});
			}
			function m({ className: e, children: s, position: t = "popper", ...i }) {
				return (0, a.jsx)(r.ZL, {
			...
			function p({ className: e, children: s, ...t }) {
			...
			function x({ className: e, ...s }) {
				return (0, a.jsx)(r.PP, {
					...
					...s,
					children: (0, a.jsx)(d.A, { className: "size-4" }),
				});
			}
		...
		38291: (e, s, t) => {
			...
			function o({ className: e, variant: s, asChild: t = !1, ...i }) {
				let l = t ? r.DX : "span";
				return (0, a.jsx)(l, {
					"data-slot": "badge",
					className: (0, n.cn)(d({ variant: s }), e),
					...i,
				});
			}
		},
		79984: (e, s, t) => {
			t.d(s, { BT: () => o, Wu: () => l, ZB: () => d, Zp: () => i, aR: () => n });
			var a = t(95155);
			t(12115);
			var r = t(91337);
		...
		88265: (e, s, t) => {
			...
			var a = t(95155),
				...
				b = t(66088),
				w = t(49876);
			let N = "dms.api.user_permissions";
			async function y() {
				return (0, w.AT)(`/api/method/${N}.get_user_permission_settings`, {
					method: "POST",
					body: JSON.stringify({}),
				});
			}
			async function k(e) {
				return (0, w.AT)(`/api/method/${N}.save_user_permission`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function C(e) {
				return (0, w.AT)(`/api/method/${N}.delete_user_permission`, {
					method: "POST",
			...
			function M() {
				let { data: e, isLoading: s, mutate: t } = (0, i.Ay)("up-settings", () => y()),
					[l, c] = (0, r.useState)(""),
					[p, x] = (0, r.useState)(null),
					[b, w] = (0, r.useState)(!1),
					[N, M] = (0, r.useState)(!1),
					z = e?.permission_rows || [],
					R = e?.whitelisted_users || [],
					D = z.filter(
						(e) =>
							!l ||
							((e.user || "") + " " + (e.full_name || ""))
								...
								(0, a.jsxs)("div", {
									children: [
										...
										(0, a.jsx)("p", {
											...
											children:
												"DMS CRM User Settings — per-user access control",
										}),
									],
								}),
								(0, a.jsxs)(d.$, {
									...
									children: [
										(0, a.jsx)(h.A, { className: "h-4 w-4 mr-2" }),
										" Add Permission",
									],
								}),
							],
								...
								children: [
									...
									s
										...
										? (0, a.jsx)("p", {
												...
												children: "No permission rows found",
										  })
										: (0, a.jsx)("div", {
												className: "space-y-2",
												children: D.map((e) =>
							...
							(0, a.jsx)(A, {
								...
								onSave: function (e) {
									M(!0),
										k(e)
											.then(() => {
												n.o.success("Permission saved"), w(!1), t();
											})
											.catch((e) =>
												n.o.error(
													e instanceof Error
			...
			function A({ row: e, whitelist: s, saving: t, onClose: i, onSave: o }) {
				let [u, m] = (0, r.useState)(e?.user || ""),
					[h, v] = (0, r.useState)(e?.access_limited_to || "both"),
					[g, _] = (0, r.useState)(() => {
						let s = {
							can_edit_price: !1,
						...
						if (e)
							for (let [t] of ((s.can_edit_price = !!e.can_edit_price),
							(s.can_view_dms_dashboard = !!e.can_view_dms_dashboard),
							(s.can_view_dms_report = !!e.can_view_dms_report),
							(s.lead_sales_person = !!e.lead_sales_person),
							S))
								s[t] = !!e[t];
						return s;
					}),
					[j, w] = (0, r.useState)(!!e?.can_view_dms_report),
					N = (0, r.useMemo)(
						() => s.map((e) => ({ value: e.user, label: e.full_name || e.user })),
						[s]
					),
					y = (e, s) => _((t) => ({ ...t, [e]: s }));
				return (0, a.jsx)("div", {
					...
					children: (0, a.jsxs)("div", {
						className: "w-full max-w-xl rounded-lg bg-background p-6 shadow-lg",
						onClick: (e) => e.stopPropagation(),
						children: [
							(0, a.jsx)("h2", {
								className: "text-lg font-bold mb-4",
								children: e ? "Edit User Permission" : "Add User Permission",
							}),
							(0, a.jsxs)("div", {
								className: "space-y-4",
								children: [
									(0, a.jsxs)("div", {
										...
										children: [
											...
											(0, a.jsx)("p", {
												...
												children:
													"Only users in the DMS CRM User Settings whitelist are shown here.",
											}),
										],
									}),
									(0, a.jsxs)("div", {
										className: "space-y-2",
										children: [
											(0, a.jsx)(l.J, { children: "Workspace Access" }),
											(0, a.jsxs)(x.l6, {
												value: h,
												onValueChange: v,
												children: [
													(0, a.jsx)(x.bq, {
														children: (0, a.jsx)(x.yv, {
															placeholder:
																"Access to DMS and CRM workspaces",
														}),
													}),
													(0, a.jsxs)(x.gC, {
														children: [
															(0, a.jsx)(x.eb, {
																value: "both",
																children: "Access to DMS and CRM",
															}),
															(0, a.jsx)(x.eb, {
																value: "DMS",
																children: "DMS only",
										...
										children: [
											(0, a.jsxs)("div", {
												...
												children: [
													(0, a.jsx)(c.S, {
														id: "up-dashboard",
														checked: !!g.can_view_dms_dashboard,
														onCheckedChange: (e) =>
															y("can_view_dms_dashboard", !!e),
													}),
													(0, a.jsx)(l.J, {
														htmlFor: "up-dashboard",
														className:
															"text-sm font-medium cursor-pointer",
														children: "Can view DMS Dashboard",
													}),
												],
											}),
											(0, a.jsxs)("div", {
												...
												children: [
													(0, a.jsx)(c.S, {
														id: "up-edit-price",
														checked: !!g.can_edit_price,
														onCheckedChange: (e) =>
															y("can_edit_price", !!e),
													}),
													(0, a.jsx)(l.J, {
														htmlFor: "up-edit-price",
														className:
															"text-sm font-medium cursor-pointer",
														children:
															"Can Edit Price (unit prices / rates)",
													}),
												],
											}),
											(0, a.jsxs)("div", {
												...
												children: [
													(0, a.jsx)(c.S, {
														id: "up-lead",
														checked: !!g.lead_sales_person,
														onCheckedChange: (e) =>
															y("lead_sales_person", !!e),
													}),
													(0, a.jsx)(l.J, {
														htmlFor: "up-lead",
														className:
															"text-sm font-medium cursor-pointer",
														children: "Lead Sales Person",
													}),
												],
											}),
										],
									...
									(0, a.jsxs)("div", {
										...
										children: [
											(0, a.jsxs)("button", {
												...
												onClick: () => {
													w(!j),
														g.can_view_dms_report ||
															y("can_view_dms_report", !0);
												},
												children: [
													(0, a.jsxs)("div", {
														className: "flex items-center gap-3",
														children: [
															(0, a.jsx)(c.S, {
																id: "up-reports",
																checked: !!g.can_view_dms_report,
																onCheckedChange: (e) => {
																	y("can_view_dms_report", !!e),
																		w(!!e);
																},
															}),
															(0, a.jsx)(l.J, {
												...
												? (0, a.jsxs)("div", {
														...
														children: [
															(0, a.jsx)("p", {
																...
																children:
																	"Allowed report sections (tick the ones this user can view):",
															}),
															S.map(([e, s]) =>
																(0, a.jsxs)(
																	"div",
