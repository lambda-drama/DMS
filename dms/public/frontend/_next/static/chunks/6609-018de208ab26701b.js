						...
						(this.subscribe = (t) => (
							...
							(this.promise = (t, e) => {
								...
								let r = t instanceof Promise ? t : t(),
									...
									i = r
										.then(async (t) => {
											if (((s = ["resolve", t]), o.isValidElement(t)))
												(n = !1),
													this.create({
														id: a,
														type: "default",
...
`);
			var b = (t) => {
				...
				let {
					...
					tN = o.useMemo(() => z.findIndex((t) => t.toastId === T.id) || 0, [z, T.id]),
					tT = o.useMemo(() => {
						var t;
						return null != (t = T.closeButton) ? t : P;
					}, [T.closeButton, P]),
					tS = o.useMemo(() => T.duration || O || 4e3, [T.duration, O]),
					tB = o.useRef(0),
					tC = o.useRef(0),
					tM = o.useRef(0),
					tz = o.useRef(null),
					[tR, tI] = U.split("-"),
					tY = o.useMemo(
						() => z.reduce((t, e, a) => (a >= tN ? t : t + e.height), 0),
						[z, tN]
					),
					tj = (() => {
					...
					t$ = T.invert || N,
					tP = "loading" === tw;
				(tC.current = o.useMemo(() => tN * W + tY, [tN, tY])),
					o.useEffect(() => {
						tf.current = tS;
					}, [tS]),
					o.useEffect(() => {
					...
					o.useEffect(() => {
						...
						if (t) {
							...
							return (
								tp(e),
								C((t) => [
									{ toastId: T.id, height: e, position: T.position },
									...t,
								]),
								() => C((t) => t.filter((t) => t.toastId !== T.id))
							);
						}
					}, [C, T.id]),
					o.useLayoutEffect(() => {
						...
						(t.style.height = e),
							...
							C((t) =>
								t.find((t) => t.toastId === T.id)
									? t.map((t) => (t.toastId === T.id ? { ...t, height: a } : t))
									: [{ toastId: T.id, height: a, position: T.position }, ...t]
							);
					...
					o.createElement(
						"li",
						{
							...
							className: v(
								...
								null == (e = null == T ? void 0 : T.classNames) ? void 0 : e.toast,
								null == K ? void 0 : K.default,
								null == K ? void 0 : K[tw],
								null == (a = null == T ? void 0 : T.classNames) ? void 0 : a[tw]
							),
							"data-sonner-toast": "",
							...
							onPointerDown: (t) => {
								tP ||
									...
									"BUTTON" !== t.target.tagName &&
										(ts(!0), (tz.current = { x: t.clientX, y: t.clientY })));
							},
							onPointerUp: () => {
								var t, e, a, o;
								if (ti || !tx) return;
								...
								let r = Number(
									...
									s =
										new Date().getTime() -
										(null == (a = tg.current) ? void 0 : a.getTime()),
									i = "x" === J ? r : n,
									l = Math.abs(i) / s;
								if (Math.abs(i) >= 20 || l > 0.11) {
									tm(tC.current),
										null == (o = T.onDismiss) || o.call(T, T),
										tt(
											"x" === J
												? r > 0
													? "right"
							...
							onPointerMove: (e) => {
								...
								"y" === J
									...
									: "x" === J &&
									  ...
									  (d.x = i),
									(Math.abs(d.x) > 0 || Math.abs(d.y) > 0) && tc(!0),
									null == (r = tv.current) ||
							...
							? o.createElement(
									"button",
									{
										...
										className: v(
											...
											null == (n = null == T ? void 0 : T.classNames)
												? void 0
												: n.closeButton
										),
									},
									null != (m = null == X ? void 0 : X.close) ? m : u
							  )
							: null,
									...
									o.createElement(
										"div",
										{
											...
											className: v(
												...
												null == (p = null == T ? void 0 : T.classNames)
													? void 0
													: p.content
											),
										},
										o.createElement(
											"div",
											{
												...
												className: v(
													...
													null == (f = null == T ? void 0 : T.classNames)
														? void 0
														: f.title
												),
											},
											"function" == typeof T.title ? T.title() : T.title
										),
										T.description
											? o.createElement(
													"div",
			...
			var w = (0, o.forwardRef)(function (t, e) {
				let {
					...
					H = o.useRef(null),
					L = s.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
					A = o.useRef(null),
					V = o.useRef(!1),
					O = o.useCallback((t) => {
						C((e) => {
								...
								? o.createElement(
										...
										B.filter(
											...
											return o.createElement(b, {
												...
												defaultRichColors: p,
												duration:
													null != (s = null == w ? void 0 : w.duration)
														? s
														: f,
