	...
	[6],
	{
		...
		42074: (e, a, t) => {
			...
			var s = t(95155),
				...
				l = t(47650),
				n = t(91337);
			function c({ children: e, className: a, align: t = "end" }) {
				let [o, i] = (0, r.useState)(!1);
				(0, r.useEffect)(() => (i(!0), () => i(!1)), []);
				let d = (0, s.jsx)("div", {
					role: "toolbar",
				...
				return o ? (0, l.createPortal)(d, document.body) : null;
			}
		},
		61640: (e, a, t) => {
			...
			function f() {
				let { navigate: e } = (0, c.c)(),
					{ data: a } = (0, l.Ay)("crm-account-form-options", n._j),
					[t, f] = (0, r.useState)(!1),
					{ error: v, success: y, showError: j, clear: _ } = (0, b.B)(),
					[N, k] = (0, r.useState)({
						account_name: "",
						customer: "",
					...
					C = (0, r.useMemo)(
						() => (a?.account_types || []).map((e) => ({ value: e, label: e })),
						[a]
					),
					w = (0, r.useMemo)(
					...
					A = (e, a) => k((t) => ({ ...t, [e]: a })),
					T = async () => {
						if ((_(), !N.customer)) return void j("Customer is required.");
						if (!N.account_name.trim()) return void j("Account name is required.");
						f(!0);
						try {
							let a = await (0, n._m)({
									account_name: N.account_name.trim(),
									customer: N.customer,
									account_type: N.account_type,
									status: N.status,
									industry: N.industry || null,
									territory: N.territory || null,
									legal_name: N.legal_name || null,
									tax_id: N.tax_id || null,
									registration_number: N.registration_number || null,
									credit_terms: N.credit_terms || null,
									account_plan: N.account_plan || null,
									notes: N.notes || null,
								}),
								t = a?.name;
							t ? e("crm-account-detail", { id: String(t) }) : e("crm-accounts");
						} catch (e) {
							j(e, "Failed to create account");
						} finally {
							f(!1);
						}
					};
				return (0, s.jsxs)("div", {
					...
					children: [
						(0, s.jsx)(b.y, { error: v, success: y, onDismiss: _ }),
						(0, s.jsxs)(i.Zp, {
									...
									children: [
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: N.account_name,
													onChange: (e) =>
														A("account_name", e.target.value),
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(x.Zi, {
													options: C,
													value: N.account_type,
													onValueChange: (e) =>
														A("account_type", e || "Corporate"),
													placeholder: "Type…",
												}),
											],
										}),
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: N.industry,
													onChange: (e) => A("industry", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: N.tax_id,
													onChange: (e) => A("tax_id", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: N.registration_number,
													onChange: (e) =>
														A("registration_number", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: N.credit_terms,
													onChange: (e) =>
														A("credit_terms", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(u.T, {
													rows: 3,
													value: N.account_plan,
													onChange: (e) =>
														A("account_plan", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
