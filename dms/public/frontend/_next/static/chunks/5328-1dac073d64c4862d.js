...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	...
	{
		26518: (e, s, t) => {
			t.d(s, { bq: () => u, eb: () => x, gC: () => m, l6: () => o, yv: () => c });
			var a = t(95155);
			t(12115);
			var r = t(40287),
				n = t(66088),
			...
			function u({ className: e, size: s = "default", children: t, ...l }) {
			...
			function m({ className: e, children: s, position: t = "popper", ...n }) {
				return (0, a.jsx)(r.ZL, {
		...
		38291: (e, s, t) => {
			...
			function d({ className: e, variant: s, asChild: t = !1, ...n }) {
				let o = t ? r.DX : "span";
				return (0, a.jsx)(o, {
					"data-slot": "badge",
		...
		45328: (e, s, t) => {
			...
			var a = t(95155),
				...
				C = t(41015);
			function S() {
				let e = "ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz23456789!@#$%",
					s = new Uint32Array(12);
				if ("u" > typeof crypto && "function" == typeof crypto.getRandomValues)
					crypto.getRandomValues(s);
				else for (let e = 0; e < s.length; e += 1) s[e] = Math.floor(1e9 * Math.random());
				return Array.from(s, (s) => e[s % e.length]).join("");
			}
			function k({
				label: e,
				hint: s,
				...
				let o = t.filter((e) => !r.includes(e));
				return (0, a.jsxs)("div", {
					className: "space-y-2",
					children: [
						(0, a.jsx)(y.J, { children: e }),
						s
							? (0, a.jsx)("p", {
						...
						o.length > 0
							? (0, a.jsx)(N.Zi, {
									options: o.map((e) => ({ value: e, label: e })),
									value: "",
									onValueChange: (e) => {
										e && !r.includes(e) && n([...r, e]);
									},
									placeholder: `Add ${e.toLowerCase()}…`,
									emptyMessage: d || "Nothing left to add",
									portaled: !0,
							  })
							: null,
					],
			...
			function _({ id: e, value: s, onChange: t, placeholder: r }) {
				return (0, a.jsx)(b.p, {
					id: e,
					type: "password",
					value: s,
			...
			function A({ open: e, onOpenChange: s, user: t, bootstrap: n, onSaved: i }) {
				let c = !!t,
					[u, m] = (0, r.useState)(""),
					[x, h] = (0, r.useState)(""),
					[p, f] = (0, r.useState)(""),
					[N, U] = (0, r.useState)("System User"),
					[z, M] = (0, r.useState)(!0),
					[E, $] = (0, r.useState)(!1),
					[R, T] = (0, r.useState)(""),
					[L, P] = (0, r.useState)(""),
				...
				let B = L.length > 0 && R !== L;
				async function G() {
					if (!u.trim()) return void l.o.error("First name is required");
					if (!c && !p.trim()) return void l.o.error("Email is required");
					if (!c && R && R !== L) return void l.o.error("Passwords do not match");
					if (!c && R && R.length < 8)
						return void l.o.error("Password must be at least 8 characters");
					q(!0);
					try {
						if (c && t)
							await C.TK({
							...
							let e = await C.kg({
								...
								password: R || void 0,
								confirm_password: R ? L : void 0,
								roles: D,
								role_profiles: J,
							});
							l.o.success(
								R
									? `${e.full_name} created — they must change the password on first sign-in`
									: "User created"
							);
						}
						i(), s(!1);
					} catch (e) {
						l.o.error(e instanceof Error ? e.message : "Failed to save user");
					} finally {
						q(!1);
					}
				}
				return (0, a.jsx)(j.lG, {
					...
					children: (0, a.jsxs)(j.Cf, {
						...
						children: [
							(0, a.jsxs)(j.c7, {
								children: [
									(0, a.jsx)(j.L3, { children: c ? "Edit User" : "New User" }),
									(0, a.jsx)(j.rr, {
										children: c
							...
							(0, a.jsxs)("div", {
								...
								children: [
									(0, a.jsxs)("div", {
										...
										children: [
											(0, a.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, a.jsx)(y.J, { children: "First name" }),
													(0, a.jsx)(b.p, {
														value: u,
											...
											(0, a.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, a.jsx)(y.J, { children: "Last name" }),
													(0, a.jsx)(b.p, {
														value: x,
									...
									(0, a.jsxs)("div", {
										className: "space-y-1",
										children: [
											(0, a.jsx)(y.J, { children: "Email / username" }),
											(0, a.jsx)(b.p, {
												type: "email",
												value: p,
									...
									(0, a.jsxs)("div", {
										...
										children: [
											(0, a.jsxs)("div", {
												className: "space-y-1",
												children: [
													(0, a.jsx)(y.J, { children: "User type" }),
													(0, a.jsxs)(w.l6, {
														value: N,
														onValueChange: U,
														children: [
															(0, a.jsx)(w.bq, {
																children: (0, a.jsx)(w.yv, {}),
															}),
															(0, a.jsx)(w.gC, {
																children: (n.user_types?.length
																	? n.user_types
																	: [
																			"System User",
																			"Website User",
									...
									(0, a.jsx)(k, {
										label: "Roles",
										options: n.assignable_roles || [],
										value: D,
										onChange: F,
										placeholder: "No roles selected",
										emptyMessage:
											"No roles configured on DMS CRM User Settings",
										hint: "Only roles on DMS CRM User Settings can be assigned.",
									}),
									(0, a.jsx)(k, {
										label: "Role profiles",
										options: n.role_profiles || [],
										value: J,
										onChange: V,
			...
			function U({ open: e, onOpenChange: s, user: t, onSaved: n }) {
				let [i, c] = (0, r.useState)(""),
					[u, m] = (0, r.useState)(""),
					[x, h] = (0, r.useState)(!0),
					[p, f] = (0, r.useState)(!1);
				(0, r.useEffect)(() => {
				...
				let b = u.length > 0 && i !== u;
				async function y() {
					if (t) {
						if (i.length < 8)
							return void l.o.error("Password must be at least 8 characters");
						if (i !== u) return void l.o.error("Passwords do not match");
						f(!0);
						try {
							await C.ly({
								user: t.user,
							...
							l.o.error(e instanceof Error ? e.message : "Failed to set password");
						} finally {
							f(!1);
						}
					}
				...
				return (0, a.jsx)(j.lG, {
					...
					children: (0, a.jsxs)(j.Cf, {
						...
						children: [
							(0, a.jsxs)(j.c7, {
								children: [
									(0, a.jsx)(j.L3, { children: "Set Temporary Password" }),
									(0, a.jsxs)(j.rr, {
										children: [
											t
												? `Set a password for ${t.full_name || t.user}. `
												: "",
								...
								children: [
									(0, a.jsx)("div", {
										...
										children: (0, a.jsxs)(g.$, {
											...
											children: [
												(0, a.jsx)(d.A, { className: "mr-1 h-3.5 w-3.5" }),
												"Generate",
											],
										}),
									}),
			...
			function z({ embedded: e = !1 }) {
				let {
						data: s,
						isLoading: t,
						mutate: l,
					} = (0, n.Ay)("dms-users-bootstrap", () => C.JK()),
					[i, d] = (0, r.useState)(""),
					[v, j] = (0, r.useState)(!1),
				...
				return t
					...
					: s?.can_manage
					? (0, a.jsxs)("div", {
							className: e ? "space-y-4 border-t pt-8" : "min-w-0 space-y-4",
							children: [
								(0, a.jsxs)("div", {
									className:
										...
										(0, a.jsxs)("div", {
											children: [
												e
													...
													: (0, a.jsx)("h1", {
															className:
																"dms-stat-value text-xl tracking-tight",
															children: "Users",
													  }),
												(0, a.jsx)("p", {
													className: "text-sm text-muted-foreground",
													children:
														"Create DMS users, assign roles and set temporary passwords. Dealer Manager, System Manager and Administrator only.",
												}),
											],
										}),
										(0, a.jsxs)(g.$, {
											...
											children: [
												(0, a.jsx)(u.A, { className: "mr-2 h-4 w-4" }),
												"New User",
											],
										}),
									],
											...
											children: [
												...
												(0, a.jsxs)(f.BT, {
													children: [
														...
														" DMS user",
														1 === k.length ? "" : "s",
														" from DMS CRM User Settings. A temporary password forces a password change on first sign-in.",
													],
												}),
											],
										}),
		...
		79984: (e, s, t) => {
			t.d(s, { BT: () => d, Wu: () => o, ZB: () => i, Zp: () => n, aR: () => l });
			var a = t(95155);
			t(12115);
			var r = t(91337);
