...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[473],
	{
		...
		60473: (e, t, a) => {
			...
			let _ = 0,
				...
				y = (e) => {
					if (f.has(e)) return;
					let t = setTimeout(() => {
						f.delete(e), C({ type: "REMOVE_TOAST", toastId: e });
					}, 1e6);
					f.set(e, t);
				},
				N = [],
			...
			function S({ ...e }) {
				let t = (_ = (_ + 1) % Number.MAX_SAFE_INTEGER).toString(),
					a = () => C({ type: "DISMISS_TOAST", toastId: t });
				return (
					C({
						type: "ADD_TOAST",
						toast: {
			...
			var T = a(42074);
			let V = ["Petrol", "Diesel", "Hybrid", "PHEV", "EV", "CNG", "LPG"],
				k = ["Manual (MT)", "Automatic (AT)", "CVT", "DCT", "AMT", "EV Single Speed"],
				I = ["FWD", "RWD", "AWD", "4WD"],
				A = ["In Stock", "Delivered to Customer", "In Service", "In Transit"],
				E = [
					"Inactive",
					"Active",
					"Expired by Time",
			...
			function D() {
				let { navigate: e, viewParams: t } = (0, n.c)(),
					...
					L = (0, r.useMemo)(
						() =>
							"inspection-new" === _
								? { view: "inspection-new", label: "Back to New Inspection" }
								: "appointment-new" === _
								? { view: "appointment-new", label: "Back to New Appointment" }
								: "invoice-new" === _
								? { view: "invoice-new", label: "Back to New Invoice" }
								: { view: "vehicles", label: "Back to Vehicles" },
						[_]
					),
					z = (t) => {
						if ("inspection-new" === L.view) {
							let a = {};
							f && (a.appointment = f),
								D && (a.id = D),
								t && (a.vin = t),
						...
						if ("appointment-new" === L.view) {
							let a = {};
							t && (a.vin = t), y && (a.id = y), e("appointment-new", a);
							return;
						}
						if ("invoice-new" === L.view) {
							let a = {};
							t && (a.vin = t), e("invoice-new", a);
							return;
						}
						e("vehicles");
					},
					...
					[$, H] = (0, r.useState)(""),
					[Q, X] = (0, r.useState)(""),
					{ data: Y, isLoading: K, mutate: ee } = (0, i.cf)(R),
					{ data: et, isLoading: ea } = (0, i.iR)(W),
					{ data: es } = (0, i.dQ)(B),
					{ data: er } = (0, i.Ms)(),
					{ data: en, isLoading: ei } = (0, i.Rr)(Q),
					{ data: el, isLoading: eo } = (0, i.Ge)(F),
					{ data: ec, isLoading: ed } = (0, i.Ge)($),
					[em, eu] = (0, r.useState)(null),
					[ep, eh] = (0, r.useState)({
						company: M || "",
						vin_number: Z ? Z.toUpperCase() : "",
						engine_number: "",
						plate_number: "",
						linked_item: "",
						model: "",
					...
					ex = (e, t) => eh((a) => ({ ...a, [e]: t }));
				(0, i.Tr)(en, ei, ep.company, (e) => ex("company", e.name), { search: Q }),
					(0, i.Zf)(ep.current_customer, (e) => {
						ex("current_customer", e.default_customer), eu((0, l.Gd)(e));
					});
				let ev = (0, r.useMemo)(
					() => (0, l.b0)(es, ep.current_customer, em),
					[es, ep.current_customer, em]
				);
				async function eg() {
					if (!ep.vin_number.trim())
						return void a({ title: "VIN number is required", variant: "destructive" });
					if (17 !== ep.vin_number.trim().length)
						return void a({
					...
					if (!ep.linked_item)
						return void a({
							title: "Vehicle Item is required",
							variant: "destructive",
						});
					if (!ep.company)
						return void a({ title: "Company is required", variant: "destructive" });
					O(!0);
					try {
						let e = await o.xn({
							company: ep.company,
							vin_number: ep.vin_number.trim(),
							engine_number: ep.engine_number || void 0,
							plate_number: ep.plate_number || void 0,
							linked_item: ep.linked_item,
							model: ep.model || void 0,
							warranty_status: ep.warranty_status || "Active",
							brand: ep.brand || void 0,
							model_variant: ep.model_variant || void 0,
							model_year: ep.model_year ? parseInt(ep.model_year) : void 0,
							fuel_type: ep.fuel_type || void 0,
							transmission: ep.transmission || void 0,
							drive_type: ep.drive_type || void 0,
							exterior_color: ep.exterior_color || void 0,
							interior_color: ep.interior_color || void 0,
							current_customer: ep.current_customer || void 0,
							current_odometer: ep.current_odometer
								? parseInt(ep.current_odometer)
								: void 0,
							odometer_unit: ep.odometer_unit,
							vehicle_status: ep.vehicle_status,
							special_notes: ep.special_notes || void 0,
						});
						a({ title: `Vehicle ${e.name} created successfully` }), z(e.name);
					} catch (e) {
						a({
							title: e instanceof Error ? e.message : "Failed to create vehicle",
							variant: "destructive",
						});
					} finally {
						O(!1);
				...
				return (0, s.jsxs)("div", {
					className: "dms-form-page space-y-6 max-w-4xl",
					children: [
						(0, s.jsxs)(m.$, {
							variant: "ghost",
							size: "sm",
						...
						(0, s.jsxs)("div", {
							children: [
								...
								(0, s.jsx)("p", {
									...
									children: "Create a new VIN record",
								}),
							],
						}),
						(0, s.jsxs)(h.Zp, {
							children: [
								(0, s.jsx)(h.aR, {
									children: (0, s.jsx)(h.ZB, {
										className: "text-base",
										children: "Vehicle Identification",
									}),
								}),
								(0, s.jsx)(h.Wu, {
									className: "space-y-4",
										...
										children: [
											...
											(0, s.jsxs)("div", {
												...
												children: [
													...
													ep.vin_number &&
														17 !== ep.vin_number.length &&
														(0, s.jsxs)("p", {
															className: "text-xs text-amber-600",
															children: [
																"VIN should be 17 characters (",
																ep.vin_number.length,
																"/17)",
															],
														}),
												],
											...
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Engine Number" }),
													(0, s.jsx)(u.p, {
														placeholder: "Engine number",
														value: ep.engine_number,
														onChange: (e) =>
															ex("engine_number", e.target.value),
													}),
												],
											}),
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "License Plate" }),
													(0, s.jsx)(u.p, {
														placeholder: "License plate number",
														value: ep.plate_number,
														onChange: (e) =>
															ex(
																"plate_number",
																e.target.value.toUpperCase()
											...
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsxs)("p", {
														...
														children: [
															"Vehicle items come from Item Groups with ",
															(0, s.jsx)("b", {
																children: "Is Vehicle",
															}),
															" ticked.",
											...
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Vehicle Model" }),
													(0, s.jsx)(c.Zi, {
														value: ep.model,
														onValueChange: (e) => ex("model", e),
														onSearchChange: q,
											...
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsxs)(x.l6, {
														value: ep.warranty_status,
														onValueChange: (e) =>
															ex("warranty_status", e),
														children: [
															(0, s.jsx)(x.bq, {
									...
									children: (0, s.jsxs)("div", {
										...
										children: [
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Model Year" }),
													(0, s.jsx)(u.p, {
														type: "number",
														placeholder: "e.g. 2024",
														value: ep.model_year,
														onChange: (e) =>
															ex("model_year", e.target.value),
													}),
												],
											}),
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsx)(u.p, {
														...
														value: ep.model_variant,
														onChange: (e) =>
															ex("model_variant", e.target.value),
													}),
												],
											}),
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsx)(d.Z, {
														doctype: "Color",
														onCreated: (e) => ex("exterior_color", e),
														children: (0, s.jsx)(c.Zi, {
															options:
																el?.map((e) => ({
																	value: e.name,
											...
											(0, s.jsxs)("div", {
												...
												children: [
													...
													(0, s.jsx)(d.Z, {
														doctype: "Color",
														onCreated: (e) => ex("interior_color", e),
														children: (0, s.jsx)(c.Zi, {
															options:
																ec?.map((e) => ({
																	value: e.name,
											...
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Fuel Type" }),
													(0, s.jsxs)(x.l6, {
														value: ep.fuel_type,
														onValueChange: (e) => ex("fuel_type", e),
														children: [
															(0, s.jsx)(x.bq, {
																children: (0, s.jsx)(x.yv, {}),
															}),
											...
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Transmission" }),
													(0, s.jsxs)(x.l6, {
														value: ep.transmission,
														onValueChange: (e) =>
															ex("transmission", e),
														children: [
															(0, s.jsx)(x.bq, {
											...
											(0, s.jsxs)("div", {
												className: "space-y-2",
												children: [
													(0, s.jsx)(p.J, { children: "Drive Type" }),
													(0, s.jsxs)(x.l6, {
														value: ep.drive_type,
														onValueChange: (e) => ex("drive_type", e),
														children: [
															(0, s.jsx)(x.bq, {
																children: (0, s.jsx)(x.yv, {}),
															}),
									...
									children: (0, s.jsxs)("div", {
										...
										children: [
											(0, s.jsxs)("div", {
												...
												children: [
													(0, s.jsx)(p.J, {
														children: "Current Customer / Owner",
													}),
													(0, s.jsx)(d.Z, {
														doctype: "Customer",
														onCreated: (e, t) => {
															ex("current_customer", e),
																eu({
																	name: e,
																	customer_name: t || e,
																});
														...
														children: (0, s.jsx)(c.Zi, {
															options: ev,
															value: ep.current_customer,
															valueLabel: em?.customer_name,
															onValueChange: (e) => {
																let t = (0, l.R)(e, es, er);
																ex("current_customer", t.customer),
																	eu(t.meta);
															},
															onSearchChange: G,
															placeholder:
							...
							children: [
								...
								(0, s.jsx)(h.Wu, {
									children: (0, s.jsx)(v.T, {
										...
										value: ep.special_notes,
										onChange: (e) => ex("special_notes", e.target.value),
										rows: 3,
									}),
								}),
							],
								...
								(0, s.jsxs)(m.$, {
									...
									children: [
										J
											...
											: (0, s.jsx)(j.A, { className: "mr-2 h-4 w-4" }),
										"Create Vehicle",
									],
								}),
							],
		...
		79984: (e, t, a) => {
			a.d(t, { BT: () => o, Wu: () => c, ZB: () => l, Zp: () => n, aR: () => i });
			var s = a(95155);
			a(12115);
			var r = a(91337);
			function n({ className: e, ...t }) {
