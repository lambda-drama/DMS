		...
		47279: (e, t, a) => {
			...
			function v(e) {
				let {
					...
					[m, v] = (0, s.i)({ prop: a, defaultProp: d ?? !1, onChange: o, caller: k }),
					[x, j] = r.useState(null),
					[b, w] = r.useState(null),
					A = r.useRef(!1),
					M = !x || !!l || !!x.closest("form"),
					C = {
						checked: m,
						disabled: c,
						setChecked: v,
			...
			var x = "CheckboxTrigger",
				j = r.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: a, ...d }, s) => {
					let {
							control: l,
							value: i,
							disabled: o,
			...
			var b = r.forwardRef((e, t) => {
				...
				return (0, h.jsx)(v, {
					...
					internal_do_not_use_render: ({ isFormControl: e }) =>
						(0, h.jsxs)(h.Fragment, {
							children: [
								(0, h.jsx)(j, { ...p, ref: t, __scopeCheckbox: a }),
								e && (0, h.jsx)(C, { __scopeCheckbox: a }),
							],
						}),
				});
			});
			...
			var w = "CheckboxIndicator",
				A = r.forwardRef((e, t) => {
					let { __scopeCheckbox: a, forceMount: r, ...n } = e,
						d = m(w, a);
					return (0, h.jsx)(o.C, {
						present: r || g(d.checked) || !0 === d.checked,
			...
			var M = "CheckboxBubbleInput",
				C = r.forwardRef(({ __scopeCheckbox: e, ...t }, a) => {
					let {
							control: d,
					...
					r.useEffect(() => {
						...
						if (w !== s && e) {
							...
							(x.indeterminate = g(s)), e.call(x, !g(s) && s), x.dispatchEvent(a);
						}
					}, [x, w, s, c]);
					let C = r.useRef(!g(s) && s);
