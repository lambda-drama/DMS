	...
	[668, 9493],
	{
		...
		49493: (e, s, a) => {
			...
			var t = a(95155),
				...
				j = a(65588),
				f = a(10668);
			let g = ["Active", "Inactive", "On Leave"];
			function N({ open: e, onOpenChange: s, onCreated: a, advisor: r, onUpdated: i }) {
				let { mutate: n } = (0, m.iX)(),
					d = !!r?.name,
					[b, y] = (0, l.useState)(!1),
					[w, A] = (0, l.useState)(""),
				...
				async function $(e) {
					if ((e.preventDefault(), !w.trim() || !C.trim() || !k.trim() || !P.trim()))
					...
					try {
						if (d && r?.name) {
							await f.updatePartsAdvisor(r.name, {
								first_name: w.trim(),
								last_name: C.trim(),
								phone: k.trim(),
								email: P.trim(),
								...
								await J(),
								o.o.success("Parts advisor updated"),
								i?.(r.name),
								s(!1);
							return;
						}
						let e = await (0, j._)("Parts Advisor", {
							first_name: w.trim(),
							last_name: C.trim(),
							phone: k.trim(),
							email: P.trim(),
						...
						await J(),
							o.o.success(`Parts advisor ${e.label || e.name} created`),
							a?.(e.name, e.label),
							s(!1);
					} catch (e) {
						o.o.error(
			...
			function J() {
				let { canWrite: e } = (0, d.Sk)(),
					[s, a] = (0, i.P)("parts-advisors", "search", ""),
					[o, m] = (0, i.P)("parts-advisors", "status", "Active"),
					[u, h] = (0, l.useState)(!1),
					[j, f] = (0, l.useState)(!1),
					[g, A] = (0, l.useState)(null),
					{ data: C, isLoading: O, error: L } = (0, n.XO)(s, o),
					{ data: J, isLoading: q, mutate: F } = (0, n.nc)(g),
					Q = (0, l.useMemo)(() => {
						if (!C) return [];
						...
						return e
							? C.filter(
									(s) =>
										s.full_name?.toLowerCase().includes(e) ||
										s.name?.toLowerCase().includes(e) ||
										s.phone?.toLowerCase().includes(e) ||
										s.email?.toLowerCase().includes(e)
							  )
							: C;
					}, [C, s]),
					T = C?.filter((e) => "Active" === e.status).length ?? 0;
				return (0, t.jsxs)("div", {
					...
					children: [
						...
						(0, t.jsx)(N, { open: u, onOpenChange: h, onCreated: () => h(!1) }),
						(0, t.jsx)(N, {
							open: j,
							onOpenChange: f,
							advisor: J,
						...
						(0, t.jsxs)(b.BN, {
							...
							title: J?.full_name || g || "Parts Advisor",
							subtitle: g || void 0,
							footer:
								e("parts-advisors") && J
									? (0, t.jsxs)(x.$, {
										...
										children: [
											...
											(0, t.jsxs)(b.JH, {
												...
												children: [
													...
													(0, t.jsx)(b.Qb, {
														label: "Advisor code",
														value: J.advisor_code,
													}),
													(0, t.jsx)(b.Qb, {
														label: "Internal employee",
														value: J.internal_employee,
													}),
													(0, t.jsx)(b.Qb, {
													...
													(0, t.jsx)(b.Qb, {
														...
														value: J.date_of_joining
															? (0, r.Yq)(J.date_of_joining)
															: void 0,
													}),
												],
											}),
