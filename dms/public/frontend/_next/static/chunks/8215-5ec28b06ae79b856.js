...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[8215],
	{
		...
		26518: (e, t, a) => {
			a.d(t, { bq: () => u, eb: () => p, gC: () => m, l6: () => c, yv: () => d });
			var n = a(95155);
			a(12115);
			var s = a(40287),
				i = a(66088),
			...
			function u({ className: e, size: t = "default", children: a, ...r }) {
				return (0, n.jsxs)(s.l9, {
					...
					children: [
						...
						(0, n.jsx)(s.In, {
							asChild: !0,
							children: (0, n.jsx)(i.A, { className: "size-4 opacity-50" }),
						}),
					],
				});
			}
			function m({ className: e, children: t, position: a = "popper", ...i }) {
				return (0, n.jsx)(s.ZL, {
		...
		38291: (e, t, a) => {
			...
			function l({ className: e, variant: t, asChild: a = !1, ...i }) {
				let c = a ? s.DX : "span";
				return (0, n.jsx)(c, {
					"data-slot": "badge",
					className: (0, r.cn)(o({ variant: t }), e),
					...i,
				});
			}
		},
		...
		60932: (e, t, a) => {
			...
			var n = a(95155),
				...
				r = a(42427),
				o = a(9245);
			function l({ open: e, onOpenChange: t, salesInvoice: a, onPaid: c }) {
					...
					return (
						...
						o
							...
							.then(async (e) => {
								if (n) return;
								p(e);
								let t = await o.us(e.company);
								n || b(t);
							})
							.catch((e) => {
								n || (i.o.error(e.message || "Failed to load invoice"), t(!1));
							})
							.finally(() => {
								n || u(!1);
							}),
				...
				let g = m
					? {
							...
							partyName: m.customer_name || m.customer,
							currency: m.currency,
							grandTotal: m.grand_total || 0,
							outstanding: m.outstanding_amount || 0,
							dueDate: m.due_date,
				...
				return (0, n.jsx)(r.d, {
					...
					loading: d,
					onRecord: async (e, t) =>
						o.$h({ salesInvoice: a, payments: e, remarks: t || void 0 }),
					onPaid: c,
				});
			}
		},
		63388: (e, t, a) => {
			...
			function k({ children: e, customerId: t }) {
				let [a, i] = (0, s.useState)(null),
					r = (0, s.useMemo)(() => (e) => i(e), []);
				return (0, n.jsxs)(N.Provider, {
					value: r,
					children: [
						e,
						(0, n.jsx)(Q, {
			...
			function T(e) {
				return e ? (0, o.r6)(String(e)) || String(e) : "—";
			}
			...
			function V({ fields: e, doc: t }) {
				return (0, n.jsx)(n.Fragment, {
					children: e.map(([e, a]) => {
						let s = t[a],
							i =
								a.includes("date") || a.includes("time") || a.endsWith("_on")
									? T(s)
									: a.includes("amount") ||
									  a.includes("value") ||
									  a.includes("total") ||
									...
									? "—"
									: String(s);
						return (0, n.jsx)(c.Qb, { label: e, value: i }, a);
					}),
				});
			}
			function F({ invoice: e, onCollect: t }) {
				let a = Number(e.outstanding_amount || 0),
					s = 1 === Number(e.docstatus) && a > 0.001;
				return (0, n.jsxs)(n.Fragment, {
					children: [
						(0, n.jsxs)(c.JH, {
							title: "Invoice",
							children: [
								(0, n.jsx)(c.Qb, { label: "Invoice", value: e.name }),
								(0, n.jsx)(c.Qb, {
									label: "Customer",
									value: e.customer_name || e.customer,
								}),
								(0, n.jsx)(c.Qb, { label: "Status", value: e.status }),
								(0, n.jsx)(c.Qb, {
									label: "Posting date",
									value: T(e.posting_date),
								}),
								(0, n.jsx)(c.Qb, { label: "Due date", value: T(e.due_date) }),
							],
						}),
						(0, n.jsxs)(c.JH, {
							title: "Amounts",
							children: [
								(0, n.jsx)(c.Qb, { label: "Net total", value: z(e.net_total) }),
								(0, n.jsx)(c.Qb, {
									label: "Tax",
									value: z(e.total_taxes_and_charges),
								}),
								(0, n.jsx)(c.Qb, {
									label: "Grand total",
									value: z(e.grand_total),
								}),
								(0, n.jsx)(c.Qb, {
									label: "Outstanding",
									value: z(e.outstanding_amount),
								}),
							],
						}),
						e.items?.length
						...
						s
							? (0, n.jsxs)(m.$, {
									...
									onClick: t,
									children: [
										(0, n.jsx)(j.A, { className: "mr-2 h-4 w-4" }),
										"Collect payment",
									],
							  })
							: null,
			...
			function Q({ record: e, customerId: t, onOpenChange: a }) {
				let { navigate: o } = (0, l.c)(),
					[p, v] = (0, s.useState)(!1),
					b = e?.kind,
					g = e?.name || "",
					f = !!(
						b &&
						g &&
						!["contact", "communication", "payment", "service_due"].includes(b)
					),
					{
						data: x,
						isLoading: _,
						mutate: h,
					} = (0, i.Ay)(f ? ["crm-360-record", b, g] : null, () => P(b, g)),
					y = (0, s.useMemo)(() => {
						if (x) {
							let e = D(x);
							for (let t of [
								...
								if (e[t] && "object" == typeof e[t]) return D(e[t]);
							return e;
						}
						return e?.row || {};
					}, [x, e]),
					j = b ? A[b] : "Record",
					N = I(y, "title") || I(y, "subject") || I(y, "customer_name") || g,
					S = I(y, "status") || I(y, "stage"),
					k = b ? C[b] : void 0,
					z = "job_card" === b && x,
					T = "invoice" === b;
				return (0, n.jsxs)(n.Fragment, {
					children: [
						(0, n.jsx)(c.BN, {
							...
							onOpenChange: a,
							title: I(y, "name") || g || j,
							subtitle: N && N !== g ? `${j} \xb7 ${N}` : j,
							badge: S ? { label: S } : void 0,
							isLoading: !!(f && _),
							contentScroll: z ? "inner" : "outer",
							footer: k
								? (0, n.jsxs)(m.$, {
										className: "w-full",
										onClick: () => {
											a(!1), o(k.view, { [k.param || "id"]: g });
										},
										children: [
											(0, n.jsx)(w.A, { className: "mr-2 h-4 w-4" }),
											"Open full ",
											j.toLowerCase(),
										],
								  })
							...
							children: z
								? (0, n.jsx)(
										d.Z,
										{
											jobCard: x,
											onOpenFullDetails: () => {
												a(!1), o("job-card-detail", { id: g });
											},
										},
										g
								  )
								: T && x
								? (0, n.jsx)(F, { invoice: x, onCollect: () => v(!0) })
								: b
								? (0, n.jsx)(O, { kind: b, doc: y })
								: null,
						}),
						"invoice" === b && g
							? (0, n.jsx)(u.d, {
