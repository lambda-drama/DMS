...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[7881],
	{
		20714: (e, a, s) => {
			...
			function U(e) {
				return (
					"Internal" !== e.job_card_type &&
					("Completed" === e.status || "Delivered" === e.status)
				);
			}
			function B(e) {
				let a = (0, R.fy)(e.status, e.docstatus);
				return "Cancelled" !== a && "Delivered" !== a;
			}
			function H(e) {
				return "Cancelled" === (0, R.fy)(e.status, e.docstatus);
			}
			let Y = [
			...
			function ee({ status: e, docstatus: a, onOpen: s }) {
				let l = (0, R.fy)(e, a),
					n =
						{
							Draft: 0,
				...
				let r = (0, t.jsx)("div", {
					className: "flex items-center gap-0.5 min-w-[200px]",
					title: l,
					children: ["Draft", "Estimate", "Repair", "Road Test", "QC", "Done"].map(
						(e, a) =>
							(0, t.jsxs)(
								"div",
								{
				...
				return s
					? (0, t.jsx)("button", {
							...
							onClick: s,
							className:
								"rounded-md p-1 -m-1 text-left transition-colors hover:bg-muted/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer",
							title:
								"Draft" === l
			...
			function et() {
				let { navigate: e, viewParams: a } = (0, r.c)(),
					[s, et] = (0, W.P)("job-cards", "search", ""),
					[el, en] = (0, W.P)("job-cards", "status", "all"),
					[er, ei] = (0, W.P)("job-cards", "job_card_type", "all"),
					[ed, eo] = (0, W.P)("job-cards", "payment_status", "all"),
					[ec, em] = (0, W.P)("job-cards", "preset", null),
					[eu, ex] = (0, W.P)("job-cards", "opened_from", ""),
					[eh, ep] = (0, W.P)("job-cards", "opened_to", ""),
					[ej, ef] = (0, W.P)("job-cards", "completed_from", ""),
					[eb, eg] = (0, W.P)("job-cards", "completed_to", ""),
					[ev, eN] = (0, n.useState)(1),
					[ew, ey] = (0, n.useState)(50),
					[eC, e_] = (0, n.useState)(null),
					[ek, eA] = (0, n.useState)(!1),
					[eP, e$] = (0, n.useState)(null),
					[eS, eE] = (0, n.useState)(null),
					[eD, eF] = (0, n.useState)(""),
					[eI, eJ] = (0, n.useState)(!1),
				...
				(0, n.useEffect)(() => {
					...
					s
						? (en(s), em(null))
						: ("active" === e || "qc" === e || "qc_failed" === e || "overdue" === e) &&
						  (em(e), en("all"));
				}, [a]);
				let eW = {
						status: "all" !== el ? el : void 0,
						filter: ec || void 0,
						job_card_type: "all" !== er ? er : void 0,
						payment_status: "all" !== ed ? ed : void 0,
						opened_from: eu || void 0,
						opened_to: eh || void 0,
						completed_from: ej || void 0,
						completed_to: eb || void 0,
					},
					{
						data: eL,
						isLoading: eM,
						error: eQ,
						mutate: ez,
					} = (0, d.eT)({ ...eW, limit: ew, offset: (ev - 1) * ew }),
					eV = eL?.total || 0,
					eq = [el, er, ed, ec ?? "", eu, eh, ej, eb, ev, ew].join("|"),
					{
						items: eZ,
						loadedCount: eU,
						isLoadingMore: eB,
						...
						enabled: ew >= O.J,
						fetchMore: async (e, a) =>
							(await z.p9({ ...eW, limit: a, offset: e })).data,
					}),
					{ data: eY, isLoading: eG } = (0, d.pw)(eC),
					eK = async () => {
						if (eS) {
							eJ(!0);
							try {
								await z.qu(eS.name, eD.trim() || void 0),
									F.o.success(`Job card ${eS.name} cancelled`),
									eE(null),
									eF(""),
									eC === eS.name && e_(null),
									await ez();
								...
								F.o.error(
									e instanceof Error ? e.message : "Failed to cancel job card"
								);
							} finally {
								eJ(!1);
							}
					...
					eX = async (a) => {
						eT(a.name);
						try {
							let s = await z.UF(a.name);
							F.o.success(`New version ${s.name} created`),
								e("job-card-detail", { id: s.name });
						} catch (e) {
							F.o.error(
					...
					e0 = async (a) => {
						if (a.already_amended && a.amended_as)
							return void e("job-card-detail", { id: a.amended_as });
						eT(a.name);
						try {
							let s = await z.fV(a.name);
							F.o.success(`Amended as ${s.name}`),
								e("job-card-detail", { id: s.name });
						} catch (e) {
							F.o.error(e instanceof Error ? e.message : "Failed to amend job card");
						} finally {
							eT(null);
						}
					};
				(0, n.useEffect)(() => {
					eN(1);
				}, [el, er, ed, ec, eu, eh, ej, eb]);
				let e1 = !!(eu || eh || ej || eb),
					e2 = !!(ec || "all" !== el || "all" !== er || "all" !== ed || e1),
					e4 = es(eu, eh),
					e3 = es(ej, eb),
					e5 = eZ?.filter((e) => {
						if (!s) return !0;
						...
						return (
							...
							e.customer_name?.toLowerCase().includes(a) ||
							e.license_plate?.toLowerCase().includes(a) ||
							e.vehicle_vin?.toLowerCase().includes(a) ||
							e.vin_number?.toLowerCase().includes(a) ||
							e.vehicle_model?.toLowerCase().includes(a)
						);
					}),
					e9 = {
						total: e5?.length || 0,
						open:
							e5?.filter(
								(e) => "Draft" === e.status || "Estimation Pending" === e.status
							).length || 0,
						inProgress: e5?.filter((e) => X.includes(e.status)).length || 0,
						completed:
							e5?.filter((e) => "Completed" === e.status || "Delivered" === e.status)
								.length || 0,
					};
				return (0, t.jsxs)("div", {
					...
					children: [
									...
									children: [
											...
											children: [
												(0, t.jsxs)("div", {
													...
													children: [
														...
														(0, t.jsx)(u.p, {
															placeholder:
																"Search by job card ID, vehicle, customer...",
															value: s,
										...
										(0, t.jsxs)("div", {
											...
											children: [
												(0, t.jsxs)("div", {
													...
													children: [
														(0, t.jsx)(q.J, {
															htmlFor: "job-card-opened-from",
															className:
																"text-xs text-muted-foreground",
															children: "Open date from",
														}),
														(0, t.jsx)(u.p, {
												...
												(0, t.jsxs)("div", {
													...
													children: [
														(0, t.jsx)(q.J, {
															htmlFor: "job-card-opened-to",
															className:
																"text-xs text-muted-foreground",
															children: "Open date to",
														}),
														(0, t.jsx)(u.p, {
												...
												(0, t.jsxs)("div", {
													...
													children: [
														(0, t.jsx)(q.J, {
															htmlFor: "job-card-completed-from",
															className:
																"text-xs text-muted-foreground",
															children: "Completed date from",
														}),
														(0, t.jsx)(u.p, {
										...
										eM
											...
											? (0, t.jsx)("div", {
													...
													children: "Failed to load job cards",
											  })
											: e5 && e5.length > 0
											? (0, t.jsxs)(t.Fragment, {
													children: [
																												...
																												(
																													...
																													e.stopPropagation(),
																														(function (
																															...
																															window.open(
																																`${a}#job-card-detail?id=${encodeURIComponent(
																																	e
																																)}`,
																																"_blank",
																																"noopener,noreferrer"
											...
											: (0, t.jsxs)("div", {
													className:
														"flex flex-col items-center justify-center rounded-lg border border-dashed py-10 text-muted-foreground md:h-48 md:border-0 md:py-0",
													children: [
														(0, t.jsx)(A.A, {
														...
														(0, t.jsx)("p", {
															...
															children: "No job cards found",
														}),
														(0, t.jsx)(m.$, {
															variant: "link",
															className: "mt-2",
															onClick: () => e("job-card-new"),
															children: "Create your first job card",
														}),
													],
											  }),
										e5 && e5.length > 0
							...
							children: [
								(0, t.jsxs)("div", {
									...
									children: [
										...
										(0, t.jsxs)(m.$, {
											...
											onClick: () => eA((e) => !e),
											children: [
												(0, t.jsx)(P.A, { className: "mr-2 h-3.5 w-3.5" }),
												ek ? "Hide stats" : "Show stats",
												(0, t.jsx)($.A, {
													className: (0, Q.cn)(
								...
								(0, t.jsxs)("div", {
									className: (0, Q.cn)(
										...
										ek ? "grid" : "hidden md:grid"
									),
									children: [
										(0, t.jsx)(x.Zp, {
											className: "dms-kpi-card",
											children: (0, t.jsxs)(x.Wu, {
												className:
												...
												children: [
													...
													(0, t.jsx)("div", {
														className:
															"rounded-full bg-primary/10 p-2 sm:p-2",
										...
										(0, t.jsx)(x.Zp, {
											...
											children: (0, t.jsxs)(x.Wu, {
												...
												children: [
													...
													(0, t.jsx)("div", {
														className:
															"rounded-full bg-[#1E88E5]/10 p-2 sm:p-2",
														children: (0, t.jsx)(E.A, {
															className:
																"h-3.5 w-3.5 text-[#1E88E5]",
														}),
													}),
												],
											}),
													...
													(0, t.jsxs)("div", {
														...
														children: [
															...
															(0, t.jsx)("p", {
																className:
																	"dms-stat-value text-xl sm:text-2xl",
																children: e9.inProgress,
															}),
														],
													}),
													(0, t.jsx)("div", {
														className:
															"rounded-full bg-[#F9A825]/10 p-2 sm:p-2",
														children: (0, t.jsx)(A.A, {
															className:
																"h-3.5 w-3.5 text-[#F9A825]",
														}),
													}),
												],
											}),
													...
													(0, t.jsxs)("div", {
														...
														children: [
															...
															(0, t.jsx)("p", {
																className:
																	"dms-stat-value text-xl sm:text-2xl",
																children: e9.completed,
															}),
														],
													}),
													(0, t.jsx)("div", {
														className:
															"rounded-full bg-[#2E7D32]/10 p-2 sm:p-2",
														children: (0, t.jsx)(D.A, {
															className:
																"h-3.5 w-3.5 text-[#2E7D32]",
														}),
													}),
												],
											}),
						...
						(0, t.jsx)(o.BN, {
							...
							title: eC || "",
							subtitle: eY?.customer_name,
							badge: eY ? { label: eY.status } : void 0,
							isLoading: eG,
							contentScroll: "inner",
							onOpenInDesk: () => window.open(`/app/dms-job-card/${eC}`, "_blank"),
							children:
								eY &&
								eC &&
								(0, t.jsx)(
									c.Z,
									{
										jobCard: eY,
										onOpenFullDetails: () => {
											e_(null), e("job-card-detail", { id: eC });
										},
									},
									eC
								),
						...
						(0, t.jsx)(J.F, {
							...
							sourceJobCard: eP?.name || "",
							defaultComplaint: eP?.customer_complaint_summary,
							vehicleVin: eP?.vehicle_vin,
							company: eP?.company,
							onCreated: (a) => {
								e$(null), e("job-card-detail", { id: a });
							},
						}),
						(0, t.jsx)(V.lG, {
							open: !!eS,
							...
							children: (0, t.jsxs)(V.Cf, {
								children: [
									(0, t.jsxs)(V.c7, {
										children: [
											(0, t.jsx)(V.L3, { children: "Cancel Job Card" }),
											(0, t.jsx)(V.rr, {
												children: eS
													? `Cancel ${eS.name}? Linked parts stock transfers will be reversed. The job card is not deleted — filter status to Cancelled to find it later.`
													: null,
											}),
										],
									}),
									...
									(0, t.jsxs)(V.Es, {
										children: [
											...
											(0, t.jsxs)(m.$, {
												...
												disabled: eI,
												children: [
													(0, t.jsx)(_.A, { className: "h-4 w-4 mr-2" }),
													eI ? "Cancelling…" : "Cancel Job Card",
												],
											}),
										],
									}),
		...
		33745: (e, a, s) => {
			...
			var t = s(95155),
				...
				r = s(4474),
				i = s(91337);
			function d({ module: e, label: a, className: s, ...o }) {
			...
			function i({ onClick: e, label: a = "Add", className: s, disabled: d }) {
				return (0, t.jsx)("div", {
					...
					children: (0, t.jsxs)(l.$, {
						...
						onClick: e,
						disabled: d,
						children: [(0, t.jsx)(n.A, { className: "h-4 w-4 mr-1" }), a],
					}),
				});
			}
		},
		...
		81672: (e, a, s) => {
			s.d(a, { Ge: () => m, N0: () => o, Yq: () => i, gQ: () => c, r6: () => d });
			let t = [
					"January",
					"February",
					"March",
			...
			function r(e) {
				...
				let a = String(e).trim();
				if (!a) return null;
				let s = /^(\d{4})-(\d{1,2})-(\d{1,2})$/.exec(a);
				if (s) return new Date(Number(s[1]), Number(s[2]) - 1, Number(s[3]));
				let t = new Date(a.includes(" ") && !a.includes("T") ? a.replace(" ", "T") : a);
				return Number.isNaN(t.getTime()) ? null : t;
			}
			function i(e, a = "") {
				let s = r(e);
				return s ? `${n(s.getDate())}/${n(s.getMonth() + 1)}/${s.getFullYear()}` : a;
			}
			function d(e, a = "", s = !1) {
				let t = r(e);
				if (!t) return a;
				let l = `${n(t.getHours())}:${n(t.getMinutes())}${
					s ? `:${n(t.getSeconds())}` : ""
				}`;
				return `${i(t)} ${l}`;
			}
			function o(e, a = "") {
				let s = r(e);
				return s ? `${t[s.getMonth()]} ${s.getFullYear()}` : a;
			}
			function c(e, a = "") {
				let s = r(e);
				return s ? l[s.getDay()] : a;
			}
			function m(e, a = "") {
				let s = r(e);
				return s ? `${l[s.getDay()]}, ${i(s)}` : a;
			}
		},
		95964: (e, a, s) => {
			s.d(a, { Q: () => d });
			...
			function d({
				...
				let [x, h] = l.useState(!1),
					[p, j] = l.useState(() => i(e, s));
				return (
					l.useEffect(() => {
						x || j(i(e, s));
					}, [e, x, s]),
		...
		98883: (e, a, s) => {
			...
			function c({ className: e, children: a, side: s = "right", ...i }) {
				return (0, t.jsxs)(d, {
					children: [
						(0, t.jsx)(o, {}),
						(0, t.jsxs)(l.UC, {
								...
								children: (0, t.jsx)("div", {
									...
									children: (0, t.jsxs)("div", {
										...
										children: [
											...
											l && (0, t.jsx)(x, { className: "mt-1", children: l }),
										],
									}),
								}),
							}),
			...
			function b({ title: e, children: a, className: s }) {
				return (0, t.jsxs)("div", {
			...
			function g({ label: e, value: a, className: s }) {
				return (0, t.jsxs)("div", {
					className: (0, r.cn)(
