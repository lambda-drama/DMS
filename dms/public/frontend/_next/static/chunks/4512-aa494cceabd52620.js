	...
	[4512],
	{
		24512: (e, t, s) => {
			...
			var r = s(95155),
				...
				q = s(91337),
				S = s(37489);
			let T = [y.A, w.A, h.A, k.A];
			function I({ request: e, canApprove: t = !0, canIssue: s = !0, onUpdated: a }) {
				let [n, i] = (0, b.useState)(!1),
					[l, u] = (0, b.useState)(!1),
					[m, x] = (0, b.useState)(""),
					[p, f] = (0, b.useState)(""),
					[g, j] = (0, b.useState)(!1),
					{ completedThrough: y, current: w } = (0, S.HJ)(e.status),
					k = (0, S.Z6)(e.status),
					E = async (e, t) => {
						i(!0);
						try {
							await e(), $.o.success(t), a?.();
						} catch (e) {
							$.o.error(e instanceof Error ? e.message : "Action failed");
						} finally {
							i(!1);
						}
					};
				return "Cancelled" === e.status
					? (0, r.jsx)(d.Zp, {
							...
							children: (0, r.jsx)(d.Wu, {
								...
								children: "This request was cancelled.",
							}),
					  })
					: (0, r.jsxs)(r.Fragment, {
							children: [
								(0, r.jsx)(d.Zp, {
									className:
										"min-w-0 overflow-hidden border-primary/30 bg-primary/5",
									children: (0, r.jsxs)(d.Wu, {
											...
											(0, r.jsxs)("div", {
												...
												children: [
													...
													"Received" === e.status &&
														(0, r.jsxs)("p", {
															className:
																"text-xs text-green-700 dark:text-green-400 flex items-center gap-1",
															children: [
																(0, r.jsx)(A.A, {
								...
								(0, r.jsx)(v.lG, {
									open: l,
									onOpenChange: u,
									children: (0, r.jsxs)(v.Cf, {
										className: "sm:max-w-lg",
										children: [
											(0, r.jsxs)(v.c7, {
												children: [
													(0, r.jsxs)(v.L3, {
														children: ["Issue parts — ", e.name],
													}),
													(0, r.jsx)(v.rr, {
														children:
			...
			function E() {
				let { viewParams: e, navigate: t } = (0, n.c)(),
					{ canWrite: s } = (0, l.Sk)(),
					b = e.get("id") || "",
					{ data: v, isLoading: N, error: y, mutate: w } = (0, i.Sx)(b),
					k = s("parts-requisitions");
				return b
					? N
						? (0, r.jsx)("div", {
						...
						? (0, r.jsxs)("div", {
								...
								children: [
									(0, r.jsx)(m.A, { className: "h-12 w-12 text-destructive" }),
									(0, r.jsx)("p", {
										className: "text-lg text-muted-foreground",
										children: "Parts requisition not found",
									}),
									(0, r.jsx)(c.$, {
										variant: "outline",
										onClick: () => t("parts-requisitions"),
										children: "Back to Parts Requisition",
									}),
								],
						  })
						: (0, r.jsxs)("div", {
								...
								children: [
									(0, r.jsxs)("div", {
										...
										children: [
											...
											(0, r.jsxs)("div", {
												className:
													"flex flex-wrap items-center gap-2 pl-12 sm:pl-0",
												children: [
													(0, r.jsx)(o.E, {
														variant: "outline",
														children: v.status,
					...
					: (0, r.jsxs)("div", {
							...
							children: [
								...
								(0, r.jsx)("p", {
									className: "text-lg text-muted-foreground",
									children: "No parts requisition ID provided",
								}),
								(0, r.jsx)(c.$, {
									variant: "outline",
									onClick: () => t("parts-requisitions"),
		...
		79984: (e, t, s) => {
			s.d(t, { BT: () => c, Wu: () => d, ZB: () => l, Zp: () => n, aR: () => i });
			var r = s(95155);
			s(12115);
			var a = s(91337);
		...
		81672: (e, t, s) => {
			s.d(t, { Ge: () => u, N0: () => d, Yq: () => l, gQ: () => o, r6: () => c });
			let r = [
					"January",
					"February",
					"March",
