...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[3702],
	{
			...
			var v = "CollapsibleTrigger",
				A = a.forwardRef((e, t) => {
					...
					return (0, p.jsx)(s.sG.button, {
						...
						...a,
						ref: t,
						onClick: (0, n.mK)(e.onClick, o.onOpenToggle),
					});
				});
			A.displayName = v;
			var M = "CollapsibleContent",
				b = a.forwardRef((e, t) => {
					let { forceMount: r, ...a } = e,
						n = m(M, e.__scopeCollapsible);
					return (0, p.jsx)(u.C, {
						present: r || n.open,
						children: ({ present: e }) => (0, p.jsx)(w, { ...a, ref: t, present: e }),
					});
				});
			b.displayName = M;
			var w = a.forwardRef((e, t) => {
				let { __scopeCollapsible: r, present: n, children: o, ...i } = e,
					u = m(M, r),
					[c, h] = a.useState(n),
					y = a.useRef(null),
					f = (0, d.s)(t, y),
					...
					let { mutate: o } = (0, n.iX)(),
						...
						k = (0, a.useCallback)(async (e, t) => {
							...
							try {
								...
								return (
									c.current <= p &&
										(l(() => y({ data: t, isMutating: !1, error: void 0 })),
						...
						m = (0, a.useCallback)(() => {
							(c.current = (0, i.o)()), y({ data: i.U, error: i.U, isMutating: !1 });
						}, []);
					return (
						(0, i.u)(() => {
							(d.current = e), (s.current = t), (u.current = r);
						}),
						{
							trigger: k,
							reset: m,
		...
		67514: (e, t, r) => {
			r.d(t, { A: () => a });
			let a = (0, r(90425).A)("trending-down", [
