			...
			var n = r(12115),
				...
				R = n.forwardRef((e, t) =>
					(0, v.jsx)(y.Provider, {
						...
						children: (0, v.jsx)(y.Slot, {
							scope: e.__scopeRovingFocusGroup,
							children: (0, v.jsx)(j, { ...e, ref: t }),
						}),
					})
				);
			R.displayName = h;
			var j = n.forwardRef((e, t) => {
					...
					return (
						n.useEffect(() => {
							let e = j.current;
							if (e)
								return e.addEventListener(p, G), () => e.removeEventListener(p, G);
						}, [G]),
						(0, v.jsx)(A, {
							scope: r,
							orientation: o,
					...
					return (
						...
						(0, v.jsx)(y.ItemSlot, {
							...
							children: (0, v.jsx)(u.sG.span, {
								...
								onFocus: (0, a.mK)(e.onFocus, () => m.onItemFocus(p)),
								onKeyDown: (0, a.mK)(e.onKeyDown, (e) => {
								...
								children:
									"function" == typeof c
										? c({ isCurrentTabStop: h, hasTabStop: null != A })
										: c,
							}),
						})
					);
