				...
				l = (0, n.Ht)(i.Ay, () => (e, r, t = {}) => {
					let { mutate: i } = (0, n.iX)(),
						...
						h = (0, a.useCallback)(async (e, r) => {
							...
							let n = (0, o.m)(
									(0, o.m)({ populateCache: !1, throwOnError: !0 }, c.current),
									r
								),
								f = (0, o.o)();
						...
						g = (0, a.useCallback)(() => {
							(d.current = (0, o.o)()), p({ data: o.U, error: o.U, isMutating: !1 });
						}, []);
					return (
						(0, o.u)(() => {
							(l.current = e), (s.current = r), (c.current = t);
						}),
						{
							trigger: h,
							reset: g,
							get data() {
								return (m.data = !0), v.data;
							},
							get error() {
								return (m.error = !0), v.error;
							},
							get isMutating() {
								return (m.isMutating = !0), v.isMutating;
							},
						}
					);
				});
		...
		84375: (e, r, t) => {
			...
			var d = "Avatar",
				[f, m] = (function (e, r = []) {
					let t = [],
						i = () => {
							let r = t.map((e) => a.createContext(e));
							return function (t) {
								let n = t?.[e] || r;
								return a.useMemo(
									() => ({ [`__scope${e}`]: { ...t, [e]: n } }),
					...
					return (
						...
						[
							function (r, i) {
								...
								t = [...t, i];
								let l = (r) => {
									let { scope: t, children: i, ...l } = r,
										s = t?.[e]?.[u] || o,
										c = a.useMemo(() => l, Object.values(l));
									return (0, n.jsx)(s.Provider, { value: c, children: i });
								};
								return (
							...
							(function (...e) {
								...
								let t = () => {
									...
									return function (e) {
										let n = t.reduce((r, { useScope: t, scopeName: a }) => {
											let n = t(e)[`__scope${a}`];
											return { ...r, ...n };
										}, {});
										return a.useMemo(
				...
				[p, v] = f(d),
				h = a.forwardRef((e, r) => {
					let { __scopeAvatar: t, ...i } = e,
						[o, u] = a.useState("idle");
					return (0, n.jsx)(p, {
						scope: t,
						imageLoadingStatus: o,
						onImageLoadingStatusChange: u,
						children: (0, n.jsx)(l.span, { ...i, ref: r }),
					});
				});
			h.displayName = d;
			var g = "AvatarImage",
				y = a.forwardRef((e, r) => {
					let {
						...
						m = v(g, t),
						p = (function (e, { referrerPolicy: r, crossOrigin: t }) {
							...
							return (
								...
								(0, o.N)(() => {
									...
									return (
										...
										r && (u.referrerPolicy = r),
										"string" == typeof t && (u.crossOrigin = t),
										() => {
											u.removeEventListener("load", a),
												u.removeEventListener("error", n);
										}
									);
								}, [u, t, r]),
								l
					...
					return (
						...
						"loaded" === p ? (0, n.jsx)(l.img, { ...f, ref: r, src: u }) : null
					);
				});
			y.displayName = g;
			var w = "AvatarFallback",
				k = a.forwardRef((e, r) => {
					let { __scopeAvatar: t, delayMs: i, ...o } = e,
						u = v(w, t),
						[s, c] = a.useState(void 0 === i);
					return (
						a.useEffect(() => {
							if (void 0 !== i) {
