	...
	[4823],
	{
		15306: (e, s, t) => {
			...
			function n({ className: e, ...s }) {
				return (0, r.jsx)(a.bL, {
					"data-slot": "tabs",
					className: (0, d.cn)("flex flex-col gap-2", e),
					...s,
				});
			}
			...
			function c({ className: e, ...s }) {
				return (0, r.jsx)(a.UC, {
					...
					className: (0, d.cn)("outline-none data-[state=inactive]:hidden", e),
					...s,
				});
			}
		},
		...
		38291: (e, s, t) => {
			...
			function l({ className: e, variant: s, asChild: t = !1, ...d }) {
				let c = t ? a.DX : "span";
				return (0, r.jsx)(c, {
					"data-slot": "badge",
					className: (0, n.cn)(i({ variant: s }), e),
					...d,
				});
			}
		},
		...
		54823: (e, s, t) => {
			...
			function v() {
				let { navigate: e } = (0, i.c)(),
					[s, t] = (0, a.useState)(""),
					[v, b] = (0, a.useState)("all"),
					[N, y] = (0, a.useState)(""),
					[_, S] = (0, a.useState)(!1),
					{ error: w, success: k, showError: C, showSuccess: R, clear: A } = (0, p.B)(),
					[D, E] = (0, a.useState)({
						adjusted_due_date: "",
						adjusted_due_km: "",
						adjustment_reason: "",
					}),
					{
						...
						isLoading: q,
						mutate: V,
					} = (0, d.Ay)(["crm-service-due", s, v], () =>
						(0, n.M8)({
							search: s || void 0,
							classification: "all" === v ? void 0 : v,
							limit: 50,
						})
					),
					{ data: Z } = (0, d.Ay)("crm-retention-settings", n.GR),
					{ data: O, mutate: L } = (0, d.Ay)("crm-deferred-work", () =>
						(0, n.P0)({ status: "Open", limit: 50 })
					),
					{ data: $, mutate: z } = (0, d.Ay)(
						N ? ["crm-service-due-detail", N] : null,
						() => (0, n.Xp)(N)
					),
					B = M?.data || [],
					U = M?.summary || {},
					W = O?.data || [],
					X = Z?.service_reminder_sequence || [],
					I = async () => {
						A(), S(!0);
						try {
							let e = await (0, n.xc)(300);
							await V(), R(`Synced ${e?.synced ?? 0} service-due records.`);
						} catch (e) {
							C(e, "Sync failed");
						} finally {
							S(!1);
					...
					T = async () => {
						A(), S(!0);
						try {
							let e = await (0, n.xo)(300);
							await V(),
								N && (await z()),
								R(`Created ${e?.created ?? 0} reminders.`);
						} catch (e) {
							C(e, "Reminder run failed");
						} finally {
							S(!1);
						}
					},
					F = async () => {
						if (N) {
							if ((A(), !D.adjustment_reason.trim()))
								return void C("Adjustment reason is required.");
							S(!0);
							try {
								await (0, n.Dl)(N, {
									adjusted_due_date: D.adjusted_due_date || null,
									adjusted_due_km: D.adjusted_due_km
										? Number(D.adjusted_due_km)
										: null,
									adjustment_reason: D.adjustment_reason,
								}),
									await z(),
									await V(),
									R("Due date adjusted (audit trail saved).");
							} catch (e) {
								C(e, "Adjustment failed");
							} finally {
								S(!1);
							}
						}
				...
				return (0, r.jsxs)("div", {
					className: "space-y-4",
					children: [
						(0, r.jsx)(p.y, { error: w, success: k, onDismiss: A }),
						(0, r.jsxs)("div", {
							...
							children: [
								(0, r.jsx)("p", {
									...
									children:
										"Aftersales lifecycle \xb7 service due engine \xb7 reminder sequence from DMS CRM Settings",
								}),
								(0, r.jsxs)("div", {
									...
									children: [
										...
										(0, r.jsx)(l.$, {
											disabled: _,
											onClick: () => void T(),
											children: "Run reminder sequence",
										}),
									],
								}),
							],
						...
						(0, r.jsx)("div", {
							className:
								"grid gap-3 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-9",
							children: [
								"Upcoming",
								"Due",
								"Overdue",
													...
													children: [
														(0, r.jsx)(o.aR, {
															children: (0, r.jsxs)(o.ZB, {
																className: "text-base",
																children: [
																	String($.vin_number || $.vin),
																	" \xb7 adjust / reminders",
																],
															}),
														}),
														(0, r.jsxs)(o.Wu, {
													...
													children: (0, r.jsxs)(o.Wu, {
														...
														children: [
															(0, r.jsx)("p", {
																className:
																	"text-xs text-muted-foreground",
																children: "Open pipeline value",
															}),
															(0, r.jsx)("p", {
																className:
																	"text-2xl font-semibold",
																children: Number(
																	O?.open_pipeline_value || 0
																).toLocaleString(),
															}),
														],
													}),
											...
											children: [
												(0, r.jsx)(o.aR, {
													children: (0, r.jsx)(o.ZB, {
														className: "text-base",
														children: "Recommended / deferred work",
													}),
												}),
												(0, r.jsx)(o.Wu, {
									...
									children: (0, r.jsxs)(o.Zp, {
										...
										children: [
											(0, r.jsx)(o.aR, {
												children: (0, r.jsx)(o.ZB, {
													className: "text-base",
													children: "Configured reminder sequence",
												}),
											}),
											(0, r.jsxs)(o.Wu, {
												className: "space-y-2",
												children: [
													(0, r.jsx)("p", {
														className: "text-sm text-muted-foreground",
														children:
															"Edit offsets and channels in Desk → DMS CRM Settings → Service Reminder Sequence. Service intervals still come from VIN / Vehicle Model (and DMS warranty settings).",
													}),
													0 === X.length
														? (0, r.jsx)("p", {
																className:
		...
		93108: (e, s, t) => {
			...
			function o() {
				let [e, s] = (0, a.useState)(""),
					[t, r] = (0, a.useState)(""),
					n = (0, a.useCallback)((e, t = "Something went wrong.") => {
						let a =
				...
				return {
					...
					success: t,
					showError: n,
					showSuccess: (0, a.useCallback)((e) => {
						s(""), r(e), d.o.success(e);
					}, []),
					clear: (0, a.useCallback)(() => {
						s(""), r("");
					}, []),
				};
			}
			function u({ error: e, success: s, onDismiss: t, className: a }) {
				if (!e && !s) return null;
				let d = !!e;
				return (0, r.jsx)("div", {
					className: (0, c.cn)("sticky top-0 z-40 -mx-1 px-1 pt-1", a),
					children: (0, r.jsxs)("div", {
						role: d ? "alert" : "status",
