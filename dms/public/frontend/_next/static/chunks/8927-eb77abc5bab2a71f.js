	...
	[8927],
	{
		...
		18927: (e, s, t) => {
			...
			var a = t(95155),
				...
				j = t(21628),
				f = t(91337);
			function y({ value: e, max: s }) {
				let t = s > 0 ? Math.min(100, Math.round((e / s) * 100)) : 0;
				return (0, a.jsxs)("div", {
					className: "relative mx-auto flex h-36 w-56 items-end justify-center",
					children: [
						(0, a.jsxs)("svg", {
							viewBox: "0 0 200 120",
							...
							children: [
								...
								(0, a.jsx)("path", {
									...
									strokeWidth: "16",
									strokeLinecap: "round",
									strokeDasharray: `${(((t / 100) * 180) / 180) * 251} 251`,
								}),
								(0, a.jsx)("defs", {
			...
			function v({ stages: e }) {
				let s = Math.max(1, ...e.map((e) => e.count));
				return (0, a.jsx)("div", {
					className: "space-y-3",
					children: e.map((e) =>
						(0, a.jsxs)(
			...
			function b() {
				let { navigate: e } = (0, l.c)(),
					{ user: s } = (0, i.A)(),
					{
						...
						isLoading: b,
						error: N,
					} = (0, r.Ay)("crm-dashboard", n.b_, { revalidateOnFocus: !0 }),
					k = t?.stats,
					_ = (s?.full_name || t?.user?.full_name || "there").split(" ")[0];
				if (b)
					return (0, a.jsxs)("div", {
						className: "space-y-4",
						children: [
							(0, a.jsx)(d.E, { className: "h-10 w-64" }),
							(0, a.jsxs)("div", {
								className: "grid gap-4 md:grid-cols-2",
								children: [
									(0, a.jsx)(d.E, { className: "h-56" }),
									(0, a.jsx)(d.E, { className: "h-56" }),
								],
							}),
							(0, a.jsxs)("div", {
					...
					children: [
						...
						(0, a.jsxs)("div", {
							...
							children: [
								(0, a.jsxs)(o.Zp, {
									className:
										"cursor-pointer overflow-hidden border-border/70 shadow-sm transition-colors hover:bg-muted/30",
									role: "link",
									tabIndex: 0,
									onClick: () => e("crm-leads"),
									onKeyDown: (s) => {
										("Enter" === s.key || " " === s.key) &&
											(s.preventDefault(), e("crm-leads"));
									},
									children: [
										(0, a.jsx)(o.aR, {
											className: "pb-2",
											children: (0, a.jsx)(o.ZB, {
												...
												children: "Lead Target",
											}),
										}),
										(0, a.jsxs)(o.Wu, {
											children: [
												(0, a.jsx)(y, {
													value: k?.leads_this_month ?? 0,
													max:
														k?.lead_target ??
														Math.max(k?.leads_this_month ?? 1, 1),
												}),
												(0, a.jsx)("p", {
													className:
														"mt-2 text-center text-sm text-muted-foreground",
													children: k?.lead_target_configured
														? (0, a.jsxs)(a.Fragment, {
																children: [
																	"Remaining",
																	" ",
														...
														: (0, a.jsxs)(a.Fragment, {
																children: [
																	...
																	(0, a.jsx)("span", {
																		...
																		children:
																			"Set Monthly Lead Target in DMS CRM Settings",
																	}),
																],
														  }),
												}),
								...
								(0, a.jsxs)(o.Zp, {
									className:
										"cursor-pointer border-border/70 shadow-sm transition-colors hover:bg-muted/30",
									role: "link",
									tabIndex: 0,
									onClick: () => e("crm-opportunities"),
									onKeyDown: (s) => {
										("Enter" === s.key || " " === s.key) &&
											(s.preventDefault(), e("crm-opportunities"));
									},
									children: [
										(0, a.jsxs)(o.aR, {
											className:
										...
										(0, a.jsxs)(o.Wu, {
											children: [
												(0, a.jsx)(v, { stages: t?.stage_pipeline || [] }),
												(0, a.jsxs)("div", {
													className:
														"mt-4 rounded-lg bg-primary/5 px-3 py-2 text-sm",
													children: [
														"Weighted pipeline",
														" ",
														(0, a.jsx)("span", {
										...
										(0, a.jsxs)(o.aR, {
											...
											children: [
												...
												(0, a.jsxs)(c.$, {
													...
													onClick: () =>
														e("crm-reports", {
															section: "crm_executive",
															report: "crm_appendix_b_kpis",
														}),
													children: [
														"Formulas ",
														(0, a.jsx)(j.A, {
								...
								(0, a.jsxs)(o.aR, {
									...
									children: [
										...
										(0, a.jsxs)(c.$, {
											...
											children: [
												"View all ",
												(0, a.jsx)(j.A, { className: "h-3.5 w-3.5" }),
											],
										}),
									],
								}),
																			...
																			children: [
																				...
																				(0, a.jsx)("td", {
																					...
																					a.jsx)(
																						...
																						{
																							className:
																								"inline-flex rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-foreground",
																							children:
																								s.status,
																						}
																					),
						...
						(0, a.jsx)("div", {
							...
							children: A.map((s) =>
								(0, a.jsx)(
									...
									{
										className:
											"cursor-pointer border-border shadow-sm transition-colors hover:bg-muted/30",
										role: "link",
										tabIndex: 0,
										onClick: () => e(s.view),
										onKeyDown: (t) => {
