...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5079],
	{
		5240: (e, t, i) => {
			function r(e, t, i) {
				return new Promise((r, n) => {
					e.toBlob((e) => (e ? r(e) : n(Error("Image compression failed"))), t, i);
				});
			}
			async function n(e, t, i, n) {
				let { width: a, height: s } = (function (e, t, i) {
						let r = Math.max(e, t);
						if (r <= i) return { width: e, height: t };
						let n = i / r;
						return {
							width: Math.max(1, Math.round(e * n)),
				...
				return (c.drawImage(e, 0, 0, a, s), n) ? r(o, "image/png") : r(o, "image/jpeg", i);
			}
			async function a(e, t) {
				if (!e.type.startsWith("image/")) return e;
				let i = t?.skipBelowBytes ?? 4e5;
				if (e.size <= i) return e;
				let r = t?.targetMaxBytes ?? 14e5,
					a = "image/png" === e.type;
				try {
					let i = await new Promise((t, i) => {
							let r = URL.createObjectURL(e),
								n = new Image();
							(n.onload = () => {
								URL.revokeObjectURL(r), t(n);
							}),
								(n.onerror = () => {
									URL.revokeObjectURL(r), i(Error("Could not read image"));
								}),
								(n.src = r);
						}),
						s = [
						...
						o = null;
					for (let e of s)
						if ((o = await n(i, e.maxSide, e.quality, a)).size <= r) break;
					if (!o || (o.size >= e.size && e.size <= r)) return e;
					let c = a ? ".png" : ".jpg",
						l = a ? "image/png" : "image/jpeg",
						u = (e.name.replace(/\.[^.]+$/, "") || "image").slice(0, 120);
					return new File([o], `${u}${c}`, { type: l, lastModified: Date.now() });
				} catch {
					return e;
				}
			}
			...
			function c(e) {
				let t = String(e?.oem_part_number || e?.item_code || e?.name || "").trim(),
					i = String(e?.item_name || e?.name || t).trim();
				return t && i && t !== i ? `${t}: ${i}` : i || t;
			}
			function l(e) {
				var t;
				let i = [],
					r = String(e?.item_code || e?.spare_part_item || "").trim();
				return (
					r && r !== e?.name && i.push(r),
					e?.part_category && i.push(e.part_category),
					e?.bin_location && i.push(`Bin: ${e.bin_location}`),
			...
			function d(e) {
				let t = String(e?.custom_service_code || "").trim(),
					i = String(e?.custom_item_name || e?.service_item || e?.name || t).trim();
				return t && i && t !== i ? `${t}: ${i}` : i || t;
			}
			function m(e) {
			...
			async function f(e, t, i) {
				return (0, s.AT)(`/api/method/${o}.get_customers`, {
					method: "POST",
					body: JSON.stringify({ search: e || null, limit: t || 50, offset: i || 0 }),
				});
			}
			async function y(e) {
			...
			async function S(e, t, i) {
				return (0, s.AT)(`/api/method/${o}.get_vehicle_models`, {
					method: "POST",
					body: JSON.stringify({ search: e || null, brand: t || null, limit: i ?? 30 }),
				});
			}
			...
			async function P(e, t, i, r, n, a) {
				return (0, s.AT)(`/api/method/${o}.get_spare_parts`, {
					...
					body: JSON.stringify({
						...
						warehouse: t || null,
						company: i || null,
						vehicle_model: r || null,
						vin: n || null,
						vehicle_brand: a || null,
					}),
				});
			}
			async function k(e, t, i, r = 50) {
			...
			async function U(e) {
				let t = await (0, s.AT)(`/api/method/${o}.get_spare_part_price`, {
					...
					i = "number" == typeof t ? t : parseFloat(String(t ?? ""));
			...
			async function R(e) {
				...
				let t = q.get(e);
				if (t) return t;
				let i = await (0, s.AT)(`/api/method/${o}.get_print_formats`, {
						method: "POST",
						body: JSON.stringify({ doctype: e }),
					}),
					r = Array.isArray(i) && i.length ? i : ["Standard"];
				return q.set(e, r), r;
			}
			async function I(e) {
				let t = await a(e);
				await (0, s.bd)();
				let i = window.csrf_token,
					r = new FormData();
				r.append("file", t),
					r.append("is_private", "0"),
					r.append("folder", "Home/Attachments"),
					i && r.append("csrf_token", i);
				let n = window.location.origin,
					o = await fetch(`${n}/api/method/upload_file`, {
						method: "POST",
						headers: i ? { "X-Frappe-CSRF-Token": i } : {},
						body: r,
						credentials: "include",
					}),
		...
		25261: (e, t, i) => {
			...
			function s(e, t) {
				return !t || null == e || e.includes(t);
			}
		},
		47277: (e, t, i) => {
			i.d(t, { A: () => c, AuthProvider: () => o });
			var r = i(95155),
				n = i(12115),
				a = i(70931);
			let s = (0, n.createContext)(void 0);
			function o({ children: e }) {
				let [t, i] = (0, n.useState)(null),
					[c, l] = (0, n.useState)(!0),
		...
		63360: (e, t, i) => {
			...
			var r = i(95155),
				...
				o = i(49876);
			async function c() {
				return (0, o.AT)("/api/method/dms.api.permissions.get_dms_ui_permissions", {
					method: "POST",
					body: JSON.stringify({}),
				});
			}
			...
			function d({ children: e }) {
				let { isAuthenticated: t, user: i } = (0, s.A)(),
					{ data: o, isLoading: m } = (0, a.Ay)(
						t ? ["dms-ui-permissions", i?.name] : null,
						() => c(),
						{ revalidateOnFocus: !0, dedupingInterval: 6e4 }
					),
					p = o ?? {},
					h = (0, n.useCallback)((e) => p[e], [p]),
					f = (0, n.useCallback)(
						(e) => {
							let t = (0, l.q0)(e);
							if (!t) return !0;
					...
					y = (0, n.useCallback)(
						(e) => !!f("reports") && (0, l.aw)(p.reports?.allowed_sections, e),
						[f, p.reports?.allowed_sections]
					),
					_ = (0, n.useCallback)(
						(e) => {
							let t = p[e];
							return "dashboard" === e ||
								"reports" === e ||
								"settings" === e ||
								"advanced-permissions" === e ||
								"users" === e
								? (0, l.vN)(t?.visible)
								: (0, l.vN)(t?.read) || (0, l.vN)(t?.select);
						},
						[p]
					),
					g = (0, n.useCallback)((e) => (0, l.vN)(p[e]?.create), [p]),
					v = (0, n.useCallback)((e) => (0, l.vN)(p[e]?.write), [p]),
					b = (0, n.useCallback)((e) => (0, l.vN)(p[e]?.submit), [p]),
					w = (0, n.useCallback)((e) => (0, l.vN)(p[e]?.cancel), [p]),
					S = (0, n.useCallback)((e) => (0, l.vN)(p[e]?.delete), [p]),
					O = (0, l.vN)(p.can_edit_price?.write) || (0, l.vN)(p.can_edit_price?.visible),
					T = (0, n.useMemo)(
						() => ({
							permissions: p,
							isLoading: t && m,
							canAccessView: f,
							canAccessReportSection: y,
							canRead: _,
							canCreate: g,
							canWrite: v,
							canSubmit: b,
		...
		70931: (e, t, i) => {
			...
			var r = i(49876);
			let n = i(41463).env.NEXT_PUBLIC_FRAPPE_URL || "";
			async function a(e, t) {
				(0, r.w$)();
				let i = await fetch(`${n}/api/method/login`, {
					method: "POST",
					headers: { "Content-Type": "application/json", Accept: "application/json" },
					body: JSON.stringify({ usr: e, pwd: t }),
					credentials: "include",
				});
				if (!i.ok)
					throw Error(
						(await i.json().catch(() => ({}))).message || "Invalid credentials"
					);
				return (0, r.w$)(), await (0, r.bd)(!0), c();
			}
			async function s() {
				try {
					await (0, r.AT)("/api/method/logout", { method: "POST" });
				} catch {}
				(0, r.w$)();
			}
			async function o() {
				try {
					let e = await fetch(`${n}/api/method/frappe.auth.get_logged_user`, {
						credentials: "include",
			...
			async function c() {
				...
				let t = await fetch(
					`${n}/api/resource/User/${encodeURIComponent(
						e
					)}?fields=["name","full_name","email","user_image"]`,
					{ credentials: "include", headers: { Accept: "application/json" } }
				);
				if (!t.ok) throw Error("Failed to fetch user profile");
				let i = (await t.json()).data,
					r = [];
				try {
					let t = await fetch(
						`${n}/api/resource/Has Role?filters=[["parent","=","${e}"]]&fields=["role"]&limit_page_length=0`,
						{ credentials: "include", headers: { Accept: "application/json" } }
					);
					t.ok && (r = ((await t.json()).data || []).map((e) => e.role));
				} catch {}
				return {
					name: i.name,
					full_name: i.full_name || e,
					email: i.email || e,
					user_image: i.user_image || void 0,
					roles: r,
				};
			}
			async function l(e) {
				let t = await o();
				if (!t) throw Error("Not logged in");
				await (0, r.AT)(`/api/resource/User/${encodeURIComponent(t)}`, {
					method: "PUT",
					body: JSON.stringify(e),
				});
			}
			async function u(e, t) {
				await (0, r.AT)("/api/method/dms.api.users.change_password", {
					method: "POST",
					body: JSON.stringify({
						old_password: e,
						new_password: t,
