(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[1569, 6314],
	{
		...
		21569: (e, r, t) => {
			...
			function v() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, n.useState)(""),
					{ data: v, isLoading: h } = (0, s.Ay)(["crm-accounts", r], () =>
						(0, a.B)({ search: r || void 0, limit: 50 })
					),
					g = v?.data || [];
				return (0, i.jsxs)("div", {
					className: "space-y-4",
					children: [
						(0, i.jsx)("div", {
							...
							children: (0, i.jsxs)(o.$, {
								onClick: () => e("crm-account-new"),
								children: [
									(0, i.jsx)(p.A, { className: "mr-2 h-4 w-4" }),
									"New Account",
								],
							}),
						}),
		...
		32012: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 21569));
		},
		38291: (e, r, t) => {
			"use strict";
			t.d(r, { E: () => o });
			...
			function d(e) {
				...
				let t,
									...
									l = (function (e, r) {
										...
										for (let i in r) {
											...
											/^on[A-Z]/.test(i)
												...
												? (t[i] = { ...n, ...s })
												: "className" === i &&
												  (t[i] = [n, s].filter(Boolean).join(" "));
										}
										return { ...e, ...t };
									})(i, t.props);
								return (
									t.type !== n.Fragment && (l.ref = r ? (0, s.t)(r, o) : o),
									n.cloneElement(t, l)
								);
							}
					...
					c = n.forwardRef((e, r) => {
						...
						return (0, a.jsx)(i, { ...s, ref: r, children: t });
					});
			...
			async function l(e, r = {}) {
				...
				if (
					(!d.ok &&
						...
						(a(), ({ response: d, resData: m } = await n(!0))),
					!d.ok)
				)
					throw Error(
						(function (e) {
		...
		90425: (e, r, t) => {
			...
			let c = (0, i.forwardRef)(
				...
				o = (e, r) => {
					let t = (0, i.forwardRef)(({ className: t, ...a }, o) =>
						(0, i.createElement)(c, {
							ref: o,
							iconNode: r,
							className: n(
	...
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 32012))), (_N_E = e.O());
	},
]);
