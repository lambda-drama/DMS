(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[3988, 4239],
	{
		...
		63988: (e, r, t) => {
			...
			function p() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, i.useState)(""),
					{ data: p, isLoading: f } = (0, s.Ay)(["crm-vehicles", r], () =>
						(0, a.ix)({ search: r || void 0, limit: 50 })
					),
					v = p?.data || [];
				return (0, n.jsx)("div", {
					className: "space-y-4",
		...
		84831: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 63988));
		},
		90425: (e, r, t) => {
			"use strict";
			t.d(r, { A: () => o });
	...
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 84831))), (_N_E = e.O());
	},
]);
