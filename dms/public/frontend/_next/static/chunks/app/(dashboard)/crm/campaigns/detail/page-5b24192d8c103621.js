(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	...
	{
		445: (e, r, s) => {
			Promise.resolve().then(s.bind(s, 66668));
		},
		15181: (e, r, s) => {
			"use strict";
			function c(e) {
		...
		55833: (e, r, s) => {
			"use strict";
			s.d(r, { NavigationProvider: () => l, c: () => d, g: () => o });
			var c = s(95155),
				i = s(12115),
				t = s(15181);
			let a = [
			...
			function l({ children: e }) {
				let [r, s] = (0, i.useState)("dashboard"),
					[o, d] = (0, i.useState)(new URLSearchParams()),
					p = (0, i.useCallback)((e, r) => {
						let c = r && Object.keys(r).length > 0 ? r : void 0,
							i = `#${e}`;
						c && (i += `?${new URLSearchParams(c).toString()}`),
							s(e),
							d(new URLSearchParams(c || {})),
							(window.location.hash = i),
							(0, t.i)(),
							requestAnimationFrame(() => (0, t.i)());
					}, []);
				return (
					(0, i.useEffect)(() => {
						let e = () => {
	...
	(e) => {
		e.O(0, [8409, 4855, 6609, 357, 8103, 2372, 6668, 8441, 3794, 7358], () => e((e.s = 445))),
			(_N_E = e.O());
	},
]);
