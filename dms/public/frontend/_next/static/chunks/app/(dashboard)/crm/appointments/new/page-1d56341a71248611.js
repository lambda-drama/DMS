	...
	[7880, 8653],
	{
		...
		42074: (e, t, a) => {
			...
			var s = a(95155),
				...
				i = a(47650),
				n = a(91337);
			function c({ children: e, className: t, align: a = "end" }) {
				let [o, l] = (0, r.useState)(!1);
				(0, r.useEffect)(() => (l(!0), () => l(!1)), []);
				let m = (0, s.jsx)("div", {
					role: "toolbar",
				...
				return o ? (0, i.createPortal)(m, document.body) : null;
			}
		},
		51914: (e, t, a) => {
			"use strict";
		...
		54203: (e, t, a) => {
			Promise.resolve().then(a.bind(a, 93602));
		},
		55833: (e, t, a) => {
			"use strict";
			a.d(t, { NavigationProvider: () => m, c: () => d, g: () => o });
			var s = a(95155),
				r = a(12115),
				i = a(15181);
			let n = [
			...
			function m({ children: e }) {
				let [t, a] = (0, r.useState)("dashboard"),
					[o, d] = (0, r.useState)(new URLSearchParams()),
					...
					children: [
						...
						(0, s.jsxs)(r.UC, {
							...
							onPointerDownOutside: (e) => {
								(0, c.JM)(e.target) ? e.preventDefault() : p?.(e);
							},
							onInteractOutside: (e) => {
								(0, c.JM)(e.target) ? e.preventDefault() : u?.(e);
							},
							onFocusOutside: (e) => {
								(0, c.JM)(e.target) ? e.preventDefault() : v?.(e);
							},
							...g,
							children: [
								t,
		...
		93602: (e, t, a) => {
			...
			var s = a(95155),
				...
				h = a(6296);
			function f() {
				let { navigate: e, viewParams: t } = (0, c.c)(),
					a = t.get("customer") || "",
					f = t.get("opportunity") || "",
					{ data: x } = (0, i.Ay)("crm-sales-appointment-form-options", n.AW),
					[b, y] = (0, r.useState)(""),
					{ data: w } = (0, i.Ay)(["crm-appt-deals", b], () =>
						(0, n.wA)({ search: b || void 0, status: "Open", limit: 50 })
					),
					[j, k] = (0, r.useState)(!1),
					{ error: N, success: _, showError: S, clear: A } = (0, g.B)(),
					[C, q] = (0, r.useState)({
						customer: a,
						opportunity: f,
				...
				(0, r.useEffect)(() => {
					x &&
						q((e) => ({
							...e,
							company:
								e.company || String(x.default_company || x.companies?.[0] || ""),
							appointment_type:
								e.appointment_type ||
								String(x.appointment_types?.[0] || "Showroom Appointment"),
						}));
				}, [x]),
					(0, r.useEffect)(() => {
						C.opportunity &&
							(0, n.Oe)(C.opportunity)
								.then((e) => {
									q((t) => ({
										...t,
				...
				let P = (e, t) => q((a) => ({ ...a, [e]: t })),
					L = (x?.appointment_types || []).map((e) => ({ value: e, label: e })),
					D = (x?.companies || []).map((e) => ({ value: e, label: e })),
					E = (x?.branches || []).map((e) => ({ value: e, label: e })),
					M = x?.users || [],
					z = (0, r.useMemo)(
						() =>
							(w?.data || []).map((e) => ({
					...
					O = async () => {
						if ((A(), !C.customer)) return void S("Select a customer.");
						if (!C.appointment_datetime)
				...
				return (0, s.jsxs)("div", {
					...
					children: [
						(0, s.jsx)(g.y, { error: N, success: _, onDismiss: A }),
						(0, s.jsxs)(m.Zp, {
									...
									children: [
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(v.Zi, {
													options: z,
													value: C.opportunity,
													onValueChange: (e) => P("opportunity", e),
													onSearchChange: y,
													placeholder:
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													type: "datetime-local",
													value: C.appointment_datetime,
													onChange: (e) =>
														P("appointment_datetime", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													...
													onChange: (e) =>
														P("duration_minutes", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(v.Zi, {
													options: L,
													value: C.appointment_type,
													onValueChange: (e) => P("appointment_type", e),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(v.Zi, {
													options: M,
													value: C.assigned_to,
													onValueChange: (e) => P("assigned_to", e),
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(p.T, {
													rows: 3,
													value: C.agenda,
													onChange: (e) => P("agenda", e.target.value),
													placeholder:
