(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[2665, 7996],
	{
		...
		7996: (e, r, t) => {
			...
			function v() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, n.useState)(""),
					{ data: v, isLoading: g } = (0, s.Ay)(["crm-tenders", r], () =>
						(0, a.sX)({ search: r || void 0, limit: 50 })
					),
					h = v?.data || [];
				return (0, i.jsxs)("div", {
					className: "space-y-4",
		...
		41781: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 7996));
		},
		42442: (e, r, t) => {
			"use strict";
			t.d(r, { DX: () => m, TL: () => d });
	...
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 41781))), (_N_E = e.O());
	},
]);
