(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6172, 7689],
	{
		...
		1650: (e, t, r) => {
			Promise.resolve().then(r.bind(r, 57689));
		},
		33210: (e, t, r) => {
			"use strict";
			r.d(t, { A: () => a });
		...
		38291: (e, t, r) => {
			...
			function d({ className: e, variant: t, asChild: r = !1, ...i }) {
				let c = r ? s.DX : "span";
				return (0, a.jsx)(c, {
					"data-slot": "badge",
		...
		47279: (e, t, r) => {
			...
			function x(e) {
				let {
					...
					[g, x] = (0, o.i)({ prop: r, defaultProp: i ?? !1, onChange: l, caller: f }),
					[y, b] = a.useState(null),
					[_, j] = a.useState(null),
					N = a.useRef(!1),
					T = !y || !!d || !!y.closest("form"),
					S = {
						checked: g,
						disabled: n,
						setChecked: x,
				...
				return (0, m.jsx)(v, {
					scope: t,
					...S,
					children: "function" == typeof p ? p(S) : s,
				});
			}
			var y = "CheckboxTrigger",
				b = a.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...i }, o) => {
					let {
							control: d,
							value: c,
							disabled: l,
			...
			var _ = a.forwardRef((e, t) => {
				...
				return (0, m.jsx)(x, {
					...
					internal_do_not_use_render: ({ isFormControl: e }) =>
						(0, m.jsxs)(m.Fragment, {
							children: [
								(0, m.jsx)(b, { ...u, ref: t, __scopeCheckbox: r }),
								e && (0, m.jsx)(S, { __scopeCheckbox: r }),
							],
						}),
				});
			});
			...
			var j = "CheckboxIndicator",
				N = a.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: a, ...s } = e,
						i = g(j, r);
					return (0, m.jsx)(l.C, {
						present: a || k(i.checked) || !0 === i.checked,
				...
				S = a.forwardRef(({ __scopeCheckbox: e, ...t }, r) => {
					...
					a.useEffect(() => {
						...
						if (j !== o && e) {
							...
							(y.indeterminate = k(o)), e.call(y, !k(o) && o), y.dispatchEvent(r);
						}
					}, [y, j, o, n]);
					let S = a.useRef(!k(o) && o);
		...
		57689: (e, t, r) => {
			...
			function T() {
				let [e, t] = (0, s.useState)(""),
					...
					[$, M] = (0, s.useState)(null);
				(0, s.useEffect)(() => {
					let t = window.setTimeout(() => T(e.trim()), 250);
				...
				let {
						...
						isLoading: z,
						mutate: L,
					} = (0, i.Ay)(["job-card-terms-master", r], () =>
						_.rv({ search: r || void 0, limit: 100, offset: 0 })
					),
					D = E?.data || [];
				async function R() {
					...
					try {
						w && A.name
							? (await _.qS(A.name, {
							  ...
							  n.o.success("Job Card Terms updated"))
							: (await _.PJ({
									title: A.title.trim(),
									terms_and_conditions: A.terms_and_conditions,
									default: +!!A.default,
							  }),
							  n.o.success("Job Card Terms created")),
							k(!1),
							L();
					} catch (e) {
						n.o.error(
							e instanceof Error ? e.message : "Failed to save Job Card Terms"
						);
					} finally {
						P(!1);
					}
				...
				async function F(e) {
					M(e.name);
					try {
						await _.aL(e.name), n.o.success("Job Card Terms deleted"), L();
					} catch (e) {
						n.o.error(
							e instanceof Error ? e.message : "Failed to delete Job Card Terms"
						);
					} finally {
						M(null);
					}
										...
										? (0, a.jsxs)("div", {
												...
												children: [
													...
													(0, a.jsx)("p", {
														className: "text-sm",
														children:
															"No Job Card Terms templates found",
													}),
												],
										  })
										: (0, a.jsx)("div", {
											...
											(0, a.jsxs)("div", {
												...
												children: [
													...
													(0, a.jsx)("p", {
														...
														children:
															"Type the terms as plain text — points 1, 2, 3, etc. This will appear on the new job card and can be edited per job by the user.",
													}),
												],
											}),
											(0, a.jsxs)("div", {
		...
		66348: (e, t, r) => {
			...
			async function i(e) {
				return (0, a.AT)(`/api/method/${s}.list_spare_parts`, {
					method: "POST",
					body: JSON.stringify({
			...
			async function n(e) {
				return (0, a.AT)(`/api/method/${s}.get_spare_part`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function o(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_spare_part`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function d(e) {
				return (0, a.AT)(`/api/method/${s}.list_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
			...
			async function c(e) {
				return (0, a.AT)(`/api/method/${s}.get_vehicle_service_item`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function l(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_vehicle_service_item`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function u(e) {
				return (0, a.AT)(`/api/method/${s}.create_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function m(e, t) {
				return (0, a.AT)(`/api/method/${s}.add_vehicle_service_item_models`, {
					method: "POST",
					body: JSON.stringify({ name: e, vehicle_models: t }),
				});
			}
			async function f(e) {
				return (0, a.AT)(`/api/method/${s}.list_vehicle_service_item_names`, {
					method: "POST",
					body: JSON.stringify({ search: e?.search || null, limit: e?.limit ?? 100 }),
				});
			}
			async function h(e) {
				return (0, a.AT)(`/api/method/${s}.bulk_update_vehicle_service_items`, {
					method: "POST",
					body: JSON.stringify(e),
				});
			}
			async function p(e) {
				return (0, a.AT)(`/api/method/${s}.list_item_prices`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
			...
			async function v(e) {
				return (0, a.AT)(`/api/method/${s}.get_item_price`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function g(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_item_price`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function x(e) {
				return (0, a.AT)(`/api/method/${s}.create_item_price`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function y(e) {
				return (0, a.AT)(`/api/method/${s}.list_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 100,
			...
			async function b(e) {
				return (0, a.AT)(`/api/method/${s}.create_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function _(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function j(e) {
				return (0, a.AT)(`/api/method/${s}.delete_job_card_terms`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function N(e) {
				return (0, a.AT)(`/api/method/${s}.list_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						limit: e?.limit ?? 100,
			...
			async function T(e) {
				return (0, a.AT)(`/api/method/${s}.create_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function S(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function k(e) {
				return (0, a.AT)(`/api/method/${s}.delete_sales_invoice_tc`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function w(e) {
				return (0, a.AT)(`/api/method/${s}.list_vehicle_models`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						active_filter: e?.active_filter || "active",
			...
			async function O(e) {
				return (0, a.AT)(`/api/method/${s}.get_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function A(e) {
				return (0, a.AT)(`/api/method/${s}.create_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function J(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_vehicle_model`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function C(e, t) {
				return (0, a.AT)(`/api/method/${s}.create_vehicle_item_group`, {
					method: "POST",
					body: JSON.stringify({ item_group: e, parent_item_group: t || null }),
				});
			}
			async function P() {
				return (0, a.AT)(`/api/method/${s}.get_masters_options`, {
					method: "POST",
					body: JSON.stringify({}),
				});
			}
			async function $(e) {
				return (0, a.AT)(`/api/method/${s}.list_vehicle_service_packages`, {
					method: "POST",
					body: JSON.stringify({
						search: e?.search || null,
						active_filter: e?.active_filter || "active",
			...
			async function M(e) {
				return (0, a.AT)(`/api/method/${s}.get_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function E(e) {
				return (0, a.AT)(`/api/method/${s}.create_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function z(e, t) {
				return (0, a.AT)(`/api/method/${s}.update_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e, data: t }),
				});
			}
			async function L(e) {
				return (0, a.AT)(`/api/method/${s}.delete_vehicle_service_package`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
		...
		79984: (e, t, r) => {
			"use strict";
			r.d(t, { BT: () => d, Wu: () => c, ZB: () => o, Zp: () => i, aR: () => n });
			var a = r(95155);
			r(12115);
			var s = r(91337);
			function i({ className: e, ...t }) {
		...
		84437: (e, t, r) => {
			...
			function o({ className: e, ...t }) {
				return (0, a.jsx)(s.bL, {
					...
					...t,
					children: (0, a.jsx)(s.C1, {
						"data-slot": "checkbox-indicator",
						className: "flex items-center justify-center text-current transition-none",
						children: (0, a.jsx)(i.A, { className: "size-3.5" }),
					}),
				});
			}
		},
	...
	(e) => {
		e.O(0, [8409, 4855, 6609, 410, 7605, 1602, 2372, 8441, 3794, 7358], () => e((e.s = 1650))),
			(_N_E = e.O());
	},
]);
