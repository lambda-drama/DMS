(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[849, 1504],
	{
		...
		26518: (e, t, r) => {
			"use strict";
			r.d(t, { bq: () => m, eb: () => p, gC: () => u, l6: () => l, yv: () => d });
			var a = r(95155);
			r(12115);
			var s = r(40287),
				i = r(66088),
				...
				o = r(91337);
			function l({ ...e }) {
				return (0, a.jsx)(s.bL, { "data-slot": "select", ...e });
			}
			function d({ ...e }) {
				return (0, a.jsx)(s.WT, { "data-slot": "select-value", ...e });
			}
			function m({ className: e, size: t = "default", children: r, ...n }) {
			...
			function u({ className: e, children: t, position: r = "popper", ...i }) {
				return (0, a.jsx)(s.ZL, {
			...
			function v({ className: e, ...t }) {
				return (0, a.jsx)(s.PP, {
					...
					...t,
					children: (0, a.jsx)(c.A, { className: "size-4" }),
				});
			}
		...
		34441: (e, t, r) => {
			...
			var a = r(95155),
				...
				v = r(80723),
				h = r(85118);
			let g = (0, r(90425).A)("calendar-plus", [
			...
			function x() {
				let { navigate: e, viewParams: t } = (0, i.c)(),
					r = t.get("jobcard") || t.get("job_card") || "",
					{ trigger: x, isMutating: b } = (0, n.Y5)(),
					[w, y] = (0, s.useState)(r ? "job_card" : "standalone"),
					[j, k] = (0, s.useState)(""),
					[N, _] = (0, s.useState)(""),
					[S, C] = (0, s.useState)(r),
					[A, M] = (0, s.useState)(""),
					...
					[T, F] = (0, s.useState)("Phone Call"),
					[$, J] = (0, s.useState)(""),
					{ data: U, isLoading: V } = (0, n.dQ)(j),
					{ data: O, isLoading: Z } = (0, n.mv)(("standalone" === w && A) || void 0, N),
					{ data: D, isLoading: B } = (0, n.eT)({
						search: S || void 0,
						status: void 0,
						limit: 30,
					}),
					...
					I = async () => {
						if ("standalone" === w && !A) return void f.o.error("Select a customer");
						if ("job_card" === w && !L) return void f.o.error("Select a job card");
						if (!R) return void f.o.error("Set a follow-up due date");
						try {
							let t = await x({
								customer: "standalone" === w ? A : void 0,
								vehicle_vin: ("standalone" === w && P) || void 0,
								job_card: "job_card" === w ? L : void 0,
								follow_up_due_date: R,
								contact_method: T,
								contact_notes: $.trim() || void 0,
								contact_status: "Pending",
								case_status: "Pending",
								issue_resolved: "N/A",
							});
							f.o.success(`Follow-up ${t.name} scheduled`),
						...
						(0, a.jsxs)("div", {
							...
							children: [
								(0, a.jsx)(c.$, {
									...
									children: (0, a.jsx)(v.A, { className: "h-5 w-5" }),
								}),
								(0, a.jsxs)("div", {
									children: [
										(0, a.jsx)("h1", {
		...
		55833: (e, t, r) => {
			"use strict";
			r.d(t, { NavigationProvider: () => d, c: () => m, g: () => o });
			var a = r(95155),
				s = r(12115),
				i = r(15181);
			let n = [
			...
			let c = n.r
				...
				o = (0, s.Ht)(i.Ay, () => (e, t, r = {}) => {
					let { mutate: i } = (0, s.iX)(),
						...
						h = u.current,
						g = (0, a.useCallback)(async (e, t) => {
							let [r, a] = (0, n.s)(o.current);
							if (!l.current)
							...
							let s = (0, n.m)(
								...
								u = (0, n.o)();
							(m.current = u), v({ isMutating: !0 });
							try {
								let t = await i(
									r,
									l.current(a, { arg: e }),
									(0, n.m)(s, { throwOnError: !0 })
								);
								return (
									m.current <= u &&
										(c(() => v({ data: t, isMutating: !1, error: void 0 })),
										null == s.onSuccess || s.onSuccess.call(s, t, r, s)),
									t
								);
							} catch (e) {
								if (
									m.current <= u &&
									(c(() => v({ error: e, isMutating: !1 })),
									null == s.onError || s.onError.call(s, e, r, s),
									s.throwOnError)
								)
									throw e;
							}
						...
						f = (0, a.useCallback)(() => {
							(m.current = (0, n.o)()), v({ data: n.U, error: n.U, isMutating: !1 });
						}, []);
					return (
						(0, n.u)(() => {
							(o.current = e), (l.current = t), (d.current = r);
						}),
						{
							trigger: g,
							reset: f,
		...
		75559: (e, t, r) => {
			Promise.resolve().then(r.bind(r, 34441));
		},
		79792: (e, t, r) => {
			"use strict";
			r.d(t, { J: () => n });
		...
		79984: (e, t, r) => {
			"use strict";
			r.d(t, { BT: () => o, Wu: () => l, ZB: () => c, Zp: () => i, aR: () => n });
			var a = r(95155);
			r(12115);
			var s = r(91337);
			function i({ className: e, ...t }) {
	...
	(e) => {
		e.O(
			0,
			[5139, 878, 8409, 4855, 454, 6609, 410, 7605, 6020, 2372, 5079, 8441, 3794, 7358],
			() => e((e.s = 75559))
		),
			(_N_E = e.O());
	},
