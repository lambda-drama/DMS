(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[400, 2727],
	{
		...
		30400: (e, r, t) => {
			...
			function f() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, i.useState)(""),
					[f, h] = (0, i.useState)("Open"),
					[g, b] = (0, i.useState)(!0),
					[y, x] = (0, i.useState)(!1),
					[w, j] = (0, i.useState)("mine"),
					{ data: k, isLoading: N } = (0, n.Ay)(["crm-activities", r, f, g, y], () =>
						(0, a.s3)({
							search: r || void 0,
							status: f,
							mine: g,
					...
					{ data: S } = (0, n.Ay)(["crm-overdue-board", w], () => (0, a.Tc)(w)),
					_ = k?.data || [],
					C = k?.summary || {};
				return (0, s.jsxs)("div", {
					className: "space-y-4",
								...
								(0, s.jsxs)("div", {
									...
									children: [
										(0, s.jsxs)("span", {
											...
											children: ["Open: ", Number(C.open || 0)],
										}),
										(0, s.jsxs)("span", {
											className: "rounded-md border px-2.5 py-1",
											children: ["Mine: ", Number(C.mine_open || 0)],
										}),
										(0, s.jsxs)("span", {
											className:
												"rounded-md border border-destructive/40 px-2.5 py-1 text-destructive",
											children: ["Overdue: ", Number(C.overdue || 0)],
										}),
									],
								}),
								(0, s.jsxs)(l.$, {
		...
		39658: (e, r, t) => {
			...
			t(12115);
			var i = t(91337);
			function n({ className: e, type: r, ...t }) {
		...
		99239: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 30400));
		},
	},
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 99239))), (_N_E = e.O());
	},
]);
