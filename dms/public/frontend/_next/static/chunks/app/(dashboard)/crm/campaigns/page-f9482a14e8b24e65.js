(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6057, 9864],
	{
		4474: (e, r, t) => {
			...
			function o({ className: e, variant: r, size: t, asChild: i = !1, ...l }) {
				let d = i ? n.DX : "button";
				return (0, s.jsx)(d, {
					"data-slot": "button",
		...
		11845: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 49864));
		},
		15181: (e, r, t) => {
			"use strict";
			function s(e) {
		...
		39658: (e, r, t) => {
			...
			t(12115);
			var n = t(91337);
			function i({ className: e, type: r, ...t }) {
		...
		42442: (e, r, t) => {
			...
			var s,
				...
				o = (s || (s = t.t(n, 2)))[" use ".trim().toString()];
			function l(e) {
				var r;
				return (
					null != e &&
			...
			function d(e) {
				...
				let t,
									...
									l = (function (e, r) {
										...
										for (let s in r) {
											...
											/^on[A-Z]/.test(s)
												...
												? (t[s] = { ...n, ...i })
												: "className" === s &&
												  (t[s] = [n, i].filter(Boolean).join(" "));
										}
										return { ...e, ...t };
									})(s, t.props);
								return (
									t.type !== n.Fragment && (l.ref = r ? (0, i.t)(r, o) : o),
									n.cloneElement(t, l)
								);
							}
					...
					c = n.forwardRef((e, r) => {
						...
						return (0, a.jsx)(s, { ...i, ref: r, children: t });
					});
		...
		49864: (e, r, t) => {
			...
			function g() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, n.useState)("campaigns"),
					[g, v] = (0, n.useState)(""),
					{ data: h, isLoading: b } = (0, i.Ay)(
						"campaigns" === r ? ["crm-campaigns", g] : null,
						() => (0, a.U5)({ search: g || void 0, limit: 50 })
					),
					{ data: y, isLoading: x } = (0, i.Ay)(
						"segments" === r ? ["crm-segments", g] : null,
						() => (0, a.Bz)({ search: g || void 0, limit: 50 })
					);
				return (0, s.jsxs)("div", {
					className: "space-y-4",
					children: [
						(0, s.jsxs)("div", {
							...
							children: [
								(0, s.jsxs)("div", {
									...
									children: [
										(0, s.jsx)(l.$, {
											variant: "campaigns" === r ? "default" : "outline",
											size: "sm",
											onClick: () => t("campaigns"),
											children: "Campaigns",
										}),
										(0, s.jsx)(l.$, {
											variant: "segments" === r ? "default" : "outline",
											size: "sm",
											onClick: () => t("segments"),
											children: "Segments",
										}),
								...
								(0, s.jsxs)(l.$, {
									...
									children: [
										...
										"campaigns" === r ? "New Campaign" : "New Segment",
									],
								}),
							],
						}),
				...
				let [r, t] = (0, n.useState)("dashboard"),
					...
					u = (0, n.useCallback)((e, r) => {
						let s = r && Object.keys(r).length > 0 ? r : void 0,
							n = `#${e}`;
						s && (n += `?${new URLSearchParams(s).toString()}`),
							t(e),
	...
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 11845))), (_N_E = e.O());
	},
]);
