	...
	[6, 9707],
	{
		...
		42074: (e, t, a) => {
			...
			function n({ children: e, className: t, align: a = "end" }) {
				...
				return o ? (0, c.createPortal)(d, document.body) : null;
			}
		},
		51914: (e, t, a) => {
			"use strict";
		...
		55833: (e, t, a) => {
			"use strict";
			a.d(t, { NavigationProvider: () => d, c: () => m, g: () => o });
			var s = a(95155),
				r = a(12115),
				c = a(15181);
			let i = [
			...
			function d({ children: e }) {
				let [t, a] = (0, r.useState)("dashboard"),
					[o, m] = (0, r.useState)(new URLSearchParams()),
		...
		61640: (e, t, a) => {
			...
			function f() {
				let { navigate: e } = (0, n.c)(),
					{ data: t } = (0, c.Ay)("crm-account-form-options", i._j),
					[a, f] = (0, r.useState)(!1),
					{ error: b, success: y, showError: w, clear: j } = (0, x.B)(),
					[k, _] = (0, r.useState)({
						account_name: "",
						customer: "",
					...
					N = (0, r.useMemo)(
						() => (t?.account_types || []).map((e) => ({ value: e, label: e })),
						[t]
					),
					C = (0, r.useMemo)(
					...
					q = (e, t) => _((a) => ({ ...a, [e]: t })),
					A = async () => {
						if ((j(), !k.customer)) return void w("Customer is required.");
						if (!k.account_name.trim()) return void w("Account name is required.");
						f(!0);
						try {
							let t = await (0, i._m)({
									account_name: k.account_name.trim(),
									customer: k.customer,
									account_type: k.account_type,
									status: k.status,
									industry: k.industry || null,
									territory: k.territory || null,
									legal_name: k.legal_name || null,
									tax_id: k.tax_id || null,
									registration_number: k.registration_number || null,
									credit_terms: k.credit_terms || null,
									account_plan: k.account_plan || null,
									notes: k.notes || null,
								}),
								a = t?.name;
							a ? e("crm-account-detail", { id: String(a) }) : e("crm-accounts");
						} catch (e) {
							w(e, "Failed to create account");
						} finally {
							f(!1);
						}
					};
				return (0, s.jsxs)("div", {
					...
					children: [
						(0, s.jsx)(x.y, { error: b, success: y, onDismiss: j }),
						(0, s.jsxs)(l.Zp, {
							...
							children: [
								(0, s.jsx)(l.aR, {
									children: (0, s.jsx)(l.ZB, {
										className: "text-base",
										children: "Corporate / fleet account",
									}),
								}),
								(0, s.jsxs)(l.Wu, {
									...
									children: [
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: k.industry,
													onChange: (e) => q("industry", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: k.tax_id,
													onChange: (e) => q("tax_id", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: k.registration_number,
													onChange: (e) =>
														q("registration_number", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(d.p, {
													value: k.credit_terms,
													onChange: (e) =>
														q("credit_terms", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(m.T, {
													rows: 3,
													value: k.account_plan,
													onChange: (e) =>
														q("account_plan", e.target.value),
												}),
											],
										}),
										(0, s.jsxs)("div", {
		...
		69385: (e, t, a) => {
			Promise.resolve().then(a.bind(a, 61640));
		},
		74350: (e, t, a) => {
			"use strict";
			a.d(t, {
