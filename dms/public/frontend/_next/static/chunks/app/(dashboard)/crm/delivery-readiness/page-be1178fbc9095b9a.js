(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[4147, 6008],
	{
		6008: (e, r, t) => {
			...
			function u() {
				let { navigate: e } = (0, c.c)(),
					[r, t] = (0, n.useState)(""),
					[u, p] = (0, n.useState)("all"),
					{ data: f, isLoading: v } = (0, s.Ay)(["crm-delivery-readiness", r, u], () =>
						(0, a.J1)({ search: r, status: u })
					),
					g = f?.data || [];
				return (0, i.jsxs)("div", {
					className: "space-y-4",
		...
		35939: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 6008));
		},
		38291: (e, r, t) => {
			"use strict";
			t.d(r, { E: () => o });
	...
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 35939))), (_N_E = e.O());
	},
]);
