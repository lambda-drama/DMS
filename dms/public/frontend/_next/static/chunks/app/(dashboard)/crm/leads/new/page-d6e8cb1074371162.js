(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5084],
	{
			...
			async function i(e, t) {
				...
				try {
					...
					let c = i ? ".png" : ".jpg",
						...
						m = (e.name.replace(/\.[^.]+$/, "") || "image").slice(0, 120);
					return new File([o], `${m}${c}`, { type: l, lastModified: Date.now() });
				} catch {
					return e;
				}
			}
		...
		36241: (e, t, r) => {
			...
			function p() {
				let { navigate: e } = (0, o.c)(),
					{ data: t } = (0, i.Ay)("crm-lead-form-options", n.Fl),
					[r, p] = (0, s.useState)(!1),
					{ error: h, success: f, showError: g, clear: v } = (0, d.B)(),
					[y, b] = (0, s.useState)(m.Sp);
				(0, s.useEffect)(() => {
					t &&
						b((e) => ({
							...e,
							company: e.company || t.default_company || "",
							source: e.source || t.sources?.[0] || "Showroom Walk-in",
						}));
				}, [t]);
				let w = async () => {
					if ((v(), !y.lead_name.trim() && !y.first_name.trim() && !y.mobile_no.trim()))
						return void g("Enter a lead name, first name, or mobile number.");
					if (!y.source) return void g("Lead source is required.");
					p(!0);
					try {
						let t = await (0, n.tR)((0, m.DW)(y));
						t?.name ? e("crm-lead-detail", { id: t.name }) : e("crm-leads");
					} catch (e) {
						g(e, "Failed to create lead");
					} finally {
						p(!1);
					}
				};
				return (0, a.jsxs)("div", {
					...
					children: [
						(0, a.jsx)(d.y, { error: h, success: f, onDismiss: v }),
						(0, a.jsx)(m.Rs, { form: y, setForm: b, options: t, showStatus: !0 }),
						(0, a.jsxs)(l.h, {
							children: [
								(0, a.jsx)(c.$, {
									variant: "outline",
		...
		55833: (e, t, r) => {
			"use strict";
			r.d(t, { NavigationProvider: () => m, c: () => d, g: () => c });
			var a = r(95155),
				s = r(12115),
				i = r(15181);
			let n = [
			...
			function m({ children: e }) {
				let [t, r] = (0, s.useState)("dashboard"),
					[c, d] = (0, s.useState)(new URLSearchParams()),
		...
		59304: (e, t, r) => {
			Promise.resolve().then(r.bind(r, 36241));
		},
		74350: (e, t, r) => {
			"use strict";
			r.d(t, {
		...
		93108: (e, t, r) => {
			...
			function d({ error: e, success: t, onDismiss: r, className: s }) {
				if (!e && !t) return null;
				let i = !!e;
				return (0, a.jsx)("div", {
					className: (0, l.cn)("sticky top-0 z-40 -mx-1 px-1 pt-1", s),
	...
	(e) => {
		e.O(
			0,
			[
				5139, 878, 8409, 4855, 454, 6609, 410, 7605, 1602, 6158, 8103, 2372, 2751, 5505,
				2079, 8441, 3794, 7358,
			],
			() => e((e.s = 59304))
		),
