(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6337],
	{
			...
			async function l(e, r = {}) {
				...
				let i = r.method?.toUpperCase() || "GET",
					n = async (t) => {
						...
						return { response: l, resData: m };
					},
					{ response: m, resData: d } = await n(!1);
				if (
					(!m.ok &&
						"GET" !== i &&
						(403 === m.status ||
							(400 === m.status &&
								("CSRFTokenError" === (t = d).exc_type ||
									String(t.exc ?? "").includes("CSRFTokenError")))) &&
						(a(), ({ response: m, resData: d } = await n(!0))),
					!m.ok)
				)
					throw Error(
						(function (e) {
		...
		55833: (e, r, t) => {
			...
			function m({ children: e }) {
				let [r, t] = (0, n.useState)("dashboard"),
					[o, d] = (0, n.useState)(new URLSearchParams()),
		...
		65983: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 3680));
		},
		90425: (e, r, t) => {
			"use strict";
			t.d(r, { A: () => o });
	...
	(e) => {
		e.O(0, [8409, 4855, 8091, 6031, 445, 6020, 5079, 3680, 8441, 3794, 7358], () =>
			e((e.s = 65983))
		),
			(_N_E = e.O());
	},
