(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[1671, 1968],
	{
		4474: (e, r, t) => {
			...
			function o({ className: e, variant: r, size: t, asChild: n = !1, ...l }) {
				let d = n ? i.DX : "button";
				return (0, s.jsx)(d, {
					"data-slot": "button",
		...
		11671: (e, r, t) => {
			...
			var s = t(95155),
				...
				u = t(80723);
			function p() {
				let { navigate: e, viewParams: r } = (0, a.c)(),
					t = r.get("id") || "",
					{
						data: p,
						isLoading: f,
						mutate: v,
					} = (0, i.Ay)(t ? ["crm-referral", t] : null, () => (0, n.o4)(t)),
					{ error: g, success: h, showError: y, showSuccess: w, clear: b } = (0, m.B)();
				if (!t)
					return (0, s.jsx)(l.Zp, {
						children: (0, s.jsx)(l.Wu, {
							className: "py-10 text-center text-muted-foreground",
							children: "No referral selected.",
						}),
					});
				if (f || !p) return (0, s.jsx)(d.E, { className: "h-40" });
				let x = async (e) => {
					b();
					try {
						await (0, n.ns)(t, e), await v(), w(`Marked ${e}.`);
					} catch (e) {
						y(e, "Update failed");
					}
				};
				return (0, s.jsxs)("div", {
					className: "space-y-4",
					children: [
						(0, s.jsx)(m.y, { error: g, success: h, onDismiss: b }),
						(0, s.jsxs)(o.$, {
							variant: "ghost",
							size: "sm",
							onClick: () => e("crm-referrals"),
							children: [
									...
									children: (0, s.jsxs)("div", {
										...
										children: [
											(0, s.jsxs)(l.ZB, {
												className: "text-base",
												children: [
													String(p.referred_name),
													" (",
													String(p.name),
													")",
												],
											}),
											(0, s.jsx)(c.E, { children: String(p.status) }),
										],
									}),
								}),
								(0, s.jsxs)(l.Wu, {
									...
									children: [
										(0, s.jsxs)("p", {
											children: [
												...
												String(p.referrer_name || p.referrer_customer),
											],
										}),
										(0, s.jsxs)("p", {
											children: [
												(0, s.jsx)("span", {
													className: "text-muted-foreground",
													children: "Reward event: ",
												}),
												String(p.reward_event || "—"),
												" (",
												Number(p.reward_points || 0),
												" pts)",
											],
										}),
										(0, s.jsxs)("p", {
										...
										(0, s.jsxs)("p", {
											children: [
												(0, s.jsx)("span", {
													className: "text-muted-foreground",
													children: "Reward paid: ",
												}),
												p.reward_paid ? "Yes" : "No",
											],
										}),
									],
								}),
						...
						(0, s.jsxs)("div", {
							...
							children: [
								["Lead Converted", "Booking", "Full Payment", "Delivery"].map(
									(e) =>
										(0, s.jsxs)(
											o.$,
											{
								...
								(0, s.jsx)(o.$, {
									...
									onClick: async () => {
										try {
											await (0, n.fl)(t, { status: "Disqualified" }),
												await v(),
												w("Disqualified.");
										} catch (e) {
											y(e, "Failed");
		...
		18460: (e, r, t) => {
			...
			let i = (e) => ("boolean" == typeof e ? `${e}` : 0 === e ? "0" : e),
				...
				a = (e, r) => (t) => {
					...
					let { variants: a, defaultVariants: c } = r,
		...
		38291: (e, r, t) => {
			...
			function o({ className: e, variant: r, asChild: t = !1, ...n }) {
				let l = t ? i.DX : "span";
				return (0, s.jsx)(l, {
					"data-slot": "badge",
					className: (0, a.cn)(c({ variant: r }), e),
					...n,
				});
			}
		},
		42442: (e, r, t) => {
			...
			var s,
				...
				o = (s || (s = t.t(i, 2)))[" use ".trim().toString()];
			function l(e) {
				var r;
				return (
					null != e &&
				...
				let t,
					s =
						...
						((t = i.forwardRef((e, r) => {
							let { children: t, ...s } = e;
							if (
								(l(t) && "function" == typeof o && (t = o(t._payload)),
								i.isValidElement(t))
							) {
								var a;
								let e,
								...
								return (
									t.type !== i.Fragment && (l.ref = r ? (0, n.t)(r, o) : o),
									i.cloneElement(t, l)
								);
							}
						...
						if (d) {
							...
							return (0, a.jsx)(s, {
								...
								children: i.isValidElement(e)
									? i.cloneElement(e, void 0, t)
									: null,
							});
						}
						return (0, a.jsx)(s, { ...n, ref: r, children: t });
					});
		...
		49876: (e, r, t) => {
			...
			async function n(e = !1) {
				let r = window;
				if (!e) {
					if (i(r?.csrf_token)) return r.csrf_token.trim();
					let e = (function () {
					...
					if (e) return r && (r.csrf_token = e), e;
				}
				return (
					s ||
					(s = (async () => {
						try {
							let r = await fetch("/api/method/dms.api.common.get_csrf_token", {
									method: "GET",
									credentials: "include",
							...
							if (i(s)) {
								...
								return (
									(e = s.trim()),
									(r = window) && (r.csrf_token = e),
									(function (e) {
										if ("u" < typeof document) return;
										let r = document.querySelector('meta[name="csrf-token"]');
										r ||
			...
			async function l(e, r = {}) {
				var t;
				let s = r.method?.toUpperCase() || "GET",
					i = async (t) => {
						"GET" !== s && (await n(t));
						let i = (function (e, r) {
								let t = { ...e };
							...
							o =
								"GET" !== s
									? (function (e, r) {
											if (!r || null == e || "string" != typeof e) return e;
											try {
												let t = JSON.parse(e);
												if (
													null !== t &&
													...
													return JSON.stringify({ ...t, csrf_token: r });
											} catch {}
											return e;
									  })(r.body ?? null, a)
									: r.body,
						...
						return { response: l, resData: d };
					},
					{ response: d, resData: m } = await i(!1);
				if (
					(!d.ok &&
						"GET" !== s &&
						(403 === d.status ||
							(400 === d.status &&
								("CSRFTokenError" === (t = m).exc_type ||
									String(t.exc ?? "").includes("CSRFTokenError")))) &&
						(a(), ({ response: d, resData: m } = await i(!0))),
					!d.ok)
				)
					throw Error(
						(function (e) {
							if (e._server_messages) {
								let r = (function (e) {
									try {
										let r = JSON.parse(String(e));
										if (!Array.isArray(r)) return o(String(e));
										return r
											.map((e) => {
												try {
													return (
				...
				return void 0 !== m.data ? m.data : void 0 !== m.message ? m.message : m;
			}
		},
		55833: (e, r, t) => {
			"use strict";
			...
			function d({ children: e }) {
				let [r, t] = (0, i.useState)("dashboard"),
					[o, m] = (0, i.useState)(new URLSearchParams()),
					u = (0, i.useCallback)((e, r) => {
						let s = r && Object.keys(r).length > 0 ? r : void 0,
							i = `#${e}`;
						s && (i += `?${new URLSearchParams(s).toString()}`),
							t(e),
							m(new URLSearchParams(s || {})),
							(window.location.hash = i),
							(0, n.i)(),
							requestAnimationFrame(() => (0, n.i)());
					}, []);
				return (
					(0, i.useEffect)(() => {
						let e = () => {
			...
			let c = (0, s.forwardRef)(
					(
						...
						(0, s.createElement)(
							...
							[
								...l.map(([e, r]) => (0, s.createElement)(e, r)),
								...(Array.isArray(o) ? o : [o]),
							]
						)
				),
				o = (e, r) => {
					let t = (0, s.forwardRef)(({ className: t, ...a }, o) =>
						(0, s.createElement)(c, {
							ref: o,
							iconNode: r,
							className: i(
		...
		92996: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 11671));
		},
		93108: (e, r, t) => {
			"use strict";
			t.d(r, { B: () => d, y: () => m });
			...
			function d() {
				let [e, r] = (0, i.useState)(""),
					[t, s] = (0, i.useState)(""),
					a = (0, i.useCallback)((e, t = "Something went wrong.") => {
						let i =
				...
				return {
					...
					success: t,
					showError: a,
					showSuccess: (0, i.useCallback)((e) => {
						r(""), s(e), n.o.success(e);
					}, []),
					clear: (0, i.useCallback)(() => {
						r(""), s("");
					}, []),
				};
			}
			function m({ error: e, success: r, onDismiss: t, className: i }) {
				if (!e && !r) return null;
				let n = !!e;
				return (0, s.jsx)("div", {
					className: (0, l.cn)("sticky top-0 z-40 -mx-1 px-1 pt-1", i),
					children: (0, s.jsxs)("div", {
						role: n ? "alert" : "status",
						...
						children: [
							n
								? (0, s.jsx)(a.A, { className: "mt-0.5 h-4 w-4 shrink-0" })
								: (0, s.jsx)(c.A, { className: "mt-0.5 h-4 w-4 shrink-0" }),
							(0, s.jsx)("p", {
	...
	(e) => {
		e.O(0, [8409, 4855, 6609, 8103, 8441, 3794, 7358], () => e((e.s = 92996))), (_N_E = e.O());
	},
]);
