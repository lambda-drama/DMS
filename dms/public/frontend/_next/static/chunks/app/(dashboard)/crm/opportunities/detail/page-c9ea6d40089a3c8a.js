(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5473],
	{
		5240: (e, t, r) => {
			...
			function a(e, t, r) {
				return new Promise((a, i) => {
					e.toBlob((e) => (e ? a(e) : i(Error("Image compression failed"))), t, r);
				});
			}
			async function i(e, t, r, i) {
				let { width: s, height: n } = (function (e, t, r) {
						let a = Math.max(e, t);
				...
				return (c.drawImage(e, 0, 0, s, n), i) ? a(o, "image/png") : a(o, "image/jpeg", r);
			}
			async function s(e, t) {
				...
				try {
					let r = await new Promise((t, r) => {
						...
						o = null;
					for (let e of n)
						if ((o = await i(r, e.maxSide, e.quality, s)).size <= a) break;
					if (!o || (o.size >= e.size && e.size <= a)) return e;
					let c = s ? ".png" : ".jpg",
						l = s ? "image/png" : "image/jpeg",
			...
			async function P(e, t, r, a, i, s) {
				return (0, n.AT)(`/api/method/${o}.get_spare_parts`, {
					...
					body: JSON.stringify({
						...
						vin: i || null,
						vehicle_brand: s || null,
					}),
				});
			}
			async function $(e, t, r, a = 50) {
			...
			async function R(e) {
				...
				let i = window.location.origin,
					o = await fetch(`${i}/api/method/upload_file`, {
						method: "POST",
		...
		55833: (e, t, r) => {
			...
			function m({ children: e }) {
				let [t, r] = (0, i.useState)("dashboard"),
					[c, d] = (0, i.useState)(new URLSearchParams()),
					u = (0, i.useCallback)((e, t) => {
						let a = t && Object.keys(t).length > 0 ? t : void 0,
							i = `#${e}`;
						a && (i += `?${new URLSearchParams(a).toString()}`),
							r(e),
		...
		92547: (e, t, r) => {
			Promise.resolve().then(r.bind(r, 23718));
		},
		94514: (e, t, r) => {
			"use strict";
			r.d(t, { A: () => a });
	...
	(e) => {
		e.O(
			0,
			[
				5139, 878, 8409, 4855, 454, 6609, 410, 7605, 1602, 3031, 8103, 2372, 2751, 7367,
				5505, 6400, 3718, 8441, 3794, 7358,
			],
			() => e((e.s = 92547))
		),
			(_N_E = e.O());
