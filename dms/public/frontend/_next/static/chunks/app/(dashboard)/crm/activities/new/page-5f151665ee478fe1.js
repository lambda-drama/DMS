(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[2623, 3370],
	{
		2573: (e, t, r) => {
			...
			function h() {
				let { navigate: e } = (0, n.c)(),
					...
					[r, h] = (0, a.useState)(!1),
					{ error: x, success: b, showError: y, clear: w } = (0, g.B)(),
					[j, k] = (0, a.useState)({
						subject: "",
						activity_type: "Call",
						status: "Open",
					...
					N = (e, t) => k((r) => ({ ...r, [e]: t })),
					_ = (e) => (e || []).filter(Boolean).map((e) => ({ value: e, label: e })),
					q = async () => {
						if ((w(), !j.subject.trim())) return void y("Subject is required.");
						h(!0);
						try {
							let t = await (0, c.E1)({
								...
								status: j.status,
								priority: j.priority,
								due_datetime: j.due_datetime || null,
								customer: j.customer || null,
								is_recurring: +!!j.is_recurring,
								recurrence_frequency:
									(j.is_recurring && j.recurrence_frequency) || null,
								outcome_notes: j.outcome_notes || null,
							});
							e("crm-activity-detail", { id: String(t.name) });
						} catch (e) {
							y(e, "Failed to create activity");
						} finally {
							h(!1);
						}
					};
				return (0, s.jsxs)("div", {
					...
					children: [
						(0, s.jsx)(g.y, { error: x, success: b, onDismiss: w }),
						(0, s.jsxs)(l.Zp, {
									...
									children: [
										...
										(0, s.jsxs)("div", {
											...
											children: [
												...
												(0, s.jsx)(p.Zi, {
													options: _(t?.activity_types),
													value: j.activity_type,
													onValueChange: (e) =>
										...
										j.is_recurring
											? (0, s.jsxs)("div", {
													...
													children: [
														...
														(0, s.jsx)(p.Zi, {
															options: _(t?.recurrence_frequencies),
															value: j.recurrence_frequency,
															onValueChange: (e) =>
		...
		13545: (e, t, r) => {
			"use strict";
			r.d(t, { A: () => s });
			let s = (0, r(90425).A)("circle-alert", [
				["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
		...
		34262: (e, t, r) => {
			Promise.resolve().then(r.bind(r, 2573));
		},
		39540: (e, t, r) => {
			"use strict";
			r.d(t, { T: () => i });
		...
		42074: (e, t, r) => {
			...
			var s = r(95155),
				...
				i = r(47650),
				c = r(91337);
			function n({ children: e, className: t, align: r = "end" }) {
				let [o, l] = (0, a.useState)(!1);
				(0, a.useEffect)(() => (l(!0), () => l(!1)), []);
				let d = (0, s.jsx)("div", {
					role: "toolbar",
		...
		55833: (e, t, r) => {
			...
			function d({ children: e }) {
				let [t, r] = (0, a.useState)("dashboard"),
					[o, m] = (0, a.useState)(new URLSearchParams()),
		...
		56563: (e, t, r) => {
			"use strict";
			r.d(t, { A: () => s });
			let s = (0, r(90425).A)("chevrons-up-down", [
		...
		94514: (e, t, r) => {
			"use strict";
			r.d(t, { A: () => s });
			let s = (0, r(90425).A)("check", [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]]);
		},
	},
	(e) => {
