(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[6447, 8040],
	{
		4474: (e, r, t) => {
			...
			function o({ className: e, variant: r, size: t, asChild: s = !1, ...l }) {
				let d = s ? i.DX : "button";
				return (0, n.jsx)(d, {
					"data-slot": "button",
		...
		38291: (e, r, t) => {
			...
			function o({ className: e, variant: r, asChild: t = !1, ...s }) {
				let l = t ? i.DX : "span";
				return (0, n.jsx)(l, {
					"data-slot": "badge",
		...
		39658: (e, r, t) => {
			...
			t(12115);
			var i = t(91337);
			function s({ className: e, type: r, ...t }) {
		...
		42442: (e, r, t) => {
			...
			var n,
				...
				o = (n || (n = t.t(i, 2)))[" use ".trim().toString()];
			function l(e) {
				var r;
				return (
					null != e &&
			...
			function d(e) {
				...
				let t,
									...
									l = (function (e, r) {
										...
										for (let n in r) {
											...
											/^on[A-Z]/.test(n)
												...
												? (t[n] = { ...i, ...s })
												: "className" === n &&
												  (t[n] = [i, s].filter(Boolean).join(" "));
										}
										return { ...e, ...t };
									})(n, t.props);
								return (
									t.type !== i.Fragment && (l.ref = r ? (0, s.t)(r, o) : o),
									i.cloneElement(t, l)
								);
							}
					...
					c = i.forwardRef((e, r) => {
						...
						return (0, a.jsx)(n, { ...s, ref: r, children: t });
					});
		...
		49876: (e, r, t) => {
			...
			async function l(e, r = {}) {
				var t;
				let n = r.method?.toUpperCase() || "GET",
					i = async (t) => {
						"GET" !== n && (await s(t));
						let i = (function (e, r) {
								let t = { ...e };
			...
			function d({ children: e }) {
				let [r, t] = (0, i.useState)("dashboard"),
					...
					u = (0, i.useCallback)((e, r) => {
						let n = r && Object.keys(r).length > 0 ? r : void 0,
							i = `#${e}`;
						n && (i += `?${new URLSearchParams(n).toString()}`),
							t(e),
							m(new URLSearchParams(n || {})),
							(window.location.hash = i),
							(0, s.i)(),
							requestAnimationFrame(() => (0, s.i)());
					}, []);
				return (
					(0, i.useEffect)(() => {
						let e = () => {
		...
		76447: (e, r, t) => {
			...
			function h() {
				let { navigate: e } = (0, o.c)(),
					[r, t] = (0, s.useState)(""),
					[h, y] = (0, s.useState)("all"),
					{ data: b, isLoading: w } = (0, a.Ay)(["crm-sales-appointments", r, h], () =>
						(0, c.bh)({ search: r || void 0, status: h, limit: 100 })
					),
					x = b?.data || [];
				return (0, n.jsxs)("div", {
					className: "space-y-4",
		...
		81672: (e, r, t) => {
			"use strict";
			t.d(r, { Ge: () => m, N0: () => l, Yq: () => c, gQ: () => d, r6: () => o });
			let n = [
					"January",
					"February",
					"March",
			...
			function a(e) {
				...
				let n = new Date(r.includes(" ") && !r.includes("T") ? r.replace(" ", "T") : r);
				return Number.isNaN(n.getTime()) ? null : n;
			}
			function c(e, r = "") {
				let t = a(e);
				return t ? `${s(t.getDate())}/${s(t.getMonth() + 1)}/${t.getFullYear()}` : r;
			}
			function o(e, r = "", t = !1) {
				let n = a(e);
				if (!n) return r;
				let i = `${s(n.getHours())}:${s(n.getMinutes())}${
					t ? `:${s(n.getSeconds())}` : ""
				}`;
				return `${c(n)} ${i}`;
			}
			function l(e, r = "") {
				let t = a(e);
				return t ? `${n[t.getMonth()]} ${t.getFullYear()}` : r;
			}
			function d(e, r = "") {
				let t = a(e);
				return t ? i[t.getDay()] : r;
			}
			function m(e, r = "") {
				let t = a(e);
				return t ? `${i[t.getDay()]}, ${c(t)}` : r;
			}
		},
		90425: (e, r, t) => {
			"use strict";
					...
					(
						...
						(0, n.createElement)(
							"svg",
							{
								...
								height: r,
								stroke: e,
								strokeWidth: s ? (24 * Number(t)) / Number(r) : t,
							...
							[
								...l.map(([e, r]) => (0, n.createElement)(e, r)),
								...(Array.isArray(o) ? o : [o]),
							]
						)
				),
				o = (e, r) => {
					let t = (0, n.forwardRef)(({ className: t, ...a }, o) =>
						(0, n.createElement)(c, {
							ref: o,
							iconNode: r,
							className: i(
		...
		91774: (e, r, t) => {
			Promise.resolve().then(t.bind(t, 76447));
		},
	},
	(e) => {
		e.O(0, [8409, 4855, 8103, 8441, 3794, 7358], () => e((e.s = 91774))), (_N_E = e.O());
	},
]);
