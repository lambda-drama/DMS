...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[1569],
	{
		21569: (e, t, r) => {
			...
			function p() {
				let { navigate: e } = (0, d.c)(),
					[t, r] = (0, a.useState)(""),
					{ data: p, isLoading: f } = (0, n.Ay)(["crm-accounts", t], () =>
						(0, c.B)({ search: t || void 0, limit: 50 })
					),
					g = p?.data || [];
				return (0, s.jsxs)("div", {
					className: "space-y-4",
		...
		38291: (e, t, r) => {
			...
			function i({ className: e, variant: t, asChild: r = !1, ...n }) {
				let l = r ? a.DX : "span";
				return (0, s.jsx)(l, {
					"data-slot": "badge",
					className: (0, c.cn)(d({ variant: t }), e),
					...n,
				});
			}
		},
