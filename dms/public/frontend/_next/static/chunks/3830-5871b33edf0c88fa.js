...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[3830],
	{
		38291: (e, s, t) => {
			...
			function l({ className: e, variant: s, asChild: t = !1, ...r }) {
				let d = t ? n.DX : "span";
				return (0, a.jsx)(d, {
					"data-slot": "badge",
					className: (0, i.cn)(c({ variant: s }), e),
					...r,
				});
			}
		},
		53830: (e, s, t) => {
			...
			function S() {
				let { canWrite: e } = (0, r.Sk)(),
					...
					[E, F] = (0, n.useState)([]),
					[R, B] = (0, n.useState)([]),
					[D, Z] = (0, n.useState)(null),
					[z, I] = (0, n.useState)(!1),
					[U, L] = (0, n.useState)(!1),
					[M, W] = (0, n.useState)(!1),
					{ data: H, isLoading: X } = (0, k.Rr)(),
					{ data: V, isLoading: q } = (0, k.dQ)(S);
				(0, k.Tr)(H, X, $, (e) => C(e.name)),
					(0, n.useEffect)(() => {
						!$ && H?.length && C(H[0].name);
					}, [H, $]);
				let G = (0, n.useMemo)(
					...
					Q = (0, n.useCallback)(async () => {
						if (!s) return void O(null);
						J(!0);
						try {
							let e = await _.DJ(s, $ || void 0);
							O(e), !$ && e.company && C(e.company), F([]), B([]);
						} catch (e) {
							O(null),
								N.o.error(
									e instanceof Error
				...
				let K = (e, s, t) => {
						t(s.includes(e) ? s.filter((s) => s !== e) : [...s, e]);
					},
					Y = T?.invoices ?? [],
					ee = T?.payments ?? [],
					es = T?.missing_dimensions ?? [],
					et = (0, n.useMemo)(() => Y.filter((e) => E.includes(e.key)), [Y, E]),
					ea = (0, n.useMemo)(() => ee.filter((e) => R.includes(e.key)), [ee, R]),
					en = et.reduce((e, s) => e + s.outstanding, 0),
					er = ea.reduce((e, s) => e + s.amount, 0),
					ei = Y[0]?.currency || ee[0]?.currency,
					ec =
						e("reconciliation-hub") &&
						!!T &&
						E.length > 0 &&
						R.length > 0 &&
						0 === es.length,
					el = async () => {
						if (T) {
							L(!0);
							try {
								Z(await _.$X(T.customer, T.company, E, R)), I(!0);
							} catch (e) {
								N.o.error(
									e instanceof Error
										? e.message
										: "Failed to preview the allocation"
								);
							} finally {
								L(!1);
							}
					...
					ed = async () => {
						if (T) {
							W(!0);
							try {
								let e = await _.eI(T.customer, T.company, E, R);
								N.o.success(
									`Reconciled ${w(e.allocated_total, ei)} across ${
										e.invoice_count
									} invoice(s)`
								),
									I(!1),
								...
								N.o.error(e instanceof Error ? e.message : "Failed to reconcile");
							} finally {
								W(!1);
							}
						}
				...
				return (0, a.jsxs)("div", {
					...
					children: [
						(0, a.jsxs)("div", {
							children: [
								...
								(0, a.jsx)("p", {
									...
									children:
										"Pick a customer, then tick the unpaid invoices and the payments / advances that settle them.",
								}),
							],
						}),
						(0, a.jsx)(c.Zp, {
							children: (0, a.jsxs)(c.Wu, {
								...
								children: [
									...
									T
										? (0, a.jsxs)("div", {
												className:
													"flex flex-wrap items-center justify-between gap-3 rounded-lg border bg-muted/20 px-3 py-2 text-sm",
												children: [
													(0, a.jsxs)("div", {
														className:
												...
												children: [
													...
													(0, a.jsxs)("span", {
														children: [
															...
															" in DMS Settings → Company Defaults before reconciling — ERPNext requires it as an accounting dimension on this company’s Balance Sheet accounts.",
														],
													}),
												],
										  })
										...
										(0, a.jsx)(c.Wu, {
											children: P
												...
												? 0 === Y.length
													...
													: (0, a.jsx)("div", {
															className:
																"max-h-[26rem] space-y-1.5 overflow-y-auto pr-1",
															children: Y.map((e) =>
																(0, a.jsxs)(
																	"label",
																	{
																		className:
																			"flex cursor-pointer items-center gap-3 rounded-md border px-3 py-2 transition-colors hover:bg-muted/40",
																		children: [
																			(0, a.jsx)(d.S, {
																				checked:
																					E.includes(
						...
						(0, a.jsx)(c.Zp, {
							children: (0, a.jsxs)(c.Wu, {
								className:
									"flex flex-col gap-3 pt-6 sm:flex-row sm:items-center sm:justify-between",
								children: [
									(0, a.jsxs)("div", {
										className:
											"flex flex-wrap items-center gap-x-6 gap-y-1 text-sm",
										children: [
											(0, a.jsxs)("span", {
												children: [
													(0, a.jsx)("span", {
														className: "text-muted-foreground",
														children: "Invoices ticked: ",
													}),
													(0, a.jsx)("span", {
						...
						(0, a.jsx)(m.lG, {
							...
							children: (0, a.jsxs)(m.Cf, {
								className: "sm:max-w-2xl",
								children: [
									(0, a.jsxs)(m.c7, {
										children: [
											(0, a.jsx)(m.L3, {
												children: "Confirm reconciliation",
											}),
											(0, a.jsx)(m.rr, {
												children: D
													? `${w(
									...
									D
										? (0, a.jsxs)("div", {
												...
												children: [
													(0, a.jsx)("div", {
														className:
															"max-h-[22rem] overflow-y-auto rounded-md border",
														children: (0, a.jsxs)(x.XI, {
															children: [
																(0, a.jsx)(x.A0, {
																	children: (0, a.jsxs)(x.Hj, {
																		children: [
																			(0, a.jsx)(x.nd, {
																				children:
																					"Payment",
													...
													(0, a.jsxs)("div", {
														className:
															"flex flex-wrap justify-between gap-x-4 gap-y-1 rounded-lg border bg-muted/20 px-3 py-2 text-sm",
														children: [
															(0, a.jsxs)("span", {
																children: [
																	(0, a.jsx)("span", {
									...
									(0, a.jsxs)(m.Es, {
										...
										children: [
											...
											(0, a.jsx)(i.$, {
												onClick: ed,
												disabled: M || !D || 0 === D.allocations.length,
												children: M
													? (0, a.jsxs)(a.Fragment, {
															children: [
																(0, a.jsx)(p.A, {
		...
		79984: (e, s, t) => {
			t.d(s, { BT: () => l, Wu: () => d, ZB: () => c, Zp: () => r, aR: () => i });
			var a = t(95155);
			t(12115);
			var n = t(91337);
		...
		94411: (e, s, t) => {
			...
			var a = t(49876);
			let n = "dms.api.payment_entries";
			async function r(e) {
				return (0, a.AT)(`/api/method/${n}.get_payment_entries`, {
					method: "POST",
					body: JSON.stringify({
			...
			async function i(e) {
				return (0, a.AT)(`/api/method/${n}.get_payment_entry_detail`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function c(e) {
				return (0, a.AT)(`/api/method/${n}.create_advance_payment`, {
					method: "POST",
					body: JSON.stringify({ data: e }),
				});
			}
			async function l(e, s) {
				return (0, a.AT)(`/api/method/${n}.get_customer_advances`, {
					method: "POST",
					body: JSON.stringify({ customer: e, company: s || null }),
				});
			}
			async function d(e) {
				return (0, a.AT)(`/api/method/${n}.cancel_payment_entry`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			async function o(e, s = !0) {
				return (0, a.AT)(`/api/method/${n}.amend_payment_entry`, {
					method: "POST",
					body: JSON.stringify({ name: e, submit: +!!s }),
				});
			}
			async function m(e) {
				return (0, a.AT)(`/api/method/${n}.delete_draft_payment_entry`, {
					method: "POST",
					body: JSON.stringify({ name: e }),
				});
			}
			let x = "dms.api.reconciliation";
			async function u(e, s) {
				return (0, a.AT)(`/api/method/${x}.get_reconciliation_overview`, {
					method: "POST",
					body: JSON.stringify({ customer: e, company: s || null }),
				});
			}
			async function h(e, s, t, n) {
				return (0, a.AT)(`/api/method/${x}.preview_allocation`, {
					method: "POST",
					body: JSON.stringify({
						customer: e,
						company: s,
			...
			async function p(e, s, t, n) {
				return (0, a.AT)(`/api/method/${x}.reconcile_payments`, {
					method: "POST",
					body: JSON.stringify({
						customer: e,
						company: s,
			...
			async function g(e, s, t) {
				return (0, a.AT)(`/api/method/${x}.reconcile_invoice_advances`, {
					method: "POST",
					body: JSON.stringify({
						sales_invoice: e,
						company: s || null,
						payment_keys: t?.length ? t : null,
					}),
				});
			}
		},
