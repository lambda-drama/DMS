	...
	[8051],
	{
		...
		33745: (e, t, a) => {
			...
			var s = a(95155),
				...
				i = a(4474),
				o = a(91337);
			function l({ module: e, label: t, className: a, ...d }) {
		...
		65588: (e, t, a) => {
			...
			async function r(e, t) {
				var a = await (0, s.AT)("/api/method/dms.api.quick_create.quick_create_doc", {
					method: "POST",
				...
				return {
					name: r.trim(),
					label: "string" == typeof n && n.trim() ? n.trim() : void 0,
				};
			}
		},
		79984: (e, t, a) => {
		...
		81672: (e, t, a) => {
			a.d(t, { Ge: () => u, N0: () => d, Yq: () => o, gQ: () => c, r6: () => l });
			let s = [
					"January",
					"February",
					"March",
			...
			function l(e, t = "", a = !1) {
				let s = i(e);
				if (!s) return t;
				let r = `${n(s.getHours())}:${n(s.getMinutes())}${
					a ? `:${n(s.getSeconds())}` : ""
				}`;
				return `${o(s)} ${r}`;
			}
			...
			function c(e, t = "") {
				let a = i(e);
				return a ? r[a.getDay()] : t;
			}
			function u(e, t = "") {
				let a = i(e);
				return a ? `${r[a.getDay()]}, ${o(a)}` : t;
			}
		},
		95885: (e, t, a) => {
			a.d(t, { BK: () => o, eu: () => i, q5: () => l });
			var s = a(95155);
			a(12115);
			var r = a(84375),
				n = a(91337);
		...
		98883: (e, t, a) => {
			...
			function c({ className: e, children: t, side: a = "right", ...o }) {
				return (0, s.jsxs)(l, {
					children: [
						(0, s.jsx)(d, {}),
						(0, s.jsxs)(r.UC, {
								...
								children: (0, s.jsx)("div", {
									...
									children: (0, s.jsxs)("div", {
										...
										children: [
											...
											r && (0, s.jsx)(f, { className: "mt-1", children: r }),
										],
									}),
								}),
							}),
							(0, s.jsx)(g.w, { className: "bg-(--dms-green)/20" }),
							l
								? (0, s.jsx)("div", {
			...
			function b({ title: e, children: t, className: a }) {
				return (0, s.jsxs)("div", {
