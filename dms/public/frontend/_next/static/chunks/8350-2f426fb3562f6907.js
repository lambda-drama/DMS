	...
	[8350],
	{
		48350: (e, s, t) => {
			...
			var a = t(95155),
				...
				M = t(49387);
			function E() {
				let { navigate: e, viewParams: s } = (0, h.c)(),
					{ canWrite: t } = (0, i.Sk)(),
					[E, J] = (0, d.P)("customers", "search", ""),
					[D, T] = (0, r.useState)(1),
					[I, V] = (0, r.useState)(50),
				...
				let {
						...
						error: O,
						mutate: Y,
					} = (0, n.sL)({ search: E || void 0, limit: I, offset: (D - 1) * I }),
					B = H?.total || 0,
					{
						items: P,
						loadedCount: q,
						...
						resetKey: [E, D, I].join("|"),
						enabled: I >= o.J,
						fetchMore: async (e, s) => (await m.gn(E || void 0, s, e)).data,
					});
				(0, r.useEffect)(() => {
					T(1);
				}, [E]);
				let X = P?.find((e) => e.name === z),
					K = W ?? X ?? null,
					ee = (0, r.useMemo)(
						() =>
							P
								? {
										total: P.length,
										individual: P.filter(
											(e) => "Individual" === e.customer_type
										).length,
										company: P.filter((e) => "Company" === e.customer_type)
											.length,
								  }
								: { total: 0, individual: 0, company: 0 },
						[P]
					);
				return (0, a.jsxs)("div", {
					...
					children: [
							...
							children: (0, a.jsxs)("div", {
								children: [
									...
									(0, a.jsx)("p", {
										...
										children: "Vehicle customers managed in DMS",
									}),
								],
							}),
						}),
									...
									children: (0, a.jsx)(f.Wu, {
										...
										children: (0, a.jsxs)("div", {
											...
											children: [
												(0, a.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-primary/10 p-1.5 sm:order-2",
									...
									children: (0, a.jsx)(f.Wu, {
										...
										children: (0, a.jsxs)("div", {
											...
											children: [
												(0, a.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-blue-100 p-2 dark:bg-blue-900/30 sm:p-1.5 sm:order-2",
													children: (0, a.jsx)(y.A, {
														className:
									...
									children: (0, a.jsx)(f.Wu, {
										...
										children: (0, a.jsxs)("div", {
											...
											children: [
												(0, a.jsx)("div", {
													className:
														"order-1 w-fit rounded-full bg-purple-100 p-2 dark:bg-purple-900/30 sm:p-1.5 sm:order-2",
													children: (0, a.jsx)(y.A, {
														className:
						...
						(0, a.jsxs)(f.Zp, {
							children: [
								(0, a.jsx)(f.aR, {
									children: (0, a.jsx)(f.ZB, { children: "Customer List" }),
								}),
								(0, a.jsxs)(f.Wu, {
									children: [
										L
						...
						(0, a.jsx)(u.BN, {
							...
							title: X?.customer_name || z || "",
							subtitle: z || void 0,
							badge: X?.customer_type ? { label: X.customer_type } : void 0,
							onOpenInDesk: () => window.open(`/app/customer/${z}`, "_blank"),
							footer: (0, a.jsxs)("div", {
								...
								children: [
									...
									(0, a.jsxs)(j.$, {
										...
										className: "gap-2",
										onClick: () => {
											F(null), e("vehicles", { customer: z });
										},
										children: [
											(0, a.jsx)(A.A, { className: "h-4 w-4" }),
											"View Vehicles",
										],
									}),
								],
									...
									children: [
										(0, a.jsxs)(u.JH, {
											...
											children: [
												...
												(0, a.jsx)(u.Qb, {
													label: "Customer Type",
													value: X.customer_type,
												}),
												(0, a.jsx)(u.Qb, {
													label: "Customer Group",
													value: X.customer_group,
												}),
												(0, a.jsx)(u.Qb, {
													label: "Territory",
													value: X.territory,
										...
										(0, a.jsx)(u.JH, {
											title: "Info",
											children: (0, a.jsx)(u.Qb, {
												label: "Created",
												value: X.creation ? (0, l.Yq)(X.creation) : void 0,
											}),
										}),
									],
								}),
		...
		61991: (e, s, t) => {
			...
			var l = t(89803),
				r = t(91337);
			function n({ className: e, orientation: s = "horizontal", decorative: t = !0, ...i }) {
				return (0, a.jsx)(l.b, {
					"data-slot": "separator",
					decorative: t,
					orientation: s,
		...
		81672: (e, s, t) => {
			t.d(s, { Ge: () => m, N0: () => o, Yq: () => i, gQ: () => d, r6: () => c });
			let a = [
					"January",
					"February",
					"March",
			...
			function c(e, s = "", t = !1) {
				let a = n(e);
				if (!a) return s;
				let l = `${r(a.getHours())}:${r(a.getMinutes())}${
					t ? `:${r(a.getSeconds())}` : ""
				}`;
				return `${i(a)} ${l}`;
			}
			...
			function d(e, s = "") {
				let t = n(e);
				return t ? l[t.getDay()] : s;
			}
			function m(e, s = "") {
				let t = n(e);
				return t ? `${l[t.getDay()]}, ${i(t)}` : s;
			}
		},
		92461: (e, s, t) => {
			t.d(s, { h: () => h });
			var a = t(95155),
				...
				x = t(10086),
				p = t(32144);
			function h({ open: e, onOpenChange: s, customer: t, onUpdated: j }) {
				let { mutate: g } = (0, i.iX)(),
					{ data: f } = (0, c.Ay)(e ? "crm-customer-create-options" : null, p.$I),
					[N, b] = (0, l.useState)(!1),
					[v, y] = (0, l.useState)({
						customer_name: "",
				...
				let _ = (0, l.useMemo)(
						() =>
							(f?.customer_types || ["Individual", "Company"]).map((e) => ({
								value: e,
								label: e,
							})),
						[f]
					...
					C = (0, l.useMemo)(
						() => (f?.customer_groups || []).map((e) => ({ value: e, label: e })),
						[f]
					),
					k = (0, l.useMemo)(
						() => (f?.territories || []).map((e) => ({ value: e, label: e })),
						[f]
					);
				async function A(e) {
					if ((e.preventDefault(), t?.name)) {
						...
						try {
							await (0, p.Gk)(t.name, {
								...
								customer_group: v.customer_group || null,
								mobile_no: v.mobile_no.trim() || null,
								email_id: v.email_id.trim() || null,
					...
					children: (0, a.jsx)(o.Cf, {
						...
						children: (0, a.jsxs)("form", {
							...
							children: [
								(0, a.jsxs)(o.c7, {
									children: [
										(0, a.jsx)(o.L3, { children: "Edit customer" }),
										(0, a.jsx)(o.rr, {
											children:
		...
		98883: (e, s, t) => {
			...
			function d({ className: e, children: s, side: t = "right", ...i }) {
				return (0, a.jsxs)(c, {
					children: [
						(0, a.jsx)(o, {}),
						(0, a.jsxs)(l.UC, {
								...
								children: (0, a.jsx)("div", {
									...
									children: (0, a.jsxs)("div", {
										...
										children: [
											...
											l && (0, a.jsx)(x, { className: "mt-1", children: l }),
										],
									}),
								}),
							}),
							(0, a.jsx)(h.w, { className: "bg-(--dms-green)/20" }),
							c
								? (0, a.jsx)("div", {
			...
			function N({ label: e, value: s, className: t }) {
				return (0, a.jsxs)("div", {
					className: (0, n.cn)(
