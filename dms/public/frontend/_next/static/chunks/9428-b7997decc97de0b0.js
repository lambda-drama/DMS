...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[9428],
	{
		...
		43447: (e, t, a) => {
			...
			function i({ className: e, sideOffset: t = 4, ...a }) {
				return (0, s.jsx)(r.ZL, {
			...
			function c({ className: e, inset: t, variant: a = "default", ...d }) {
				return (0, s.jsx)(r.q7, {
			...
			function o({ className: e, inset: t, ...a }) {
				return (0, s.jsx)(r.JU, {
		...
		59428: (e, t, a) => {
			...
			function f() {
				let { navigate: e } = (0, l.c)(),
					[t, a] = (0, r.useState)(""),
					[f, v] = (0, r.useState)("all"),
					{ error: j, success: b, showError: y, showSuccess: N, clear: w } = (0, x.B)(),
					{
						data: k,
						isLoading: S,
						mutate: C,
					} = (0, n.Ay)(["crm-leads", t, f], () =>
						(0, d.AP)({ search: t || void 0, status: f, limit: 50 })
					),
					A = k?.data || [],
					_ = async (e) => {
						w();
						try {
							await (0, d.Jv)(e), await C(), N(`Lead ${e} accepted.`);
						} catch (e) {
							y(e, "Failed to accept lead");
						}
					};
				return (0, s.jsxs)("div", {
					className: "space-y-4",
					children: [
						(0, s.jsx)(x.y, { error: j, success: b, onDismiss: w }),
						(0, s.jsx)("div", {
																								...
																								"td",
																								{
																									...
																									children:
																										...
																										s.jsx)(
																											"span",
																											{
																												className: `inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium ${(function (
																													e
																												) {
																													switch (
																														e
		...
		93108: (e, t, a) => {
			...
			function o() {
				let [e, t] = (0, r.useState)(""),
					[a, s] = (0, r.useState)(""),
					d = (0, r.useCallback)((e, a = "Something went wrong.") => {
						let r =
			...
			function u({ error: e, success: t, onDismiss: a, className: r }) {
				...
				return (0, s.jsx)("div", {
					...
					children: (0, s.jsxs)("div", {
						...
						children: [
							n
								? (0, s.jsx)(d.A, { className: "mt-0.5 h-4 w-4 shrink-0" })
