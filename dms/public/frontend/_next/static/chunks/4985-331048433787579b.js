		...
		47279: (e, t, r) => {
			...
			function k(e) {
				let {
					...
					[y, k] = (0, l.i)({ prop: r, defaultProp: a ?? !1, onChange: u, caller: p }),
					[b, w] = n.useState(null),
					[x, g] = n.useState(null),
					A = n.useRef(!1),
				...
				return (0, f.jsx)(m, {
					scope: t,
					...R,
					children: "function" == typeof v ? v(R) : o,
				});
			}
			var b = "CheckboxTrigger",
				w = n.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: r, ...a }, l) => {
					let {
							control: i,
							value: c,
							disabled: u,
			...
			var g = "CheckboxIndicator",
				A = n.forwardRef((e, t) => {
					let { __scopeCheckbox: r, forceMount: n, ...o } = e,
						a = y(g, r);
					return (0, f.jsx)(u.C, {
						present: n || j(a.checked) || !0 === a.checked,
					...
					return (
						...
						(0, p.jsx)(y.ItemSlot, {
							...
							children: (0, p.jsx)(c.sG.span, {
								...
								onFocus: (0, o.mK)(e.onFocus, () => v.onItemFocus(h)),
