...
> = {
  ...
  "Repair Completed": { label: "Repair Completed", color: "text-[#2E7D32]", icon: Wrench, bgColor: "bg-[#2E7D32]/10" },
  ...
  "Road Test Completed": { label: "Road Test Done", color: "text-[#2E7D32]", icon: Car, bgColor: "bg-[#2E7D32]/10" },
  "QC In Progress": { label: "QC In Progress", color: "text-[#2E7D32]", icon: Settings2, bgColor: "bg-[#2E7D32]/10" },
  ...
  Completed: { label: "Completed", color: "text-[#2E7D32]", icon: CheckCircle2, bgColor: "bg-[#2E7D32]/10" },
  Delivered: { label: "Delivered", color: "text-[#2E7D32]", icon: Truck, bgColor: "bg-[#2E7D32]/10" },
